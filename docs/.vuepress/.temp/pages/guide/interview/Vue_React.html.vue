<template><div><h1 id="vue-react" tabindex="-1"><a class="header-anchor" href="#vue-react"><span>Vue&amp;React</span></a></h1>
<h3 id="说说vue动态权限绑定渲染列表-权限列表渲染" tabindex="-1"><a class="header-anchor" href="#说说vue动态权限绑定渲染列表-权限列表渲染"><span>说说vue动态权限绑定渲染列表（权限列表渲染）</span></a></h3>
<ol>
<li>
<p>首先请求服务器,获取当前用户的权限数据,比如请求 this.$http.get(&quot;rights/list&quot;);</p>
</li>
<li>
<p>获取到权限数据之后,在列表中使用v-if v-if-else的组合来展示不同的内容</p>
...
<h3 id="vue用的哪种设计模式" tabindex="-1"><a class="header-anchor" href="#vue用的哪种设计模式"><span>Vue用的哪种设计模式</span></a></h3>
...
<h3 id="说说vue操作真实dom性能瓶颈" tabindex="-1"><a class="header-anchor" href="#说说vue操作真实dom性能瓶颈"><span>说说vue操作真实dom性能瓶颈</span></a></h3>
<p>vue性能瓶颈的几种情况</p>
<ol>
<li>
<p>一次渲染大量的数据的时候,存在大量数据并且都是复杂类型的时候,会导致vue对数据的劫持时间和渲染时间变长, js 连续执行时间过长，会导致页面长时间无法交互，而且渲染时间太慢，用户一次交互反馈的时间过长。</p>
<blockquote>
<p>优化方案:可以使用<code v-pre>requestAnimation</code>这个方法,将数据进行分割,分批次渲染,减少了 js 的连续运行时间，并且加快了渲染时间，利用加长总运行时间换取了渲染时间，用户既能快速得到反馈，而且不会因为过长时间的 js 运行而无法与页面交互。</p>
</blockquote>
</li>
<li>
<p>当页面中存在大量数据,只是修改了一小部分导致页面也会导致页面卡顿,因为vue的更新以组件为粒度进行更新的，只要修改了当前组件中所使用的数据，组件就会整个去进行更新,造成大量的时间浪费</p>
<blockquote>
...
<li>
<p>动态插槽作用域或者静态插槽的更新</p>
<blockquote>
<p>使用插槽作用域来替换这两种操作方式,一样能提升性能,因为使用<code v-pre>插槽作用域</code>之后,插槽内容会被封装到一个函数中,被子组件渲染,而不是在父组件</p>
</blockquote>
</li>
</ol>
<h3 id="vue中如何获取dom、操作dom、更新dom" tabindex="-1"><a class="header-anchor" href="#vue中如何获取dom、操作dom、更新dom"><span>Vue中如何获取dom、操作dom、更新dom</span></a></h3>
...
<h3 id="vue-的双向数据绑定原理是什么" tabindex="-1"><a class="header-anchor" href="#vue-的双向数据绑定原理是什么"><span>Vue 的双向数据绑定原理是什么</span></a></h3>
...
<ol>
<li>只能监听对象(Object)，不能监听数组的变化，无法触发push, pop, shift, unshift,splice, sort, reverse。</li>
<li>必须遍历对象的每个属性</li>
<li>只能劫持当前对象属性，如果想深度劫持，必须深层遍历嵌套的对象。</li>
</ol>
<p>Proxy的优点：</p>
<ol>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="mvvm框架是什么" tabindex="-1"><a class="header-anchor" href="#mvvm框架是什么"><span>mvvm框架是什么</span></a></h3>
...
<p><img src="@source/guide/interview/MVVM.png" alt="alt text"></p>
<h3 id="谈谈vue的token存储" tabindex="-1"><a class="header-anchor" href="#谈谈vue的token存储"><span>谈谈Vue的token存储</span></a></h3>
...
<h3 id="知道nexttick的作用吗-谈谈对它的理解-是什么-怎么用" tabindex="-1"><a class="header-anchor" href="#知道nexttick的作用吗-谈谈对它的理解-是什么-怎么用"><span>知道nextTick的作用吗，谈谈对它的理解，是什么，怎么用</span></a></h3>
...
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>example<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>{{message}}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">var</span> vm <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Vue</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nexttick和settimeout区别" tabindex="-1"><a class="header-anchor" href="#nexttick和settimeout区别"><span>nextTick和setTimeout区别</span></a></h3>
...
<h3 id="vue中为什么用虚拟dom而不操作真实dom" tabindex="-1"><a class="header-anchor" href="#vue中为什么用虚拟dom而不操作真实dom"><span>vue中为什么用虚拟dom而不操作真实dom</span></a></h3>
...
<p><img src="@source/guide/interview/虚拟DOM.png" alt="alt text"></p>
<p>虚拟DOM还有一个好处，可以渲染到 DOM 以外的平台，实现 SSR、同构渲染这些高级特性，Weex 等框架应用的就是这一特性。</p>
<h3 id="vue如何进行组件传值" tabindex="-1"><a class="header-anchor" href="#vue如何进行组件传值"><span>Vue如何进行组件传值</span></a></h3>
<p>父向子组件传值，可以利用prop方式。</p>
<p>子向父组件传值，可以利用自定义事件$emit方式。</p>
<p><img src="@source/guide/interview/vue父子通信.png" alt="alt text"></p>
<p>多层级组件传值，可以使用provide/inject</p>
<p><img src="@source/guide/interview/provide_inject.png" alt="alt text"></p>
<p>无关系的组件传值，利用vuex状态管理</p>
<p><img src="@source/guide/interview/vuex.png" alt="alt text"></p>
<h3 id="说说vue里面的父子通信" tabindex="-1"><a class="header-anchor" href="#说说vue里面的父子通信"><span>说说vue里面的父子通信</span></a></h3>
<p>父 -&gt; 子: 通过 Prop 向子组件传递数据，子组件通过props属性来接收。</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>blog-post</span> <span class="token attr-name">title</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>My journey with Vue<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>blog-post</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">Vue<span class="token punctuation">.</span><span class="token function">component</span><span class="token punctuation">(</span><span class="token string">'blog-post'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>子 -&gt; 父: 父组件自定义事件，子组件利用$emit来完成。</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token comment">&lt;!--拿到子组件传递的数据$event即0.1--></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line">Vue.component('blog-post', {</span>
...
<span class="line">})</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/guide/interview/vue父子通信-1.png" alt="alt text"></p>
<h3 id="谈谈如何实现vue组件通信和传值方式-两个问题为同一个答案问法不一样" tabindex="-1"><a class="header-anchor" href="#谈谈如何实现vue组件通信和传值方式-两个问题为同一个答案问法不一样"><span>谈谈如何实现vue组件通信和传值方式 （两个问题为同一个答案问法不一样）</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">这类问题 首先分类 表明了解的比较多   具体就没说完 或者漏了  面试官也不会计较很多</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="说说vue中key值的作用" tabindex="-1"><a class="header-anchor" href="#说说vue中key值的作用"><span>说说vue中Key值的作用</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">关于这个可以的key的作用 首先表明 key 不是一定要有的  不写可以代码也可以跑  但是建议加上</span>
...
<span class="line">          </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="说说vue中的虚拟dom和diff算法" tabindex="-1"><a class="header-anchor" href="#说说vue中的虚拟dom和diff算法"><span>说说vue中的虚拟dom和diff算法</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">Virtual DOM 其实就是一棵以 JavaScript 对象( VNode 节点)作为基础的树，用对象属性来描述节点，实际上它只是一层对真实 DOM 的抽象。最终可以通过一系列操作使这棵树映射到真实的DOM上</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="https://segmentfault.com/a/1190000020663531?utm_source=tag-newest" target="_blank" rel="noopener noreferrer">实现虚拟DOM的过程</a></p>
<h3 id="vue3-0有了解过吗-你觉得vue3-0好吗-好在哪" tabindex="-1"><a class="header-anchor" href="#vue3-0有了解过吗-你觉得vue3-0好吗-好在哪"><span>vue3.0有了解过吗，你觉得vue3.0好吗，好在哪</span></a></h3>
<p>这种问题 是开放的   多说就是都是对的    可以讲差异  也可以讲新增 的知识点</p>
<p>比如说 常用的api特别好用</p>
<ol>
<li>ref、toRefs、toRef、isRef</li>
</ol>
<ul>
<li>ref 用于定义响应式变量、快捷DOM访问。</li>
<li>基本语法：<code v-pre>const a = ref(1) // {value:1}</code></li>
<li>基础使用： 一般用于定义 String、Number、Boolean 这种基于数据类型，外在表现统一使用 .value 访问。</li>
<li>补充：ref 还可以访问 DOM对象或者组件实例对象，可做DOM操作。</li>
<li>toRef、toRefs 用于把一个object的变量，变成响应式的变量。</li>
<li>基本语法：<code v-pre>const msg = toRef(obj, key) </code>// 把obj[key]变成响应式的</li>
<li>基本语法：<code v-pre>const { msg } = toRefs(obj)</code> // 把整个obj都变成响应式的</li>
<li>unref 返回一个变量的值</li>
<li>基本语法：<code v-pre>const x = unref(x)</code> // 如果x是ref变量则返回x.value，如果x不是ref变量则直接返回x。</li>
<li>isRef 用于判断一个变量是不是ref响应式变量</li>
<li>基本语法：<code v-pre>const bol = isRef(x)</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">useUpdBoxStyle</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<li>shallowRef、triggerRef</li>
</ol>
<ul>
<li>shallowRef 用于性能优化，只对对象的第一层进行proxy</li>
<li>基本语法：<code v-pre>const obj = shallowRef({a:1,b:{c:{d:{e:2}}}})</code></li>
<li>triggerRef 用于手动触发那些shallowRef的变量进行更新视图</li>
<li>基本语法：<code v-pre>triggerRef(obj)</code> // 当obj.value.b.c.d发生变化，triggerRef(obj) 强制更新视图。</li>
<li>customRef 自定义ref，把ref变量拆成get/set的写法</li>
<li>基本语法：<code v-pre>customRef((track, trigger) =&gt;({get,set})</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">useObj</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li>reactive、readonly</li>
</ol>
<ul>
<li>reactive 用于定义响应式变量（引用数据类型）</li>
<li>基本语法：<code v-pre>const arr = reactive([]) // {value: []}</code></li>
<li>ref和reactive是什么关系呢？ref背后是使用reactive来实现的。</li>
<li>shallowReactive 用于性能优化，只对对象的第一层进行proxy</li>
<li>基本语法：<code v-pre>const c = shallowReactive({a:{b:{c:100}}})</code> // 只对这个对象的第一层进行proxy</li>
<li>readonly 把响应式变量变成“只读的”，如果修改就报警告。</li>
<li>基本语法：<code v-pre>const user = readonly({name:1,age:2})</code></li>
<li>isReadonly 用于判断一个变量是否是readonly的，返回布尔值</li>
<li>基本语法：<code v-pre>const bol = isReadonly(x)</code></li>
<li>isProxy 用于判断一个变量是否是响应式的，返回布尔值</li>
<li>基本语法：<code v-pre>const bol = isProxy(x)</code></li>
<li>isReactive 用于判断一个变量是否是reactive响应式变量，返回布尔值</li>
<li>基本语法：<code v-pre>const bol = isReactive(x)</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">useUser</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<ul>
<li>toRaw 用于返回一个响应式变量的原始值</li>
<li>基本语法：<code v-pre>const a3 = toRow(reactive(a1)) </code>// a1===a3是true</li>
<li>markRaw 用于把一个普通变量标记成“不可proxy”的</li>
<li>基本语法：<code v-pre>const b2 = markRaw(b1) </code>// b2是无法被reactive的</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">useRaw</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<ul>
<li>computed 用于对响应式变量进行二次计算，当它依赖的响应式变量发生变化时会重新计算</li>
<li>基本语法：<code v-pre>const c = computed(()=&gt;c1.value*c2.value) </code>// 只读</li>
<li>基本语法：<code v-pre>const c = computed({get:()=&gt;c1.value*c2.value,set:(newVal)=&gt;c1.value=newVal})</code> // 可写可读</li>
<li>watch 用于监听响应式变量的变化，组件初始化它不执行</li>
<li>基本语法：<code v-pre>const stop = watch(x, (new,old)=&gt;{})</code> // 调用stop()可以停止监听</li>
<li>基本语法：<code v-pre>const stop = watch([x,y], ([newX,newY],[oldX,oldY])=&gt;{})</code></li>
<li>watchEffect 用于监听响应式变量的变化，组件初始化会执行</li>
<li>基本语法：<code v-pre>const stop = watchEffect(()=&gt;ajax({cate,page,size}))</code></li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">export default function useWatchComputed() {</span>
...
<h3 id="v-model有了解过吗-原理是什么" tabindex="-1"><a class="header-anchor" href="#v-model有了解过吗-原理是什么"><span>v-model有了解过吗，原理是什么</span></a></h3>
<p>这种原理性问题  不要直接说不清楚 不了解</p>
<p>先讲下使用</p>
<p>v-model本质上是一个语法糖，可以看成是value + input 方法的语法糖。可以通过model的prop属性和event事件来进行自定义。</p>
<p>2、v-model是vue的双向绑定的指令，能将页面上控件输入的值同步更新到相关绑定的data属性， 也会在更新<code v-pre>data</code>绑定属性时候，更新页面上输入控件的值。</p>
<p>然后再来讲细节</p>
...
<h3 id="vue组件如何与iframe通信问题" tabindex="-1"><a class="header-anchor" href="#vue组件如何与iframe通信问题"><span>VUE组件如何与iframe通信问题</span></a></h3>
...
<p>代码和例子</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> &lt;div class="mapbox"></span>
...
<span class="line">});</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="用过vue-的自定义指令吗-自定义指令的方法有哪些" tabindex="-1"><a class="header-anchor" href="#用过vue-的自定义指令吗-自定义指令的方法有哪些"><span>用过VUE 的自定义指令吗？自定义指令的方法有哪些</span></a></h3>
<p>这种问题一样的  先回答经常用的一些指定 比如 v-for  v-if  v-model   v-show等等之类的  指令分为全局和局部的</p>
<p>然后在回答自定义指令</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">通过directive来自定义指令，自定义指令分为全局指令和局部指令，自定义指令也有几个的钩子函数，常用的有bind和update，当 bind 和 update 时触发相同行为，而不关心其它的钩子时可以简写。一个表达式可以使用多个过滤器。过滤器之间需要用管道符“<span class="token operator">|</span>”隔开。其执行顺序从左往右。  </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="当修改data时vue的组件重渲染是异步还是同步" tabindex="-1"><a class="header-anchor" href="#当修改data时vue的组件重渲染是异步还是同步"><span>当修改data时Vue的组件重渲染是异步还是同步</span></a></h3>
...
<h3 id="sync修饰器的作用是" tabindex="-1"><a class="header-anchor" href="#sync修饰器的作用是"><span>.sync修饰器的作用是</span></a></h3>
...
<p>代码解释</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 这里父组件，要给子组件传一个title的值</span>
...
<span class="line">&lt;/script></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 子组件</span>
<span class="line">&lt;template></span>
<span class="line">    &lt;div></span>
...
<span class="line">&lt;/script></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里关键就是emit里的参数要写成'update'+ ':' +'要修改的props'</p>
<p>以前是用的this.$emit(&quot;自定义方法&quot;)</p>
<h3 id="vue多组件嵌套通信方式" tabindex="-1"><a class="header-anchor" href="#vue多组件嵌套通信方式"><span>vue多组件嵌套通信方式</span></a></h3>
...
<p>方法三：利用公共的bus = new  Vue()   bus.$on  声明  bus.$emit()   调用</p>
<p>方法四：使用vuex 全局的状态管理</p>
<h3 id="vue如何让css只在当前组件生效" tabindex="-1"><a class="header-anchor" href="#vue如何让css只在当前组件生效"><span>vue如何让css只在当前组件生效</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">当前组件&lt;style>写成&lt;style  scoped>   加上scoped就可以了</span>
<span class="line"></span>
<span class="line">这个style中一般还有lang   lang可以是less  scss  stylus 等等</span>
<span class="line">不加scoped就是全局的样式</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-的-keep-live-用过吗-作用是什么" tabindex="-1"><a class="header-anchor" href="#vue-的-keep-live-用过吗-作用是什么"><span>Vue 的 keep-live 用过吗？作用是什么？</span></a></h3>
<ol>
<li>没有用过</li>
<li>用过，它的作用是可以在组件切换时，保存其包裹的组件的状态，使其不被销毁，防止多次渲染。</li>
</ol>
<h3 id="keepalive-添加这个会比平常多生命周期吗-keepalive-已经缓存了-但是想跳回去的时候添加新的属性在哪个生命周期里实现" tabindex="-1"><a class="header-anchor" href="#keepalive-添加这个会比平常多生命周期吗-keepalive-已经缓存了-但是想跳回去的时候添加新的属性在哪个生命周期里实现"><span>keepalive,添加这个会比平常多生命周期吗? keepalive 已经缓存了,但是想跳回去的时候添加新的属性在哪个生命周期里实现</span></a></h3>
<p>会比平常的组件多两个生命周期钩子函数，分别是：activated 和 deactivated。使用<code v-pre>keep-alive</code>包裹的组件在切换时不会被销毁，而是缓存到内存中并执行 deactivated 钩子函数，再次渲染后会执行 activated 钩子函数。如果再一次跳回显示组件的时候可以在 activated 中做处理</p>
<h3 id="说一下-keep-alive-的关联生命周期" tabindex="-1"><a class="header-anchor" href="#说一下-keep-alive-的关联生命周期"><span>说一下 keep-alive 的关联生命周期</span></a></h3>
<p>会比平常的组件多两个生命周期钩子函数，分别是：activated 和 deactivated。使用<code v-pre>keep-alive</code>包裹的组件在切换时不会被销毁，而是缓存到内存中并执行 deactivated 钩子函数，再次渲染后会执行 activated 钩子函数。</p>
<h3 id="vue-创建项目的指令是什么" tabindex="-1"><a class="header-anchor" href="#vue-创建项目的指令是什么"><span>Vue 创建项目的指令是什么</span></a></h3>
<ol>
<li>使用的官方 cli 脚手架，如果是低于 3.0 的版本，使用<code v-pre>npm init</code></li>
<li>cli 的版本大于 3.0 的使用<code v-pre>vue create</code></li>
<li>可以使用 vite 直接搭建项目，命令为<code v-pre>npm init vite@latest</code>，根据提示，一步一步操作就好</li>
</ol>
<p>参考链接</p>
<p><a href="https://vitejs.dev/guide/#scaffolding-your-first-vite-project" target="_blank" rel="noopener noreferrer">Getting Started | Vite</a></p>
<p><a href="https://cli.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">Vue CLI</a></p>
<h3 id="vue-中如何使用-ref-绑定" tabindex="-1"><a class="header-anchor" href="#vue-中如何使用-ref-绑定"><span>vue 中如何使用 ref 绑定</span></a></h3>
<p>通过为组件或者标签添加 ref 属性，可以在 js 代码中使用全局 api<code v-pre>$refs</code>获取 dom 元素或者组件，其上的方法或者属性可以直接进行操作。</p>
<h3 id="vue-导航守卫与-jq-导航拦截器的介绍" tabindex="-1"><a class="header-anchor" href="#vue-导航守卫与-jq-导航拦截器的介绍"><span>vue 导航守卫与 jq 导航拦截器的介绍</span></a></h3>
...
<li>
<p>next: 一个回调函数， 一定要调用这个方法，不然路由不会继续往下</p>
<p>jq 导航拦截器没有听过，一般在 jQuery 的作用就是对 dom 元素做操作，jQuery 的核心功能是元素选择器。至于提到的导航器可能是一类第三方 jQuery 插件？或者网络请求拦截，如果是网络请求拦截，那么 jQuery 发起请求的话，可以封装一个全局 ajax 请求插件，通过设置 ajaxSetup 实现</p>
</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">// 参考这个 https://www.runoob.com/jquery/ajax-ajaxsetup.html</span></span>
...
<span class="line">  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-常用哪些命令" tabindex="-1"><a class="header-anchor" href="#vue-常用哪些命令"><span>vue 常用哪些命令</span></a></h3>
<ol>
<li>v-model 指令，用于表单输入。</li>
<li>v-on 指令，用于事件绑定。</li>
<li>v-bind 指令，用于动态绑定一个值和传入变量。</li>
<li>v-once 指令，事件只能用一次，无论点击几次，执行一次之后都不会再执行。</li>
<li>v-html 指令，会将 span 的内容替换成 rawHtml 的属性值，直接作为 HTML 代码解析。</li>
<li>v-for 指令，与 HTML 标签结合使用，用于数据的遍历摆放。</li>
<li>v-if 指令，用来进行条件判断的，直接操作 dom。</li>
<li>v-else 指令，用来进行条件判断的，与 v-if 指令连用，意义为条件不成立时执行。</li>
<li>v-show 指令，根据真假切换元素的显示状态。</li>
</ol>
<h3 id="vue-中插槽共有几种-及插槽的作用" tabindex="-1"><a class="header-anchor" href="#vue-中插槽共有几种-及插槽的作用"><span>vue 中插槽共有几种，及插槽的作用</span></a></h3>
<p>三种：默认插槽、具名插槽、作用域插槽</p>
<ul>
<li>
<p>默认插槽</p>
<p>默认插槽就是指<slot/>，<slot/>的作用类似于占符。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">//定义一个全局子组件</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token comment">&lt;!--引用child组件--></span></span>
...
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述的子组件 child 里定义的 slot 被 span 标签给代替了，如果子组件里没有定义 slot，则 span 标签会被直接忽略，且一个子组件里只能定义一个单个插槽。</p>
</li>
<li>
<p>具名插槽</p>
<p>可以通过设置 name 属性，指定显示的位置</p>
<p>定义一个base-layout组件：</p>
...
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>base-layout</span><span class="token punctuation">></span></span></span>
...
<h3 id="vue-如何使用插件" tabindex="-1"><a class="header-anchor" href="#vue-如何使用插件"><span>vue 如何使用插件</span></a></h3>
<p>直接安装，引入就能使用。vue 还是 js，只要是 js 那么所有的插件使用都是相同的方式，引入绑定到对应的节点或者操作对应的节点就好。</p>
<h3 id="vue-组件懒加载-图片懒加载" tabindex="-1"><a class="header-anchor" href="#vue-组件懒加载-图片懒加载"><span>Vue 组件懒加载，图片懒加载</span></a></h3>
<h4 id="组件懒加载" tabindex="-1"><a class="header-anchor" href="#组件懒加载"><span>组件懒加载</span></a></h4>
<ol>
<li>结合路由插件使用的时候使用 import 方式实现</li>
</ol>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// 第一步注释import导入的文件</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="图片懒加载" tabindex="-1"><a class="header-anchor" href="#图片懒加载"><span>图片懒加载</span></a></h4>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">就是在加载页面的时候，如果页面中的图片过多，可以使用占位符的方式替换没有在可是区域内的图片，只加载当前需要现实的图片。监听滚动条的位置，当图片标签出现在可视区域的时候，重置图片的路径为真是路径，然后展示图片地址。一般在实际开发的时候都直接使用图片懒加载插件实现。还有一种解决方案就是使用页面骨架屏效果，也是类似占位显示，当数据加载完成之后替换掉占位显示的内容</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="使用vue封装过组件吗-有哪些-讲一下他们是怎么实现的" tabindex="-1"><a class="header-anchor" href="#使用vue封装过组件吗-有哪些-讲一下他们是怎么实现的"><span>使用Vue封装过组件吗?有哪些?讲一下他们是怎么实现的</span></a></h3>
<p>比如做后台管理中，很多模块经常会复用，比如侧边导航组件、项目中常用的 echarts图表的封装（比如折线图、柱状图等）</p>
<p>封装组件需要考虑复用性：</p>
<ul>
<li>预留插槽slot, 多次调用如果 子组件视图结构不一样那么就要 在 子组件template预留好 插槽（单个插槽、具名插槽，作用域插槽）</li>
<li>考虑到数据传递，定义props 组件接收父组件传递的数据，同时需要注意单向数据流，props不能直接修改，$emit自定义事件，父组件修改</li>
<li>业务逻辑不要在子组件中处理，子组件在不同父组件中调用时，业务处理代码不同，切记不要直接在子组件中处理业务，应该子组件 $emit自定义事件，将数据传递给父组件，父组件处理业务。</li>
</ul>
<h3 id="说说vuex的管理操作或理解" tabindex="-1"><a class="header-anchor" href="#说说vuex的管理操作或理解"><span>说说vuex的管理操作或理解</span></a></h3>
...
<h3 id="说说vuex的工作流程" tabindex="-1"><a class="header-anchor" href="#说说vuex的工作流程"><span>说说Vuex的工作流程</span></a></h3>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>组件中使用 使用vuex</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// 获取state</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vuex项目中怎么使用-工作原理是什么" tabindex="-1"><a class="header-anchor" href="#vuex项目中怎么使用-工作原理是什么"><span>vuex项目中怎么使用？工作原理是什么？</span></a></h3>
<p>原则:</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vuex中处理异步需要在什么地方写" tabindex="-1"><a class="header-anchor" href="#vuex中处理异步需要在什么地方写"><span>Vuex中处理异步需要在什么地方写</span></a></h3>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="请你谈谈你对vuex的理解" tabindex="-1"><a class="header-anchor" href="#请你谈谈你对vuex的理解"><span>请你谈谈你对vuex的理解</span></a></h3>
...
<h3 id="vuex—个模块中改变state中数据-其他模块如何获取" tabindex="-1"><a class="header-anchor" href="#vuex—个模块中改变state中数据-其他模块如何获取"><span>vuex—个模块中改变state中数据,其他模块如何获取</span></a></h3>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// 模块a</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vuex的状态是怎样的-怎么改变状态" tabindex="-1"><a class="header-anchor" href="#vuex的状态是怎样的-怎么改变状态"><span>vuex的状态是怎样的，怎么改变状态</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="你在项目中哪里使用vuex-vuex的应用场景" tabindex="-1"><a class="header-anchor" href="#你在项目中哪里使用vuex-vuex的应用场景"><span>你在项目中哪里使用vuex，vuex的应用场景</span></a></h3>
<p>原则:</p>
<p>​	中小型项目中，如果组件的公共状态不多的情况下，不建议使用vuex，反而会增加代码复杂度，想要组件通信，直接通过event bus即可，中大型项目中，多个组件公共状态较多情况下，建议使用vuex</p>
<p>在项目中，多个组件的公共状态可以存储的vuex中，比如电商网站的购物车数据，可以存储在vuex中。后台管理角色鉴权中的 不同角色的侧边栏数据，以及 不同角色可以访问的路由数据可以存储的vuex中，拿到数据储存。</p>
<h3 id="vuex的数据丢失知道吗-怎么解决" tabindex="-1"><a class="header-anchor" href="#vuex的数据丢失知道吗-怎么解决"><span>vuex的数据丢失知道吗  怎么解决</span></a></h3>
...
<p>具体代码如下</p>
<p>安装</p>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> i vuex-persistedstate <span class="token parameter variable">-S</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>使用</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> Vuex <span class="token keyword">from</span> <span class="token string">"vuex"</span><span class="token punctuation">;</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vuex怎么拿数据" tabindex="-1"><a class="header-anchor" href="#vuex怎么拿数据"><span>vuex怎么拿数据</span></a></h3>
<ul>
<li>
<p><strong>获取vuex state中的count数据方法有</strong>：</p>
<p>方法1： <code v-pre>this.$store.state.count</code> 直接使用；</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  方法2：`import { mapState } from vuex `</span>
<span class="line"></span>
<span class="line">  然后把`...mapState('count')放入computed中`,然后直接使用count变量。</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><strong>获取vuex getters中getCount数据的方法</strong>：</p>
<p>方法1： <code v-pre>this.$store.getters.getCount</code>直接使用。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  方法2：`import { mapGetters } from vuex `</span>
<span class="line"></span>
<span class="line">  然后把`...mapGetters ('getCount')放入computed中`，然后直接使用getCount变量。</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ul>
<h3 id="说说vuex原理" tabindex="-1"><a class="header-anchor" href="#说说vuex原理"><span>说说Vuex原理</span></a></h3>
<pre><code>   vuex 是一个专门为 vue 构建的状态管理工具，主要是为了解决 多组间之间状态共享问题。强调的是集中式管理，（组件与组件之间的关系变成了组件与仓库之间的关系）
</code></pre>
<p>vuex 的核心包括：state（存放状态）、mutations（同步的更改状态）、actions（发送异步请求，拿到数据）、getters（根据之前的状态派发新的状态）、modules（模块划分）
　　state 发布一条新的数据，在 getters 里面根据状态派发新的状态，actions 发送异步请求获取数据，然后在 mutations 里面同步的更改数据
　　应用场合：购物车的数据共享、登入注册</p>
<h3 id="vuex仓库数据很多-怎么管理" tabindex="-1"><a class="header-anchor" href="#vuex仓库数据很多-怎么管理"><span>vuex仓库数据很多，怎么管理</span></a></h3>
<p>使用moduls模块划分和文件拆分来管理数据很多的问题。
例如：我们可以在modules中进行模块划分，比如用户相关模块放入user中，
文章信息相关模块放入article中。</p>
<p>代码如下：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">modules:{</span>
...
<h3 id="vuex中actions与mutations的区别" tabindex="-1"><a class="header-anchor" href="#vuex中actions与mutations的区别"><span>vuex中actions与mutations的区别</span></a></h3>
...
<p>Action Action 类似于 mutation，不同在于：
...
1、通过提交commit改变数据
2、只是一个单纯的函数
3、不要使用异步操作，异步操作会导致变量不能追踪</p>
<h3 id="说说vue如何进行路由配置" tabindex="-1"><a class="header-anchor" href="#说说vue如何进行路由配置"><span>说说vue如何进行路由配置</span></a></h3>
<p>一、安装</p>
<p>本地环境安装路由插件vue-router：    cnpm install vue-router --save-dev</p>
<p>二、配置
两种配置方法：在main.js中 || 在src/router文件夹下的index.js中
这里只说在src/router/index.js中的</p>
<pre><code> ```javaScript
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"> Vue<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>Router<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ol start="2">
<li>
<p>配置
配置路由：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">export default new Router({</span>
...
import Home from '@/components/Content’</p>
</li>
<li>
<p>在main.js中调用index.js的配置：
import router from './router'</p>
</li>
<li>
<p>App.vue页面使用（展示）路由：<!-- 展示router --></p>
<p>把这个标签放到对应位置：  <code v-pre>&lt;router-view&gt;&lt;/router-view&gt;</code></p>
</li>
<li>
<p>路由切换（原来的<a href="XXX.html"/>等地方）：把切换标签和链接改成：
<code v-pre>&lt;router-link  to=&quot;/&quot;&gt;切换到Home组件&lt;/router-link&gt;&lt;router-link  to=&quot;/content&quot;&gt;切换到Content组件&lt;/router-link&gt;</code>
//这里，to里边的参数和配置时，path的路径一样即可</p>
</li>
</ol>
<h3 id="谈谈vue路由守卫" tabindex="-1"><a class="header-anchor" href="#谈谈vue路由守卫"><span>谈谈Vue路由守卫</span></a></h3>
<p>1、路由守卫 是什么</p>
<p>简单来说，导航守卫就是路由跳转前、中、后过程中的一些钩子函数，这个函数能让你操作一些其他的事儿，这就是导航守卫。
官方解释，vue-router提供的导航守卫主要用来通过跳转或取消的方式守卫导航。</p>
<p>2、路由守卫分类
...
<p>beforeRouteUpdate
在当前路由改变时，并且该组件被复用时调用，可以通过this访问实例。参数包括to，from，next。</p>
<p>beforeRouteLeave
导航离开该组件的对应路由时调用，可以访问组件实例this，参数包括to，from，next。
3、路由守卫回调参数
to：目标路由对象；
from：即将要离开的路由对象；
next：他是最重要的一个参数，他相当于佛珠的线，把一个一个珠子逐个串起来。</p>
<h3 id="路由守卫中页面跳转运用了哪些钩子函数" tabindex="-1"><a class="header-anchor" href="#路由守卫中页面跳转运用了哪些钩子函数"><span>路由守卫中页面跳转运用了哪些钩子函数</span></a></h3>
<p><strong>应用场景1：可进行一些页面跳转前处理，例如判断需要登录的页面进行拦截，做登录跳转！！</strong></p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">router.beforeEach((to, from, next) => {</span>
...
<span class="line">})</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>应用场景2，进入页面登录判断、管理员权限判断、浏览器判断</strong></p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">//使用钩子函数对路由进行权限跳转</span>
...
<span class="line">})</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>应用场景3：当页面中有未关闭的窗口, 或未保存的内容时, 阻止页面跳转</strong></p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">beforeRouteLeave (to, from, next) {</span>
...
<span class="line">  }</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="谈谈vue路由模式-路由有哪些模式" tabindex="-1"><a class="header-anchor" href="#谈谈vue路由模式-路由有哪些模式"><span>谈谈Vue路由模式，路由有哪些模式</span></a></h3>
<p>在vue-router路由对象中，路由有两种模式：hash和history，而默认的是hash模式.
前端路由目前主要有两种方法：
...
2、利用HTML5的History模式，使url看起来类似普通网站，以”/”分割，没有”#”，但页面并没有跳转，不过使用这种模式需要服务器端的支持，服务器在接收到所有的请求后，都指向同一个html文件，通过historyAPI，监听popState事件，用pushState和replaceState来实现。</p>
<h3 id="路由守卫的作用-全局和局部使用的差异是什么" tabindex="-1"><a class="header-anchor" href="#路由守卫的作用-全局和局部使用的差异是什么"><span>路由守卫的作用，全局和局部使用的差异是什么</span></a></h3>
<p>全局路由守卫：就是在整个网页中，只要发生了路由的变化，都会触发。全局导航守卫主要包括两个函数，分别为：beforeEach、afterEach。
局部路由守卫:（组件内的守卫）只有当前路由使用。
路由加载之前触发：beforeRouteEnter (to, from, next)
更新路由之前触发：beforeRouteUpdate (to, from, next)
离开当前路由之前触发：beforeRouteLeave (to, from, next)</p>
<h3 id="写出路由传参的具体实现" tabindex="-1"><a class="header-anchor" href="#写出路由传参的具体实现"><span>写出路由传参的具体实现</span></a></h3>
<p>方式一：params 传参（显示参数）
params 传参（显示参数）又可分为 声明式 和 编程式 两种方式
1、声明式 router-link
该方式是通过 router-link 组件的 to 属性实现，该方法的参数可以是一个字符串路径，或者一个描述地址的对象。使用该方式传值的时候，需要子路由提前配置好参数，例如：</p>
<div class="language-javaScript line-numbers-mode" data-highlighter="prismjs" data-ext="javaScript" data-title="javaScript"><pre v-pre><code><span class="line">//子路由配置</span>
<span class="line">{</span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javaScript line-numbers-mode" data-highlighter="prismjs" data-ext="javaScript" data-title="javaScript"><pre v-pre><code><span class="line">//父路由组件</span>
<span class="line">&lt;router-link to=&quot;/child/123&quot;&gt;进入Child路由&lt;/router-link&gt;</span>
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、编程式 this.$router.push
...
方式二：params 传参（不显示参数）
params 传参（不显示参数）也可分为 声明式 和 编程式 两种方式，与方式一不同的是，这里是通过路由的别名 name 进行传值的</p>
<p>1、声明式 router-link
该方式也是通过 router-link 组件的 to 属性实现，例如：</p>
<div class="language-javaScript line-numbers-mode" data-highlighter="prismjs" data-ext="javaScript" data-title="javaScript"><pre v-pre><code><span class="line">&lt;router-link :to=&quot;{name:'Child',params:{id:123}}&quot;&gt;进入Child路由&lt;/router-link&gt;</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>2、编程式 this.$router.push
...
1、声明式 router-link
该方式也是通过 router-link 组件的 to 属性实现，不过使用该方式传值的时候，需要子路由提前配置好路由别名（name 属性），例如：</p>
<div class="language-javaScript line-numbers-mode" data-highlighter="prismjs" data-ext="javaScript" data-title="javaScript"><pre v-pre><code><span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、编程式 this.$router.push
...
在子路由中可以通过下面代码来获取传递的参数值
this.$route.query.id</p>
<h3 id="vue路由有哪几种" tabindex="-1"><a class="header-anchor" href="#vue路由有哪几种"><span>vue路由有哪几种</span></a></h3>
<p>this.$router.push(obj) 跳转到指定url路径，并想history栈中添加一个记录，点击后退会返回到上一个页面
this.$router.replace(obj)  跳转到指定url路径，但是history栈中不会有记录
this.$router.go(n)  向前或者向后跳转n个页面，n可为正整数或负整数</p>
<h3 id="说一下vue路由跳转方式" tabindex="-1"><a class="header-anchor" href="#说一下vue路由跳转方式"><span>说一下vue路由跳转方式</span></a></h3>
<p>1、router-link 【实现跳转最简单的方法】
<code v-pre>&lt;router-link to='需要跳转到的页面的路径&gt;</code>
浏览器在解析时，将它解析成一个类似于<code v-pre>&lt;a&gt;</code>的标签。
<strong>div和css样式略</strong></p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"> <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>li</span> <span class="token punctuation">></span></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、<code v-pre>this.$router.push({ path:’/user’})</code>
3、<code v-pre>this.$router.replace{path：‘/’ }</code>类似，不再赘述</p>
<h3 id="vue路由的数据传参-params-query的区别。使用params什么时候会生效-什么时候不会生效-params有时会失效-为什么" tabindex="-1"><a class="header-anchor" href="#vue路由的数据传参-params-query的区别。使用params什么时候会生效-什么时候不会生效-params有时会失效-为什么"><span>vue路由的数据传参，params，query的区别。使用params什么时候会生效，什么时候不会生效，params有时会失效，为什么</span></a></h3>
<p>query和params区别
query类似 get, 跳转之后页面 url后面会拼接参数,类似?id=1, 非重要性的可以这样传,刷新页面id还在
params类似 post, 跳转之后页面 url后面不会拼接参数 , 但是刷新页面id 会消失
注意：如果提供了path，params会被忽略而导致失效。
通过官网我们知道路由中的name是不能重复的，而path是可以的。所以在函数式编程中，我们可以用变量来控制路径。</p>
<h3 id="路由守卫路由拦截如何配置" tabindex="-1"><a class="header-anchor" href="#路由守卫路由拦截如何配置"><span>路由守卫路由拦截如何配置</span></a></h3>
<p>通常在项目里，我们需要用户进行登录，才能让用户查看项目。在后台管理系统中，会根据不同的用户权限展示不同的内容。
在用户访问页面之前，我们通过全局前置守卫对路由进行拦截，看看你是不是可以通过。通过的标准是否登录，如果登录就通过放行，没有通过就打回。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 不需要路由验证页面 </span>
...
<span class="line">})</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>需要注意的一点是，用户没有登录，是需要跳转到登录页面，如果在白名单里面没有登录页或者没有next()，页面一直跳转直到内存溢出。</p>
<p>每个项目的验证是否拥有权限不一样，权限判断那一块可以根据自己的实项目需求来进行操作。</p>
<h3 id="写公用组件的时候-怎么提高可配置性" tabindex="-1"><a class="header-anchor" href="#写公用组件的时候-怎么提高可配置性"><span>写公用组件的时候，怎么提高可配置性</span></a></h3>
<ol>
<li>
<p>带着开放封闭原则的视角思考</p>
<p>开放原则，是说我们需要将有可能变动的属性，通过props接口的方式暴露给组件的调用者。</p>
<p>封闭原则，意思是我们需要将该组件的通用能力及逻辑封装再组件内部，让调用者使用更加方便</p>
</li>
<li>
<p>组件的可配置性需要结合实际的业务需求具体分析</p>
<blockquote>
<p>假设我们要封装一个Tab选项卡组件，实际功能交互可参考<a href="https://element.eleme.cn/#/zh-CN/component/tabs" target="_blank" rel="noopener noreferrer">组件 | Element</a></p>
</blockquote>
</li>
<li>
<p>组件的开放原则实践</p>
...
<td style="text-align:left">标签的宽度是否自撑开</td>
<td style="text-align:left">boolean</td>
<td style="text-align:left">-</td>
<td style="text-align:left">false</td>
</tr>
<tr>
<td style="text-align:left">before-leave</td>
<td style="text-align:left">切换标签之前的钩子，若返回 false 或者返回 Promise 且被 reject，则阻止切换。</td>
<td style="text-align:left">Function(activeName, oldActiveName)</td>
<td style="text-align:left">—</td>
<td style="text-align:left">—</td>
</tr>
</tbody>
...
<ul>
<li>配置项要尽可能多的，覆盖到业务中可能出现的每一种情况。</li>
<li>保证组件在每一项配置缺省状态下都能够正常表现</li>
<li>每一项配置都应该具备合理的默认值。</li>
</ul>
<ol>
<li>
<p>组件的封闭原则实践</p>
...
<ul>
<li>
<p>事件函数相关逻辑，必须在组件内部封装完善</p>
</li>
<li>
<p>自定义事件函数在触发时，必须能够返回相关的参数</p>
<blockquote>
<p>例如 @tab-click 事件会给函数返回，被点击菜单的index下标等信息</p>
</blockquote>
</li>
<li>
<p>事件函数本身也需要能够在缺省状态下，保持组件的正常运行。</p>
</li>
</ul>
<h3 id="vue-router怎么生成动态地址" tabindex="-1"><a class="header-anchor" href="#vue-router怎么生成动态地址"><span>vue-router怎么生成动态地址</span></a></h3>
<ol>
<li>
<h6 id="动态路由配置的应用场景" tabindex="-1"><a class="header-anchor" href="#动态路由配置的应用场景"><span>动态路由配置的应用场景</span></a></h6>
<p>一般我们在使用vue-router进行路由管理的时候，是通过如下方式配置<code v-pre>路由</code>与<code v-pre>组件</code>之间的<code v-pre>映射关系</code>:</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// router/index.js配置文件</span>
...
<span class="line">})</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是在后台管理平台这种类型的项目中，我们需要让拥有不同<code v-pre>角色权限</code>的用户，访问不同的<code v-pre>菜单</code>及<code v-pre>路由</code>，如上述代码所示，部分路由只有管理员才能访问，而另外一部分路由只能vip用户才能访问，所以需要用到vue-router提供的<code v-pre>addRoute</code>方法来动态管理这一部分路由配置。</p>
</li>
<li>
<h6 id="本地只配置通用路由" tabindex="-1"><a class="header-anchor" href="#本地只配置通用路由"><span>本地只配置通用路由</span></a></h6>
<p>我们为了实现路由的动态配置，需要将上述路由配置进行拆分，本地配置文件中，只保留通用的路由映射。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">const router = new VueRouter({</span>
<span class="line">    routes:[</span>
<span class="line">        {</span>
<span class="line">            path:'/login',</span>
<span class="line">            component:()=>import ('../views/Login') //登录路由</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<h6 id="后端为每个用户分配一个角色-随登录接口下发给前端" tabindex="-1"><a class="header-anchor" href="#后端为每个用户分配一个角色-随登录接口下发给前端"><span>后端为每个用户分配一个角色，随登录接口下发给前端</span></a></h6>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">app.get('/login',(req,res)=>{</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<h6 id="前端登录并动态获取路由配置" tabindex="-1"><a class="header-anchor" href="#前端登录并动态获取路由配置"><span>前端登录并动态获取路由配置</span></a></h6>
<p>前端登录成功后，会得到后端动态下发的，跟自己账号角色相匹配的路由数据，此时可以通过addRoute方法，将这些动态获取的路由配置数据包，设置给router对象</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// views/Login.vue 登录面板</span>
<span class="line"></span>
...
<h3 id="vue-router有哪些方法" tabindex="-1"><a class="header-anchor" href="#vue-router有哪些方法"><span>vue-router有哪些方法</span></a></h3>
<ol>
<li>
<h6 id="router-beforeeach-路由守卫" tabindex="-1"><a class="header-anchor" href="#router-beforeeach-路由守卫"><span>router.beforeEach 路由守卫</span></a></h6>
<p>我们可以使用这个方法，按需拦截用户访问某些敏感路由，例如:</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">router.beforeEach((to,from,next)=>{ //路由的全局前置守卫</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<h6 id="router-push-编程式导航" tabindex="-1"><a class="header-anchor" href="#router-push-编程式导航"><span>router.push 编程式导航</span></a></h6>
<p>通过编程式导航，我们可以通过事件的方式触发路由跳转</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 字符串</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<h6 id="router-go、router-back、router-forward-路由的进入与返回" tabindex="-1"><a class="header-anchor" href="#router-go、router-back、router-forward-路由的进入与返回"><span>router.go、router.back、router.forward 路由的进入与返回</span></a></h6>
<blockquote>
<p>router.go 作用等同于<code v-pre>window.history.go</code></p>
</blockquote>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 在浏览器记录中前进一步，等同于 history.forward()</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<h6 id="router-addroute-动态设置路由映射" tabindex="-1"><a class="header-anchor" href="#router-addroute-动态设置路由映射"><span>router.addRoute 动态设置路由映射</span></a></h6>
<p>添加一条新路由规则。如果该路由规则有 <code v-pre>name</code>，并且已经存在一个与之相同的名字，则会覆盖它。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">axios.get('/login',(result)=>{  //通过异步接口获取对应用户的特有路由配置</span>
<span class="line"> let {routerList} = result</span>
<span class="line"> routerList.forEach((item) => {</span>
...
<h3 id="谈谈对mvvm的理解" tabindex="-1"><a class="header-anchor" href="#谈谈对mvvm的理解"><span>谈谈对MVVM的理解</span></a></h3>
<ol>
<li>
<h6 id="什么是mvvm" tabindex="-1"><a class="header-anchor" href="#什么是mvvm"><span>什么是MVVM</span></a></h6>
<p>不管是MVC，MVP，或者MVVM，都是常见的软件架构设计模式（Architectural Pattern），它通过分离关注点来改进代码的组织方式。不同于设计模式（Design Pattern），只是为了解决一类问题而总结出的抽象方法，一种架构模式往往使用了多种设计模式。MVVM，可以拆分为<strong>Model-View-ViewModel</strong>来理解：</p>
<ul>
<li><strong>Model</strong> -  数据模型，可以对应到真实开发过程中的<code v-pre>数据包</code></li>
<li><strong>View</strong> -   视图层，布局和外观，可以对应到真实开发中的<code v-pre>DOM结构</code></li>
<li><strong>ViewModel</strong> - 扮演“View”和“Model”之间的使者，帮忙处理 <strong>View</strong> 视图层的全部业务逻辑</li>
</ul>
</li>
<li>
<h6 id="为什么使用mvvm框架" tabindex="-1"><a class="header-anchor" href="#为什么使用mvvm框架"><span>为什么使用MVVM框架</span></a></h6>
<p>要回答这个问题，我们需要对比一下，在使用MVVM框架之前，我们是如何完成前端交互的。</p>
<ul>
<li>使用前</li>
</ul>
<blockquote>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;div>{{name}}&lt;/div></span>
<span class="line"></span>
<span class="line">data:{</span>
...
<li>
<h6 id="通过上述案例进一步理解mvvm" tabindex="-1"><a class="header-anchor" href="#通过上述案例进一步理解mvvm"><span>通过上述案例进一步理解MVVM</span></a></h6>
<ul>
<li>name数据包可以认为就是那个Model</li>
<li>div  节点可以认为就是那个View</li>
<li>而Vue提供的语法环境所支持的数据驱动能力，就可以认为是那个ViewModel</li>
</ul>
</li>
</ol>
<h3 id="vue-router有什么组件" tabindex="-1"><a class="header-anchor" href="#vue-router有什么组件"><span>vue-router有什么组件</span></a></h3>
<ol>
<li>
<h6 id="router-link-组件" tabindex="-1"><a class="header-anchor" href="#router-link-组件"><span>router-link 组件</span></a></h6>
<p><code v-pre>&lt;router-link&gt;</code> 组件支持用户在具有路由功能的应用中 (点击) 导航。 通过 <code v-pre>to</code> 属性指定目标地址，默认渲染成带有正确链接的 <code v-pre>&lt;a&gt;</code> 标签，可以通过配置 <code v-pre>tag</code> 属性生成别的标签.。另外，当目标路由成功激活时，链接元素自动设置一个表示激活的 CSS 类名。</p>
<p><code v-pre>&lt;router-link&gt;</code> 比起写死的 <code v-pre>&lt;a href=&quot;...&quot;&gt;</code> 会好一些，理由如下：</p>
<ul>
<li>无论是 HTML5 history 模式还是 hash 模式，它的表现行为一致，所以，当你要切换路由模式，或者在 IE9 降级使用 hash 模式，无须作任何变动。</li>
<li>在 HTML5 history 模式下，<code v-pre>router-link</code> 会守卫点击事件，让浏览器不再重新加载页面。</li>
<li>当你在 HTML5 history 模式下使用 <code v-pre>base</code> 选项之后，所有的 <code v-pre>to</code> 属性都不需要写 (基路径) 了。</li>
</ul>
</li>
<li>
<p>router-view组件</p>
<p><code v-pre>&lt;router-view&gt;</code> 组件是一个 functional 组件，渲染路径匹配到的视图组件。<code v-pre>&lt;router-view&gt;</code> 渲染的组件还可以内嵌自己的 <code v-pre>&lt;router-view&gt;</code>，根据嵌套路径，渲染嵌套组件。</p>
<p>其他属性 (非 router-view 使用的属性) 都直接传给渲染的组件， 很多时候，每个路由的数据都是包含在路由参数中。</p>
<p>因为它也是个组件，所以可以配合 <code v-pre>&lt;transition&gt;</code> 和 <code v-pre>&lt;keep-alive&gt;</code> 使用。如果两个结合一起用，要确保在内层使用 <code v-pre>&lt;keep-alive&gt;</code>：</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>transition</span><span class="token punctuation">></span></span></span>
...
<li>
<p>vue-router使用pushState进行路由更新，静态跳转，页面不会重新加载；</p>
</li>
<li>
<p>location.href会触发浏览器，页面重新加载一次</p>
</li>
<li>
<p>vue-router使用diff算法，实现按需加载，减少dom操作</p>
</li>
<li>
<p>vue-router是路由跳转或同一个页面跳转；location.href是不同页面间跳转；</p>
</li>
<li>
<p>vue-router是异步加载this.$nextTick(()=&gt;{获取url})；location.href是同步加载</p>
</li>
</ol>
<h3 id="vue-cli怎么自定义组件" tabindex="-1"><a class="header-anchor" href="#vue-cli怎么自定义组件"><span>vue-cli怎么自定义组件</span></a></h3>
<ol>
<li>
<h4 id="组件封装" tabindex="-1"><a class="header-anchor" href="#组件封装"><span>组件封装</span></a></h4>
</li>
</ol>
<div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre v-pre><code><span class="line">// HelloWorld.vue组件</span>
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span></span>
<span class="line">  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li>
<h4 id="局部注册调用组件" tabindex="-1"><a class="header-anchor" href="#局部注册调用组件"><span>局部注册调用组件</span></a></h4>
</li>
</ol>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// Test.vue</span>
<span class="line">&lt;template></span>
<span class="line">    &lt;div></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li>
<h4 id="全局注册使用" tabindex="-1"><a class="header-anchor" href="#全局注册使用"><span>全局注册使用</span></a></h4>
</li>
</ol>
<ul>
<li>先在main.js中全局注册该组件</li>
</ul>
...
<h5 id="一-vue-loader的作用是什么" tabindex="-1"><a class="header-anchor" href="#一-vue-loader的作用是什么"><span>一. vue-loader的作用是什么</span></a></h5>
<ol>
<li>
<p>首先我们需要达成共识的是，目前浏览器，只能识别普通的html、css、javascript。</p>
</li>
<li>
<p>但是为了能够方便使用vue的组件化开发，需要我们将代码写在.vue单文件组件中。</p>
</li>
<li>
<p>.vue文件，以及其内部的template、style、script区域代码，不能直接交给浏览器去解析，因为它解析不了。</p>
</li>
<li>
<p>所以我们需要一个vue-loader进行.vue单文件组件代码的转换，也就是</p>
<blockquote>
<p>.vue方便开发  ------&gt;  vue-laoder协助翻译  -----&gt;  浏览器才能展示</p>
</blockquote>
</li>
</ol>
<h5 id="二-vue-loader-工作原理" tabindex="-1"><a class="header-anchor" href="#二-vue-loader-工作原理"><span>二. vue-loader 工作原理</span></a></h5>
<p><strong>vue-loader</strong> 的工作流程， 简单来说，分为以下几个步骤:</p>
<ol>
<li>将一个 <strong>.vue 文件</strong> 切割成 <strong>template</strong>、<strong>script</strong>、<strong>styles</strong> 三个部分。</li>
<li><strong>template 部分</strong> 通过 <strong>compile</strong> 生成 <strong>render</strong>、 <strong>staticRenderFns</strong>。</li>
<li>获取 <strong>script 部分</strong> 返回的配置项对象 <strong>scriptExports</strong>。</li>
<li><strong>styles 部分</strong>，会通过 <strong>css-loader</strong>、<strong>vue-style-loader</strong>， 添加到 <strong>head</strong> 中， 或者通过 <strong>css-loader</strong>、<strong>MiniCssExtractPlugin</strong> 提取到一个 <strong>公共的css文件</strong> 中。</li>
<li>使用 <strong>vue-loader</strong> 提供的 <strong>normalizeComponent</strong> 方法， <strong>合并 scriptExports、render、staticRenderFns</strong>， 返回 <strong>构建vue组件需要的配置项对象 - options</strong>， 即 <strong>{data, props, methods, render, staticRenderFns...}</strong>。</li>
</ol>
<h3 id="vue实例中的data-在生命周期哪里能找到" tabindex="-1"><a class="header-anchor" href="#vue实例中的data-在生命周期哪里能找到"><span>vue实例中的data，在生命周期哪里能找到</span></a></h3>
<p>如果想要了解哪个生命周期中可以找到vue实例的data，那我们必须了解，vue实例初始化的基本流程。</p>
<h5 id="一、vue实例的初始化过程" tabindex="-1"><a class="header-anchor" href="#一、vue实例的初始化过程"><span>一、vue实例的初始化过程</span></a></h5>
<h6 id="_1-new-vue" tabindex="-1"><a class="header-anchor" href="#_1-new-vue"><span>1. new Vue</span></a></h6>
<p>从 <code v-pre>new Vue(options)</code> 开始作为入口，<code v-pre>Vue</code> 只是一个简单的构造函数，内部是这样的：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">function Vue (options) {</span>
<span class="line">  this._init(options)</span>
<span class="line">}</span>
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入了 <code v-pre>_init</code> 函数之后，先初始化了一些属性。</p>
<ol>
<li><code v-pre>initLifecycle</code>：初始化一些属性如<code v-pre>$parent</code>，<code v-pre>$children</code>。根实例没有 <code v-pre>$parent</code>，<code v-pre>$children</code> 开始是空数组，直到它的 <code v-pre>子组件</code> 实例进入到 <code v-pre>initLifecycle</code> 时，才会往父组件的 <code v-pre>$children</code> 里把自身放进去。所以 <code v-pre>$children</code> 里的一定是组件的实例。</li>
<li><code v-pre>initEvents</code>：初始化事件相关的属性，如 <code v-pre>_events</code> 等。</li>
<li><code v-pre>initRender</code>：初始化渲染相关如 <code v-pre>$createElement</code>，并且定义了 <code v-pre>$attrs</code> 和 <code v-pre>$listeners</code> 为<code v-pre>浅层</code>响应式属性。具体可以查看<code v-pre>细节</code>章节。并且还定义了<code v-pre>$slots</code>、<code v-pre>$scopedSlots</code>，其中 <code v-pre>$slots</code> 是立刻赋值的，但是 <code v-pre>$scopedSlots</code> 初始化的时候是一个 <code v-pre>emptyObject</code>，直到组件的 <code v-pre>vm._render</code> 过程中才会通过 <code v-pre>normalizeScopedSlots</code> 去把真正的 <code v-pre>$scopedSlots</code> 整合后挂到 <code v-pre>vm</code> 上。</li>
</ol>
<p>然后开始第一个生命周期：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">callHook(vm, 'beforeCreate')</span>
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_2-beforecreate被调用完成" tabindex="-1"><a class="header-anchor" href="#_2-beforecreate被调用完成"><span>2. beforeCreate被调用完成</span></a></h6>
<p><code v-pre>beforeCreate</code> 之后</p>
<ol>
<li>
<p>初始化 <code v-pre>inject</code></p>
</li>
<li>
<p>初始化</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">state</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li>初始化 <code v-pre>props</code></li>
<li>初始化 <code v-pre>methods</code></li>
<li>初始化 <code v-pre>data</code></li>
<li>初始化 <code v-pre>computed</code></li>
<li>初始化 <code v-pre>watch</code></li>
</ul>
</li>
<li>
<p>初始化 <code v-pre>provide</code></p>
</li>
</ol>
<p>所以在 <code v-pre>data</code> 中可以使用 <code v-pre>props</code> 上的值，反过来则不行。</p>
<p>然后进入 <code v-pre>created</code> 阶段：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">callHook(vm, 'created')</span>
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-created被调用完成" tabindex="-1"><a class="header-anchor" href="#_3-created被调用完成"><span>3. created被调用完成</span></a></h6>
<p>调用 <code v-pre>$mount</code> 方法，开始挂载组件到 <code v-pre>dom</code> 上。</p>
<p>如果使用了 <code v-pre>runtime-with-compile</code> 版本，则会把你传入的 <code v-pre>template</code> 选项，或者 <code v-pre>html</code> 文本，通过一系列的编译生成 <code v-pre>render</code> 函数。</p>
<ul>
<li>编译这个 <code v-pre>template</code>，生成 <code v-pre>ast</code> 抽象语法树。</li>
<li>优化这个 <code v-pre>ast</code>，标记静态节点。（渲染过程中不会变的那些节点，优化性能）。</li>
<li>根据 <code v-pre>ast</code>，生成 <code v-pre>render</code> 函数。</li>
</ul>
<p>对应具体的代码就是：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">const ast = parse(template.trim(), options)</span>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是脚手架搭建的项目的话，这一步 <code v-pre>vue-cli</code> 已经帮你做好了，所以就直接进入 <code v-pre>mountComponent</code> 函数。</p>
<p>那么，确保有了 <code v-pre>render</code> 函数后，我们就可以往<code v-pre>渲染</code>的步骤继续进行了</p>
<h5 id="二、结论" tabindex="-1"><a class="header-anchor" href="#二、结论"><span>二、结论</span></a></h5>
...
<h3 id="vue的路由有哪些钩子函数-可以用来做什么" tabindex="-1"><a class="header-anchor" href="#vue的路由有哪些钩子函数-可以用来做什么"><span>vue的路由有哪些钩子函数，可以用来做什么</span></a></h3>
<h4 id="一、全局守卫" tabindex="-1"><a class="header-anchor" href="#一、全局守卫"><span>一、全局守卫</span></a></h4>
<p>顾名思义，是要定义在全局的，也就是我们 <code v-pre>index.js</code> 中的 <code v-pre>router</code> 对象。</p>
<h5 id="_1-beforeeach" tabindex="-1"><a class="header-anchor" href="#_1-beforeeach"><span>1. beforeEach</span></a></h5>
<p>全局前置守卫，在路由跳转前触发，它在 <strong>每次导航</strong> 时都会触发。</p>
<p>通过 <code v-pre>router.beforeEach</code> 注册一个全局前置守卫。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">router<span class="token punctuation">.</span><span class="token function">beforeEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">to<span class="token punctuation">,</span> from<span class="token punctuation">,</span> next</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span></span>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>参数</strong></p>
<p><code v-pre>beforeEach</code> 全局前置守卫接收三个参数</p>
<ul>
<li><strong>to: Route</strong>: 即将要进入的目标路由对象</li>
<li><strong>from: Route</strong>: 当前导航正要离开的路由对象</li>
<li><strong>next: Function</strong>: 一定要调用该方法不然会阻塞路由。</li>
</ul>
<p><strong>注意：</strong> <code v-pre>next</code> 参数可以不添加，但是一旦添加，则必须调用一次，否则路由跳转等会停止。</p>
<p><code v-pre>next（）</code>方法的几种情况</p>
<ul>
<li><strong>next():</strong> 进行管道中的下一个钩子。</li>
<li><strong>next(false):</strong> 中断当前的导航。回到 <code v-pre>from</code> 路由对应的地址。</li>
<li><strong>next('/') 或者 next({ path: '/' }):</strong> 跳转到一个不同的地址，可传递的参数与 <code v-pre>router.push</code> 中选项一致。</li>
<li><strong>next(error):</strong> 导航终止，且该错误会被传递给 <code v-pre>router.onError()</code> 注册过的回调。、</li>
</ul>
<h5 id="_2-beforeresolve" tabindex="-1"><a class="header-anchor" href="#_2-beforeresolve"><span>2. beforeResolve</span></a></h5>
<p>全局解析守卫，在路由跳转前，所有 <strong>组件内守卫</strong> 和 <strong>异步路由组件</strong> 被解析之后触发，它同样在 <strong>每次导航</strong> 时都会触发。</p>
<p>通过 <code v-pre>router.beforeResolve</code> 注册一个全局解析守卫。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">router<span class="token punctuation">.</span><span class="token function">beforeResolve</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">to<span class="token punctuation">,</span> from<span class="token punctuation">,</span> next</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span></span>
<span class="line">  <span class="token function">next</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>回调参数，返回值和 <code v-pre>beforeEach</code> 一样。也可以定义多个全局解析守卫。</p>
<h5 id="_3-aftereach" tabindex="-1"><a class="header-anchor" href="#_3-aftereach"><span>3. afterEach</span></a></h5>
<p>全局后置钩子，它发生在路由跳转完成后，<code v-pre>beforeEach</code> 和 <code v-pre>beforeResolve</code> 之后，<code v-pre>beforeRouteEnter</code>（组件内守卫）之前。它同样在 <strong>每次导航</strong> 时都会触发。</p>
<p>通过 <code v-pre>router.afterEach</code> 注册一个全局后置钩子。</p>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个钩子的两个参数和 <code v-pre>beforeEach</code> 中的 <code v-pre>to</code> 和 <code v-pre>from</code> 一样。然而和其它全局钩子不同的是，这些钩子不会接受 <code v-pre>next</code> 函数，也不会改变导航本身。</p>
<h4 id="二、路由守卫" tabindex="-1"><a class="header-anchor" href="#二、路由守卫"><span>二、路由守卫</span></a></h4>
<p>顾名思义，就是跟路由相关的钩子，我们的路由守卫只有一个，就是 <code v-pre>beforeEnter</code>。</p>
<h5 id="_1-beforeenter" tabindex="-1"><a class="header-anchor" href="#_1-beforeenter"><span>1. beforeEnter</span></a></h5>
<p>需要在路由配置上定义 <code v-pre>beforeEnter</code> 守卫，此守卫只在进入路由时触发，在 <code v-pre>beforeEach</code> 之后紧随执行，不会在 <code v-pre>params</code>、<code v-pre>query</code> 或 <code v-pre>hash</code> 改变时触发。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">//index.js</span></span>
<span class="line"><span class="token punctuation">{</span></span>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>beforeEnter</code> 路由守卫的参数是 <code v-pre>to</code>、<code v-pre>from</code>、<code v-pre>next</code> ，同 <code v-pre>beforeEach</code> 一样。</p>
<h4 id="三、组件守卫" tabindex="-1"><a class="header-anchor" href="#三、组件守卫"><span>三、组件守卫</span></a></h4>
<p>顾名思义，是定义在路由组件内部的守卫。</p>
<h5 id="_1-beforerouteenter" tabindex="-1"><a class="header-anchor" href="#_1-beforerouteenter"><span>1. beforeRouteEnter</span></a></h5>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">//A.vue</span></span>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>路由进入组件之前调用，该钩子在全局守卫 <code v-pre>beforeEach</code> 和路由守卫 <code v-pre>beforeEnter</code> 之后，全局 <code v-pre>beforeResolve</code> 和全局 <code v-pre>afterEach</code> 之前调用。</p>
<p>参数包括 <code v-pre>to</code>，<code v-pre>from</code>，<code v-pre>next</code>。</p>
<p>该守卫内访问不到组件的实例，也就是 <code v-pre>this</code> 为 <code v-pre>undefined</code>，也就是他在 <code v-pre>beforeCreate</code> 生命周期前触发。</p>
<h5 id="_2-beforerouteupdate" tabindex="-1"><a class="header-anchor" href="#_2-beforerouteupdate"><span>2. beforeRouteUpdate</span></a></h5>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">//A.vue</span></span>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于 <code v-pre>beforeRouteUpdate</code> 来说，<code v-pre>this</code> 已经可用了，所以给 <code v-pre>next</code> 传递回调就没有必要了。</p>
<h5 id="_3-beforerouteleave" tabindex="-1"><a class="header-anchor" href="#_3-beforerouteleave"><span>3. beforeRouteLeave</span></a></h5>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">//A.vue</span></span>
...
<span class="line">复制代码</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于 <code v-pre>beforeRouteLeave</code> 来说，<code v-pre>this</code> 已经可用了，所以给 <code v-pre>next</code> 传递回调就没有必要了。</p>
<h4 id="四、总结" tabindex="-1"><a class="header-anchor" href="#四、总结"><span>四、总结</span></a></h4>
<p><strong>完整的导航解析流程</strong></p>
<blockquote>
<ol>
<li>导航被触发。</li>
<li>在失活的组件里调用 <code v-pre>beforeRouteLeave</code> 守卫。</li>
<li>调用全局的 <code v-pre>beforeEach</code> 守卫。</li>
<li>在重用的组件里调用 <code v-pre>beforeRouteUpdate</code> 守卫。</li>
<li>在路由配置里调用 <code v-pre>beforeEnter</code>。</li>
<li>解析异步路由组件。</li>
<li>在被激活的组件里调用 <code v-pre>beforeRouteEnter</code>。</li>
<li>调用全局的 <code v-pre>beforeResolve</code> 守卫。</li>
<li>导航被确认。</li>
<li>调用全局的 <code v-pre>afterEach</code> 钩子。</li>
<li>触发 <code v-pre>DOM</code> 更新。</li>
<li>调用 <code v-pre>beforeRouteEnter</code> 守卫中传给 <code v-pre>next</code> 的回调函数，创建好的组件实例会作为回调函数的参数传入。</li>
</ol>
</blockquote>
<h3 id="计算属性通常用来干什么" tabindex="-1"><a class="header-anchor" href="#计算属性通常用来干什么"><span>计算属性通常用来干什么</span></a></h3>
<h4 id="一、理解计算属性的概念" tabindex="-1"><a class="header-anchor" href="#一、理解计算属性的概念"><span>一、理解计算属性的概念</span></a></h4>
...
<h4 id="二、computed计算属性的特点" tabindex="-1"><a class="header-anchor" href="#二、computed计算属性的特点"><span>二、computed计算属性的特点</span></a></h4>
<ol>
<li>computed内部对data做出处理，其处理结果可以像data一样，可以直接在页面中渲染。</li>
<li>computed内部逻辑会<code v-pre>自动</code>识别到data的变化，从而做出新的操作，得出新的数据，从而自动更新视图。</li>
<li>computed处理的数据具有<code v-pre>缓存</code>的能力，如果data不变，则页面中调用的都是computed第一次执行时的运算结果，提高渲染性能。</li>
</ol>
<h4 id="三、computed应用场景" tabindex="-1"><a class="header-anchor" href="#三、computed应用场景"><span>三、computed应用场景</span></a></h4>
<blockquote>
<p>当某个前端已经指定的data数据包，如果我们渲染前，对其有过滤、筛选等操作需求，就可以使用computed</p>
</blockquote>
<ol>
<li>字符串翻转的官方案例，就是将一个普通字符串翻转后再渲染到视图。</li>
</ol>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">new Vue({</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li>如果一个班级中有很多学生，每个学生通过一个对象来表达，现在我们需要根据学员成绩来进行动态切换显示：<code v-pre>全部学员</code>、<code v-pre>及格学员</code>、<code v-pre>不及格学员</code>，这种在本地进行筛选的需求可以快速通过computed实现，代码逻辑大致如下:</li>
</ol>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="computed和watch的区别" tabindex="-1"><a class="header-anchor" href="#computed和watch的区别"><span>computed和watch的区别</span></a></h3>
<p>上一个问题我们已经详细探讨了computed的相关特征，在这里我们可以逐一对比一下:</p>
<ol>
<li>两者都跟data有关，区别在于
<ul>
<li>computed   在处理完data后，会提供一个新的数据包以供使用</li>
<li>watch   只会监听某个指定data的变化，执行相关的逻辑，不会提供新的数据</li>
</ul>
</li>
<li>两者的使用倾向不同
<ul>
<li>computed   内部虽然有逻辑，但是使用时更加多的关心其提供的<code v-pre>新数据包</code></li>
<li>watch     更加关注data数据变化所引发的<code v-pre>行为逻辑</code></li>
</ul>
</li>
</ol>
<h3 id="状态管理器的数据走向是什么" tabindex="-1"><a class="header-anchor" href="#状态管理器的数据走向是什么"><span>状态管理器的数据走向是什么</span></a></h3>
<h4 id="一、什么是状态管理" tabindex="-1"><a class="header-anchor" href="#一、什么是状态管理"><span>一、什么是状态管理？</span></a></h4>
<blockquote>
<p>状态管理就是，<strong>把组件之间需要共享的状态抽取出来，遵循特定的约定，统一来管理，让状态的变化可以预测</strong>。</p>
</blockquote>
<h4 id="二、为什么需要状态管理" tabindex="-1"><a class="header-anchor" href="#二、为什么需要状态管理"><span>二、为什么需要状态管理？</span></a></h4>
<h4 id="状态共享" tabindex="-1"><a class="header-anchor" href="#状态共享"><span>状态共享</span></a></h4>
<p>组件之间通常会有一些共享的状态，在 Vue 或者 React 中我们一般会将这部分状态提升至公共父组件的 <code v-pre>props</code> 中，由父组件来统一管理共享的状态，状态的改变也是由父组件执行并向下传递。这样会导致两个问题:</p>
<ul>
<li>需要将共享的状态提升至公共的父组件，若无公共的父组件，往往需要自行构造</li>
<li>状态由父组件自上而下逐层传递，若组件层级过多，数据传递会变得很冗杂</li>
</ul>
<h4 id="变化跟踪" tabindex="-1"><a class="header-anchor" href="#变化跟踪"><span>变化跟踪</span></a></h4>
<p>在应用调试过程中，可能会有跟踪状态变化过程的需求，方便对某些应用场景的复现和回溯。这时候就需要统一对状态进行管理，并遵循特定的约定去变更状态，从而让状态的变化可预测。</p>
<h4 id="三、单项数据流" tabindex="-1"><a class="header-anchor" href="#三、单项数据流"><span>三、单项数据流</span></a></h4>
<p>因为在真实项目开发过程中，Store状态管理器中的数据会在很多组件中用到，如果不设定一个统一的规范去管理数据，最终将会导致数据混乱、使得项目变得难以维护。所以vuex状态管理器设计了如下几个核心api，与视图之间进行交互配合:</p>
<ul>
<li>
<p>state</p>
<p>vuex提供的，用以集中存储共享的数据。</p>
</li>
<li>
<p>mutations</p>
<p>vuex提供的，专门用以触发state数据变化的方法集，并且要求mutations的方法执行结果必须时可预测的，在其内部不能出现异步请求等不可预测的逻辑。</p>
</li>
<li>
<p>actions</p>
<p>vuex提供的，专门用于让vuex进行异步请求处理的方法集，可选择使用。</p>
</li>
<li>
<p>view</p>
<p>视图层，整个项目组件的代称，我们在此处消费状态管理器提供的数据、方法。</p>
</li>
</ul>
<p>数据走向必须遵循单向数据流的规范:</p>
<ol>
<li>
<p>当我们初始化使用状态机数据时的流程是</p>
<blockquote>
<p>store----&gt;state----&gt; view</p>
</blockquote>
</li>
<li>
<p>当组件内部想要本地更新状态管理器的数据，其流程是</p>
<blockquote>
<p>view触发----&gt;mutations----&gt;state----&gt;store----&gt;view更新</p>
</blockquote>
</li>
<li>
<p>当组件内部想要在异步请求后，再更新本地状态管理器的数据，其流程是</p>
<blockquote>
<p>view触发----&gt;actions----&gt;mutations----&gt;state----&gt;store----&gt;view更新</p>
</blockquote>
</li>
</ol>
<h3 id="vuex数据丢失怎么解决" tabindex="-1"><a class="header-anchor" href="#vuex数据丢失怎么解决"><span>vuex数据丢失怎么解决</span></a></h3>
<p>vuex的 store 中的数据是保存在运行内存中的，当页面刷新时，页面会重新加载 vue 实例，vuex 里面的数据就会被重新赋值，这样就会出现页面刷新vuex中的数据丢失的问题。 如何解决浏览器刷新数据丢失问题呢？</p>
<h5 id="方法一-手动操作本地存储" tabindex="-1"><a class="header-anchor" href="#方法一-手动操作本地存储"><span>方法一：手动操作本地存储</span></a></h5>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"> <span class="token function">created</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="方法二-安装-vuex-persistedstate-插件" tabindex="-1"><a class="header-anchor" href="#方法二-安装-vuex-persistedstate-插件"><span>方法二：安装 vuex-persistedstate 插件</span></a></h5>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">1. npm install vuex-persistedstate -S //安装插件</span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这时候就需要使用 sessionStorage 进行存储，修改 plugins 中的代码</p>
...
<span class="line"><span class="token punctuation">]</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="怎么理解v-for的key值" tabindex="-1"><a class="header-anchor" href="#怎么理解v-for的key值"><span>怎么理解v-for的key值</span></a></h3>
<p>key的值一般为string或则number的类型，它用于解决在进行虚拟dom更新时的更新对象快速定位，虚拟dom更新需要逐个对比虚拟dom对象绑定的数据，这个过程称为diff算法，所以key也是提升diff算法的一个标识符，因为数组可能会进行排序以及增删等动作，所以使用数组的下标来定义key是没有任何作用的</p>
<h3 id="能不能自己实现v-model的功能" tabindex="-1"><a class="header-anchor" href="#能不能自己实现v-model的功能"><span>能不能自己实现v-model的功能</span></a></h3>
<p>可以的，自定义一个指令，给节点绑定上添加input的功能，数据使用value绑定，在用户输入数据的时候，采用oninput事件来进行数据获取，并实时更新value数据，即可实现v-model的功能</p>
<h3 id="vue双向数据绑定-怎么知道数据变了" tabindex="-1"><a class="header-anchor" href="#vue双向数据绑定-怎么知道数据变了"><span>Vue双向数据绑定，怎么知道数据变了</span></a></h3>
<p>在Vue2.x中采用ES5的对象属性定义方法(Object.defineProperty)来给每一个数据添加额外属性(getter和setter属性)进行数据拦截，在vue内部实现对拦截数据的setter方法数据更新消息发布机制来获取数据更新消息，对getter方法实现消息订阅机制来获取数据更新</p>
<h3 id="退出登录头像还在是什么原因怎么办" tabindex="-1"><a class="header-anchor" href="#退出登录头像还在是什么原因怎么办"><span>退出登录头像还在是什么原因怎么办</span></a></h3>
<p>多方面的原因引起的：
1、头像信息是否采用了应用缓存机制，如果有需要清除H5应用缓存
2、头像缓存在webStorage中，退出没有清除，直接清除
3、缓存在移动设备的数据，也需要清除
4、缓存在vuex或redux中的数据，直接清除即可
5、浏览器缓存，清除cookie或则强制清除浏览器缓存</p>
<h3 id="vue数据双向绑定如何实现-如果不用vue-用原生js代码怎么实现" tabindex="-1"><a class="header-anchor" href="#vue数据双向绑定如何实现-如果不用vue-用原生js代码怎么实现"><span>vue数据双向绑定如何实现，如果不用vue，用原生js代码怎么实现</span></a></h3>
<p>1、获取传递进来的数据，然后对所有数据添加getter和setter方法，并在setter方法中添加消息订阅回调方法，在getter方法中实现数据更新发布回调方法
...
当数据发生变化，触发订阅方法，执行dom数据更新方法，把最新数据更新到视图上</p>
<h3 id="vue如何实现响应式-说一下原理-它有什么缺点" tabindex="-1"><a class="header-anchor" href="#vue如何实现响应式-说一下原理-它有什么缺点"><span>vue如何实现响应式，说一下原理，它有什么缺点？</span></a></h3>
<p>它使用ES5的Object.defineProperty方法把所有的属性全部改为setter和getter属性，在每一个组件中都有一个watcher对象，当数据被赋值或变更的时候会通知页面的render方法对数据进行重新渲染，达到数据和视图的响应更新
因为js的固有特性，不能动态观察对象动态添加、删除属性和数组的长度添加，所以vue2.x不能够动态进行数据双向绑定，需要调用$set、$delete这些方法来实现动态添加双向绑定属性</p>
<h3 id="include-exclude的区别" tabindex="-1"><a class="header-anchor" href="#include-exclude的区别"><span>include，exclude的区别</span></a></h3>
<p>这个是webpack中常常用于指定加载，对哪些文件进行加载的排除或包含的一个属性，include配置的文件路径中的所有文件都将采用配置的loader进行文件加载处理，exclude是配置的路径都不要进行这个加载器的处理</p>
<h3 id="你说你使用懒加载优化页面-用的哪个版本的vue-看过源码吗-vue2-0不能实现懒加载" tabindex="-1"><a class="header-anchor" href="#你说你使用懒加载优化页面-用的哪个版本的vue-看过源码吗-vue2-0不能实现懒加载"><span>你说你使用懒加载优化页面，用的哪个版本的vue,看过源码吗, vue2.0不能实现懒加载</span></a></h3>
<p>这个与vue没有太大关系，采用的是ES6的动态加载机制来实现页面的懒加载，主要使用的webpack语法库为：@babel/plugin-syntax-dynamic-import，在对页面引入的时候，需要把引入方式从：import MyComponent from 'path' 修改为：const MyComponent = () =&gt; import('path')</p>
<h3 id="运用多个组件库-提取公共代码进行压缩-发现js代码过大-怎么处理" tabindex="-1"><a class="header-anchor" href="#运用多个组件库-提取公共代码进行压缩-发现js代码过大-怎么处理"><span>运用多个组件库,提取公共代码进行压缩,发现js代码过大，怎么处理</span></a></h3>
<p>对组件不要做全局引入，可以采用动态引入和页面局部引入机制，减少文件首次加载的文件大小和文件进行打包时把所有依赖进行一次性打包造成的文件过大问题</p>
<h3 id="vue中爷孙通信怎么实现" tabindex="-1"><a class="header-anchor" href="#vue中爷孙通信怎么实现"><span>vue中爷孙通信怎么实现</span></a></h3>
<p>可以采用：eventBus事件机制来进行数据传递；也可以采用逐层props和$emit事件传递来实现传值；vuex数据传递；使用v-model逐层数据传递等</p>
<h3 id="vue怎么配置多个代理" tabindex="-1"><a class="header-anchor" href="#vue怎么配置多个代理"><span>vue怎么配置多个代理</span></a></h3>
<p>在vue.config.js中使用devServer配置选项的proxy属性来进行多个代理配置
devServer: {
proxy: {
'/apis': {
...
<h3 id="为什么vue3-0双向数据绑定换成了proxy" tabindex="-1"><a class="header-anchor" href="#为什么vue3-0双向数据绑定换成了proxy"><span>为什么vue3.0双向数据绑定换成了proxy</span></a></h3>
<p>因为Object.defineProperty方法的历史原因，如果要实现数据的劫持，需要遍历所有属性，如果是深层数据需要递归来进行属性绑定；而proxy是直接代理此数据对象，不需要遍历绑定属性
如果对象有数据属性添加或则属性更新，需要重新给定数据劫持方法绑定，而proxy直接代理对象，不需要对属性做另外的处理
因此可以在进行数据监听和劫持上节省很多数据遍历性能</p>
<h3 id="你封装一个组件会有哪些考虑-用户用你的组件要怎么用-如果用户在使用你组件的同时又想自己加一些按钮进去那么此时你的组件要怎么写" tabindex="-1"><a class="header-anchor" href="#你封装一个组件会有哪些考虑-用户用你的组件要怎么用-如果用户在使用你组件的同时又想自己加一些按钮进去那么此时你的组件要怎么写"><span>你封装一个组件会有哪些考虑，用户用你的组件要怎么用？如果用户在使用你组件的同时又想自己加一些按钮进去那么此时你的组件要怎么写？</span></a></h3>
...
<ul>
<li>
<p>组件的属性：需要考虑到属性的类型限制，属性的默认值</p>
</li>
<li>
<p>组件的事件：组件事件对应的函数，需要考虑到函数的参数和返回值</p>
</li>
<li>
<p>组件的内容：要充分考虑到组件的通用性，灵活性。组件的内容给予使用者以更大的灵活空间。</p>
</li>
</ul>
...
<h3 id="vue图片懒加载-1不考虑兼容性做法-你认为最好处理最效率的-2考虑兼容性做法" tabindex="-1"><a class="header-anchor" href="#vue图片懒加载-1不考虑兼容性做法-你认为最好处理最效率的-2考虑兼容性做法"><span>vue图片懒加载：①不考虑兼容性做法（你认为最好处理最效率的）②考虑兼容性做法</span></a></h3>
<p><strong>回答：</strong></p>
<p><strong>1、场景：</strong></p>
<p>一个网页如果包含了很多的图片，那么，服务器压力就会很大。不仅影响渲染速度还会浪费带宽。</p>
<p>通俗的说：你不看的图片我先不加载，也许你不看呢（哈哈），我何苦要做无效的事情呢
你想看时，我再加载（哈哈）</p>
...
<h3 id="说说vue生命周期-发送请求在生命周期的哪个阶段-为什么不可以是beforemount-mounted中" tabindex="-1"><a class="header-anchor" href="#说说vue生命周期-发送请求在生命周期的哪个阶段-为什么不可以是beforemount-mounted中"><span>说说vue生命周期，发送请求在生命周期的哪个阶段，为什么不可以是beforeMount，mounted中</span></a></h3>
<p><strong>回答：</strong></p>
<p><strong>1、vue的生命周期</strong></p>
<p><strong>1）、生命周期是什么？</strong>
Vue 实例有一个完整的生命周期，也就是从开始创建、初始化数据、编译模版、挂载 Dom -&gt; 渲染、更新 -&gt; 渲染、卸载等一系列过程，我们称这是 Vue 的生命周期。</p>
...
<h3 id="兄弟和父子组件-在不能使用vuex的情况下有多少种方案-请列举出来" tabindex="-1"><a class="header-anchor" href="#兄弟和父子组件-在不能使用vuex的情况下有多少种方案-请列举出来"><span>兄弟和父子组件，在不能使用vuex的情况下有多少种方案，请列举出来？</span></a></h3>
<p><strong>回答：</strong></p>
...
<h3 id="v-if和v-for可以同时使用吗" tabindex="-1"><a class="header-anchor" href="#v-if和v-for可以同时使用吗"><span>v-if和v-for可以同时使用吗</span></a></h3>
<p><strong>回答：</strong></p>
...
<h3 id="vue-cli怎么配置跨域" tabindex="-1"><a class="header-anchor" href="#vue-cli怎么配置跨域"><span>vue-cli怎么配置跨域</span></a></h3>
<p><strong>回答：</strong></p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="v-bind是用来干什么的" tabindex="-1"><a class="header-anchor" href="#v-bind是用来干什么的"><span>v-bind是用来干什么的</span></a></h3>
<p><strong>回答：</strong></p>
...
<p>1、<strong>属性值</strong>动态绑定：<code v-pre>v-bind:html属性=&quot;数据&quot;</code>  简写   :html属性=&quot;数据&quot;`</p>
<p>示例：</p>
...
<span class="line">    <span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="说说对插槽的理解" tabindex="-1"><a class="header-anchor" href="#说说对插槽的理解"><span>说说对插槽的理解</span></a></h3>
<p><strong>回答：</strong></p>
<p><strong>1、插槽的作用：</strong></p>
<p>插槽是用来处理组件的内容的。插槽决定了组件的内容放在组件模板的何处。插槽使用的是vue官方提供的组件<code v-pre>&lt;slot&gt;</code>来完成的。</p>
<p><strong>2、vue中的插槽分为：</strong></p>
<p><strong>1）、单个插槽</strong></p>
<p>在组件中只有一个插槽时，插槽不用起名字。默认的名字是：default</p>
<p>示例：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">//1、定义组件</span></span>
...
<span class="line"><span class="token operator">&lt;</span><span class="token operator">/</span>div<span class="token operator">></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2）、具名插槽</strong></p>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">//1、组件：</span></span>
<span class="line">    <span class="token keyword">let</span> book <span class="token operator">=</span> <span class="token punctuation">{</span></span>
<span class="line">        <span class="token literal-property property">template</span><span class="token operator">:</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string"></span>
<span class="line">            &lt;div>     </span>
<span class="line">               &lt;p>我是上p&lt;/p></span>
...
<p>按照这个思路，程序员就不能在更改数据后，立即获取更新后的DOM，也不知道什么时候DOM能够更新。基于此，vue提供了$nextTick函数。程序员只需要把  <strong>”<strong>操作更新后DOM的代码</strong>“</strong>  放入到$nextTick的回调函数里。由$nextTick内部，在更新完DOM后，调用回调函数。</p>
<p>示例：</p>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2、$nextTick理解和定时器有什么区别</strong></p>
<p>**相同：**都是延迟加载，都使用事件队列</p>
<p><strong>不同：</strong></p>
<p>1）、定时器是下一个队列的队首。</p>
<p>2）、<code v-pre>$nextTick()</code>是放在当前队列的最后一个。$nextTick()的回调函数执行要先于定时器。</p>
<h3 id="event-bus是怎么用" tabindex="-1"><a class="header-anchor" href="#event-bus是怎么用"><span>event-bus是怎么用？</span></a></h3>
...
<p>示例：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">//1、全局的vue对象: bus.js</span></span>
...
<h3 id="v-model-原理-是什么" tabindex="-1"><a class="header-anchor" href="#v-model-原理-是什么"><span>v-model   原理 是什么</span></a></h3>
<p><strong>回答：</strong></p>
...
<p>如下：</p>
<ul>
<li>text 和 textarea 元素使用 <code v-pre>value</code> property 和 <code v-pre>input</code> 事件；</li>
<li>checkbox 和 radio 使用 <code v-pre>checked</code> property 和 <code v-pre>change</code> 事件；</li>
<li>select 字段将 <code v-pre>value</code> 作为 prop 并将 <code v-pre>change</code> 作为事件。</li>
</ul>
...
<span class="line">  <span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>而，使用v-model来完成以上功能的代码如下：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> <span class="token constant">V</span><span class="token operator">--</span><span class="token operator">></span></span>
<span class="line">  <span class="token operator">&lt;</span>div id<span class="token operator">=</span><span class="token string">"app"</span><span class="token operator">></span></span>
...
<span class="line">  <span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-的组件中的-data-配置为什么必须是函数-每个组件都是-vue-的实例" tabindex="-1"><a class="header-anchor" href="#vue-的组件中的-data-配置为什么必须是函数-每个组件都是-vue-的实例"><span>vue 的组件中的 data 配置为什么必须是函数(每个组件都是 vue 的实例)</span></a></h3>
...
<h3 id="vue-中-computed-和-watch-的区别" tabindex="-1"><a class="header-anchor" href="#vue-中-computed-和-watch-的区别"><span>vue 中 computed 和 watch 的区别</span></a></h3>
<ol>
<li>watch 和 computed 都是以 Vue 的依赖追踪机制为基础的，当某一个依赖型数据（依赖型数据：简单理解即放在 data 等对象下的实例数据）发生变化的时候，所有依赖这个数据的相关数据会自动发生变化，即自动调用相关的函数，来实现数据的变动。
当依赖的值变化时，在 watch 中，是可以做一些复杂的操作的，而 computed 中的依赖，仅仅是一个值依赖于另一个值，是值上的依赖。</li>
<li>应用场景：
computed：用于处理复杂的逻辑运算；一个数据受一个或多个数据影响；用来处理 watch 和 methods 无法处理的，或处理起来不方便的情况。例如处理模板中的复杂表达式、购物车里面的商品数量和总金额之间的变化关系等。
　　 watch：用来处理当一个属性发生变化时，需要执行某些具体的业务逻辑操作，或要在数据变化时执行异步或开销较大的操作；一个数据改变影响多个数据。例如用来监控路由、inpurt 输入框值的特殊处理等。</li>
<li>区别：</li>
</ol>
<ul>
<li>computed
...
<li>计算属性不在 data 中，它是基于 data 或 props 中的数据通过计算得到的一个新值，这个新值根据已知值的变化而变化；</li>
<li>在 computed 属性对象中定义计算属性的方法，和取 data 对象里的数据属性一样，以属性访问的形式调用；</li>
<li>如果 computed 属性值是函数，那么默认会走 get 方法，必须要有一个返回值，函数的返回值就是属性的属性值；</li>
<li>computed 属性值默认会缓存计算结果，在重复的调用中，只要依赖数据不变，直接取缓存中的计算结果，只有依赖型数据发生改变，computed 才会重新计算；</li>
<li>在 computed 中的，属性都有一个 get 和一个 set 方法，当数据变化时，调用 set 方法。</li>
</ul>
</li>
<li>watch
<ul>
...
<h3 id="vue-的生命周期-网络请求为什么要挂载在-mounted-中" tabindex="-1"><a class="header-anchor" href="#vue-的生命周期-网络请求为什么要挂载在-mounted-中"><span>vue 的生命周期？网络请求为什么要挂载在 mounted 中？</span></a></h3>
<ol>
<li>vue2 的生命周期</li>
</ol>
<ul>
...
<ul>
<li>renderTracked： 跟踪虚拟 DOM 重新渲染时调用。钩子接收 debugger event 作为参数。此事件告诉你哪个操作跟踪了组件以及该操作的目标对象和键。</li>
<li>renderTriggered：当虚拟 DOM 重新渲染被触发时调用。和 renderTracked 类似，接收 debugger event 作为参数。此事件告诉你是什么操作触发了重新渲染，以及该操作的目标对象和键。
一共 13 个</li>
</ul>
<ol>
<li>vue3 的组合 api 的生命周期
移除了 beforeCreate 和 created，因为创建时的事件可以在 setup 里面直接调用。
其他的 11 个生命周期前面全部加上 on
比如：mounted -&gt; onMounted, beforeDestroy -&gt; onDeforeDestroy</li>
<li>网络请求为什么要挂载在 mounted 中？
...
如果我们的请求不需要获取/借助/依赖/改变 DOM，这时请求可以放在 Created。反之则可以放在 Mounted 里。这样做会更加的安全，也能保证页面不会闪烁。</li>
</ol>
<h3 id="vue-的指令-在项目中封装了那些常用指令" tabindex="-1"><a class="header-anchor" href="#vue-的指令-在项目中封装了那些常用指令"><span>vue 的指令，在项目中封装了那些常用指令？</span></a></h3>
<p>在 vue 中我们可以使用 Vue.directive()方法注册全局指令。也可以只用 directives 选项注册局部指令。</p>
<ul>
<li>输入框防抖指令 v-debounce</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">const</span> debounce <span class="token operator">=</span> <span class="token punctuation">{</span></span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">const</span> copy <span class="token operator">=</span> <span class="token punctuation">{</span></span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">const</span> longpress <span class="token operator">=</span> <span class="token punctuation">{</span></span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">let</span> <span class="token function-variable function">findEle</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">parent<span class="token punctuation">,</span> type</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span></span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">checkArray</span><span class="token punctuation">(</span><span class="token parameter">key</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">addWaterMarker</span><span class="token punctuation">(</span><span class="token parameter">str<span class="token punctuation">,</span> parentNode<span class="token punctuation">,</span> font<span class="token punctuation">,</span> textColor</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">const</span> draggable <span class="token operator">=</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue-的移动端适配怎么做的-rem-怎么用的" tabindex="-1"><a class="header-anchor" href="#vue-的移动端适配怎么做的-rem-怎么用的"><span>vue 的移动端适配怎么做的，rem 怎么用的</span></a></h3>
<p>vue 的移动端适配我们可以参考 vant-ui 组件库给我们提供的方案。
使用 amfe-flexible(用于自动定义跟字体大小)插件和 postcss-pxtorem(用于将 px 自动转成 rem)插件
在 main.ts 里面 import &quot;amfe-flexible&quot;
在根目录新建 .postcssrc.js 文件</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>rem 是相对于跟字体的倍数，如果我们整个项目都是用 rem 作为单位，那么当我们做移动端的响应式的时候只需要去改变跟字体的大小就能做到适配。</p>
<h3 id="后台管理系统用户验证权限" tabindex="-1"><a class="header-anchor" href="#后台管理系统用户验证权限"><span>后台管理系统用户验证权限</span></a></h3>
<ol>
<li>登录
...
为了保证安全性，后台所有 token 有效期(Expires/Max-Age)都是 Session，就是当浏览器关闭了就丢失了。重新打开浏览器都需要重新登录验证，后端也会在每周固定一个时间点重新刷新 token，让后台用户全部重新登录一次，确保后台用户不会因为电脑遗失或者其它原因被人随意使用账号。</li>
<li>拦截路由进行判断
页面会先从 localstorage 中查看是否存有 token，没有，就走一遍上一部分的流程重新登录，如果有 token,就会把这个 token 返给后端去拉取 user_info，保证用户信息是最新的。 当然如果是做了单点登录得的的话，用户信息存储在本地也是可以的。当你一台电脑登录时，另一台会被提下线，所以总会重新登录获取最新的内容。</li>
<li>权限控制
...
前端控制页面级的权限，不同权限的用户显示不同的侧边栏和限制其所能进入的页面(也做了少许按钮级别的权限控制)，后端则会验证每一个涉及请求的操作，验证其是否有该操作的权限，每一个后台的请求不管是 get 还是 post 都会让前端在请求 header 里面携带用户的 token，后端会根据该 token 来验证用户是否有权限执行该操作。若没有权限则抛出一个对应的状态码，前端检测到该状态码，做出相对应的操作。</li>
<li>利用 vuex 管理路由表，根据 vuex 中可访问的路由渲染侧边栏组件。</li>
</ol>
<ul>
<li>创建 vue 实例的时候将 vue-router 挂载，但这个时候 vue-router 挂载一些登录或者不用权限的公用的页面。</li>
<li>当用户登录后，获取用 role，将 role 和路由表每个页面的需要的权限作比较，生成最终用户可访问的路由表。</li>
<li>调用 router.addRoutes(store.getters.addRouters)添加用户可访问的路由。</li>
<li>使用 vuex 管理路由表，根据 vuex 中可访问的路由渲染侧边栏组件。</li>
</ul>
<h3 id="vuex-做数据请求刷新页面-数据可能会发生丢失这个问题怎么解决" tabindex="-1"><a class="header-anchor" href="#vuex-做数据请求刷新页面-数据可能会发生丢失这个问题怎么解决"><span>vuex 做数据请求刷新页面，数据可能会发生丢失这个问题怎么解决</span></a></h3>
<p>因为 store 里的数据是保存在运行内存中的,当页面刷新时，页面会重新加载 vue 实例，store 里面的数据就会被重新赋值初始化。
所以我们可以在修改 store 的数据同时将数据再存一份到本地存储(localStorage 或者 sessionStorage),本地存储的内容是存在浏览器里面的，不会因为刷新而丢失。
我们也可以用过比如 vuex-persistedstate 这样的第三方包来帮助我们做 vuex 的持久化数据。</p>
<h3 id="vue2-和-vue3-两者的具体的区别有哪些-请一一例举出来" tabindex="-1"><a class="header-anchor" href="#vue2-和-vue3-两者的具体的区别有哪些-请一一例举出来"><span>vue2 和 vue3 两者的具体的区别有哪些，请一一例举出来</span></a></h3>
<ol>
<li>源码使用 ts 重写
现如今 typescript 异常火爆，它的崛起是有原因的，因为对于规模很大的项目，没有类型声明，后期维护和代码的阅读都是头疼的事情，所以广大码农迫切的需要 vue 能完美支持 ts。
vue2 用的是 Facebook 的 Flow 做类型检查，但是因为某些情况下推断有问题，所以 vue3 使用 typescript 进行了源码的重写。一个是为了更好的类型检查，另一个是拥抱 ts。</li>
<li>使用 proxy 代替 defineProperty
我们知道 vue2.x 双向绑定的核心是 Object.defineProperty()，所以导致 vue 对数组对象的深层监听无法实现。
所以 vue3 使用 proxy 对双向绑定进行了重写。Proxy 可以对整体进行监听，不需要关心里面有什么属性，而且 Proxy 的配置项有 13 种，可以做更细致的事情，这是之前的 defineProperty 无法达到的。</li>
<li>Diff 算法的提升
vue3 在 vue2 的 diff 算法的基础上增加了静态标记，元素提升和事件缓存等优化。使得速度更快。</li>
<li>打包体积变化
...
尽管增加了许多新特性，但 Vue 3 被压缩后的基线大小约为 10 KB，不到 Vue 2 的一半。</li>
<li>其他 Api 和功能的改动</li>
</ol>
<ul>
<li>Global API</li>
...
<li>组件</li>
<li>渲染函数</li>
<li>vue-cli 从 v4.5.0 开始提供 Vue 3 预设</li>
<li>Vue Router 4.0 提供了 Vue 3 支持，并有许多突破性的变化</li>
<li>Vuex 4.0 提供了 Vue 3 支持，其 API 与 2.x 基本相同</li>
</ul>
<ol>
<li>组件基本结构</li>
</ol>
...
<h3 id="vue-操作虚拟-dom-有什么优异的地方-他不是还多做了一层虚拟-dom-为什么比原生操作-dom-还快" tabindex="-1"><a class="header-anchor" href="#vue-操作虚拟-dom-有什么优异的地方-他不是还多做了一层虚拟-dom-为什么比原生操作-dom-还快"><span>vue 操作虚拟 DOM 有什么优异的地方？他不是还多做了一层虚拟 DOM，为什么比原生操作 DOM 还快</span></a></h3>
...
<p>简单点讲，在 Vue 的底层实现上，Vue 将模板编译成虚拟 DOM 渲染函数。结合 Vue 自带的响应系统，在状态改变时，Vue 能够智能地计算出重新渲染组件的最小代价并应到 DOM 操作上。
<img src="https://image.fundebug.com/2019-06-26-01.png" alt="avatar"></p>
<p>那么 vue 操作虚拟 DOM 有什么优异的地方呢？</p>
<ul>
<li>具备跨平台的优势
由于 Virtual DOM 是以 JavaScript 对象为基础而不依赖真实平台环境，所以使它具有了跨平台的能力，比如说浏览器平台、Weex、Node 等。</li>
<li>操作 DOM 慢，js 运行效率高。我们可以将 DOM 对比操作放在 JS 层，提高效率。
因为 DOM 操作的执行速度远不如 Javascript 的运算速度快，因此，把大量的 DOM 操作搬运到 Javascript 中，运用 patching 算法来计算出真正需要更新的节点，最大限度地减少 DOM 操作，从而显著提高性能。
Virtual DOM 本质上就是在 JS 和 DOM 之间做了一个缓存。可以类比 CPU 和硬盘，既然硬盘这么慢，我们就在它们之间加个缓存：既然 DOM 这么慢，我们就在它们 JS 和 DOM 之间加个缓存。CPU（JS）只操作内存（Virtual DOM），最后的时候再把变更写入硬盘（DOM）</li>
<li>提升渲染性能
Virtual DOM 的优势不在于单次的操作，而是在大量、频繁的数据更新下，能够对视图进行合理、高效的更新。
为了实现高效的 DOM 操作，一套高效的虚拟 DOM diff 算法显得很有必要。我们通过 patch 的核心—-diff 算法，找出本次 DOM 需要更新的节点来更新，其他的不更新。比如修改某个 model 100 次，从 1 加到 100，那么有了 Virtual DOM 的缓存之后，只会把最后一次修改 patch 到 view 上。那 diff 算法的实现过程是怎样的？</li>
</ul>
<p>那么为什么比原生操作 DOM 还快呢？
...
这是一个性能 vs. 可维护性的取舍。框架的意义在于为你掩盖底层的 DOM 操作，让你用更声明式的方式来描述你的目的，从而让你的代码更容易维护。没有任何框架可以比纯手动的优化 DOM 操作更快，因为框架的 DOM 操作层需要应对任何上层 API 可能产生的操作，它的实现必须是普适的。针对任何一个 benchmark，我都可以写出比任何框架更快的手动优化，但是那有什么意义呢？在构建一个实际应用的时候，你难道为每一个地方都去做手动优化吗？出于可维护性的考虑，这显然不可能。框架给你的保证是，你在不需要手动优化的情况下，我依然可以给你提供过得去的性能。</p>
<h3 id="token-过期你是如何来进行处理-有没有弄过-token-续期" tabindex="-1"><a class="header-anchor" href="#token-过期你是如何来进行处理-有没有弄过-token-续期"><span>token 过期你是如何来进行处理，有没有弄过 token 续期</span></a></h3>
...
<ul>
<li>一种是直接跳转到登录页面，重新登录。</li>
<li>另外一种如果返回 token 失效的信息，自动去刷新 token，然后继续完成未完成的请求操作。</li>
</ul>
<h3 id="vue底层实现原理" tabindex="-1"><a class="header-anchor" href="#vue底层实现原理"><span>vue底层实现原理</span></a></h3>
<ul>
<li>使用 Object.defineProperty 劫持 data上的数据。</li>
<li>Vue2.0通过设定对象属性的 setter/getter 方法来监听数据的变化，通过getter进行依赖收集，而每个setter方法就是一个观察者，在数据变更的时候通知订阅者更新视图。</li>
</ul>
<h3 id="vue的生命周期-created与mounted的区别" tabindex="-1"><a class="header-anchor" href="#vue的生命周期-created与mounted的区别"><span>Vue的生命周期，created与mounted的区别</span></a></h3>
...
<h3 id="用vue写了商城-从列表页点进详情页-从详情页退出来的时候-怎么保持进入详情页之前的页面卷动值。" tabindex="-1"><a class="header-anchor" href="#用vue写了商城-从列表页点进详情页-从详情页退出来的时候-怎么保持进入详情页之前的页面卷动值。"><span>用vue写了商城，从列表页点进详情页，从详情页退出来的时候，怎么保持进入详情页之前的页面卷动值。</span></a></h3>
<p>使用 <keep-alive/>对列表页面进行包裹，被包裹的列表页面就有了activated、deactivated这两个生命周期。
在离开列表页面时，在deactivated中记录页面的滚动条位置。
再次进入列表页面时，在activated中使用 this.$el.scrollTop 把页面滚动到离开时所记录的位置。</p>
<h3 id="说说你对vue的理解" tabindex="-1"><a class="header-anchor" href="#说说你对vue的理解"><span>说说你对vue的理解</span></a></h3>
<ul>
<li>vue是数据驱动的MVVM框架，相比传统的DOM库，vue有一层虚拟DOM。每当数据发生更新时，会触发虚拟DOM进行diff运算，找出最小的变化节点，大大地节省了DOM操作性能。</li>
<li>vue是组件化的，在单页面应用程序中，每一个组件相当于是一块积木，搭建起庞大的应用系统。组件，可以理解成更大粒度的“HTML元素”，有利于快速开发、组件的高效复用。</li>
<li>vue有一整套指令，大大地降低了开发者的开发难度，提升了开发效率。</li>
<li>虽然vue有诸多优点，但仍然有一些缺陷，比如复杂的业务页面通常过长，data、methods、computed、watch对应的数据和逻辑交织在一起，难以维护。</li>
</ul>
<h3 id="说说对虚拟dom的理解" tabindex="-1"><a class="header-anchor" href="#说说对虚拟dom的理解"><span>说说对虚拟DOM的理解</span></a></h3>
<ul>
<li>在vue中，虚拟DOM本质上就是一个固定格式的JSON数据，它用于描述真实的DOM结构，并使用各种不同flag标记出动态的DOM节点。</li>
<li>虚拟DOM数据保存在应用程序对应的内存结构中，拥有更快的数据交换速度。</li>
<li>每当有数据发生变化时，就会生成新的虚拟DOM，进一步发生diff运算，找出最小脏节点，减少不必要的DOM开销，这也是vue拥有更好的性能的根本原因。</li>
</ul>
<h3 id="说说provide的用法" tabindex="-1"><a class="header-anchor" href="#说说provide的用法"><span>说说provide的用法</span></a></h3>
<ul>
<li>在父级组件中，使用provide选项向vue组件树中“提供数据”，其语法是：provide:{a: 1}</li>
<li>在后代子级组件中，使用 inject选项从vue组件中“取出数据”，其语法是：inject: ['a']</li>
</ul>
<h3 id="说一下element-ui遇到过的坑" tabindex="-1"><a class="header-anchor" href="#说一下element-ui遇到过的坑"><span>说一下element ui遇到过的坑</span></a></h3>
<ol>
<li>
<p>表单设置触发事件为blur，但是ctrl+A全选以后再删除时又触发了change事件，并提示一个原始报错</p>
<ul>
<li>解决方案：trigger设置成<code v-pre>trigger: ['blur', 'change']</code></li>
</ul>
</li>
<li>
<p>使用el-dialog 遮罩层把显示内容遮住了</p>
<ul>
<li>原因： Dialog 的外层布局的 position 值为 fixed, absolute, relative 三者之一时，就会出现被蒙板遮住的情况。</li>
<li>解决方法：<code v-pre>v-bind:modal-append-to-body=&quot;false&quot;</code></li>
</ul>
</li>
<li>
<p>使用el-select 不能继承父元素的宽度</p>
<ul>
<li>原因：el-select 本身是  inline-block</li>
<li>解决办法：手动设置el-select的宽度</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">    <span class="token operator">&lt;</span>el<span class="token operator">-</span>select style<span class="token operator">=</span><span class="token string">"width:100%"</span><span class="token operator">></span><span class="token operator">&lt;</span><span class="token operator">/</span>el<span class="token operator">-</span>select<span class="token operator">></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ol>
<h3 id="怎么修改element-ui动态组件的样式" tabindex="-1"><a class="header-anchor" href="#怎么修改element-ui动态组件的样式"><span>怎么修改element ui动态组件的样式</span></a></h3>
...
<span class="line">    </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但这种方式为全局样式，会影响页面中所有复选框，如果不希望影响其它页面的样式，可以采用第二中方式</p>
</li>
<li>
<p>局部样式</p>
...
<span class="line">    </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但如果仅仅是设置了scoped属性，样式无法生效，原因是以上样式会被编译成属性选择器，而elementUI组件内部的结构却无法添加该html属性，以上样式被编译成如下代码：</p>
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css" data-title="css"><pre v-pre><code><span class="line">    <span class="token selector">.edit-item[data-v-6558bc58] .el-checkbox__inner[data-v-6558bc58]</span> <span class="token punctuation">{</span></span>
<span class="line">        　　border-radius<span class="token punctuation">:</span> 50%<span class="token punctuation">;</span></span>
<span class="line">        <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>解决方案也很简单，只需在选择器中要添加<code v-pre>&gt;&gt;&gt;</code>即可</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line">    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">scoped</span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css"></span>
<span class="line">        <span class="token selector">.edit-item >>> .el-checkbox__inner</span> <span class="token punctuation">{</span></span>
<span class="line">        　　border-radius<span class="token punctuation">:</span> 50%<span class="token punctuation">;</span></span>
<span class="line">        <span class="token punctuation">}</span></span>
<span class="line">    </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是sass或less编写的样式，还可以使用<code v-pre>/deep/</code></p>
...
<span class="line">    </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上写法样式都会编译成以下样式：</p>
<div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css" data-title="css"><pre v-pre><code><span class="line">    <span class="token selector">.edit-item[data-v-6558bc58] .el-checkbox__inner</span><span class="token punctuation">{</span><span class="token punctuation">}</span> </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>所以elementUI中的样式就能成功覆盖</p>
</li>
</ol>
<h3 id="vue和react中的key值主要用来干什么" tabindex="-1"><a class="header-anchor" href="#vue和react中的key值主要用来干什么"><span>vue和react中的key值主要用来干什么</span></a></h3>
<p>key是虚拟DOM对象的标识，在更新显示时key起着极其重要的作用，vue和react都是采用diff算法来对比新旧虚拟节点，而key的作用是为了在执行 diff算法 的时候，更快更准确地找到对应的虚拟节点，从而提高diff速度。</p>
<h3 id="route和router区别" tabindex="-1"><a class="header-anchor" href="#route和router区别"><span>route和router区别</span></a></h3>
<p><code v-pre>route</code> 和 <code v-pre>router</code> 是vue-router中经常会操作的两个对象， <code v-pre>route</code>表示当前的路由信息对象，包含了当前 URL 解析得到的信息，包含当前的路径、参数、query对象等，一般用于获取跳转时传入的参数。 <code v-pre>router</code>对象是全局路由的实例，是router构造方法的实例，一般用户路由跳转，如<code v-pre>router.push()</code>、<code v-pre>router.replace()</code> 等方法</p>
<h3 id="vue和react相对于传统的有什么好处-性能优点" tabindex="-1"><a class="header-anchor" href="#vue和react相对于传统的有什么好处-性能优点"><span>vue和react相对于传统的有什么好处，性能优点</span></a></h3>
<ol>
<li>组件化开发，开发效率更高
<blockquote>
...
<h3 id="虚拟dom实现原理" tabindex="-1"><a class="header-anchor" href="#虚拟dom实现原理"><span>虚拟DOM实现原理</span></a></h3>
<p>我们先来看看浏览器渲染一个页面的过和，大概需要以下5个步骤</p>
<ol>
<li>解析HTML元素，构建<strong>DOM树</strong></li>
<li>解析CSS，生成页面<strong>CSS规则树</strong>（Style Rules）</li>
<li>将DOM树和CSS规则树进行关联，生成<strong>render树</strong></li>
<li>布局（layout/reflow）：浏览器设定Render树中的每个节点在屏幕上的位置与尺寸</li>
<li>绘制Render树：绘制页面像素信息到屏幕上</li>
</ol>
...
<li>diff 算法 — 比较新旧两个虚拟DOM，得到<strong>差异对象</strong></li>
<li>pach 算法 — 将<strong>差异对象</strong>应用到真实 DOM 树</li>
</ol>
...
<h3 id="如何实现角色权限分配" tabindex="-1"><a class="header-anchor" href="#如何实现角色权限分配"><span>如何实现角色权限分配</span></a></h3>
...
<h3 id="双向数据绑定和单向数据流的优缺点" tabindex="-1"><a class="header-anchor" href="#双向数据绑定和单向数据流的优缺点"><span>双向数据绑定和单向数据流的优缺点</span></a></h3>
<p>所谓数据绑定，就是指<code v-pre>View</code>层和<code v-pre>Model</code>层之间的映射关系。</p>
<ul>
<li>
<p><strong>单向数据绑定：</strong><code v-pre>Model</code>的更新会触发<code v-pre>View</code>的更新，而<code v-pre>View</code>的更新不会触发<code v-pre>Model</code>的更新，它们的作用是单向的。</p>
<blockquote>
...
<li>
<p><strong>双向数据绑定：</strong><code v-pre>Model</code>的更新会触发<code v-pre>View</code>的更新，<code v-pre>View</code>的更新也会触发<code v-pre>Model</code>的更新，它们的作用是相互的。</p>
<blockquote>
<p>优点：在操作表单时使用<code v-pre>v-model</code>方便简单，可以省略繁琐或重复的<code v-pre>onChange</code>事件去处理每个表单数据的变化（减少代码量）。</p>
<p>缺点：属于暗箱操作，无法很好的追踪双向绑定的数据的变化。</p>
</blockquote>
</li>
</ul>
<h3 id="vue是如何实现双向绑定的" tabindex="-1"><a class="header-anchor" href="#vue是如何实现双向绑定的"><span>Vue是如何实现双向绑定的?</span></a></h3>
...
<p>补充回答</p>
<p>在new Vue的时候，在 Observer 中通过 <code v-pre>Object.defineProperty()</code> 达到数据劫持，代理所有数据的 getter 和 setter 属性，在每次触发 setter 的时候，都会通过 Dep 来通知 Watcher，Watcher 作为<code v-pre>Observer</code>数据监听器与<code v-pre>Compile</code>模板解析器之间的桥梁，当 Observer 监听到数据发生改变的时候，通过 Updater 来通知 Compile 更新视图，而 Compile 通过 Watcher 订阅对应数据，绑定更新函数，通过 Dep 来添加订阅者，达到双向绑定。</p>
<h3 id="proxy与object-defineproperty的优劣对比" tabindex="-1"><a class="header-anchor" href="#proxy与object-defineproperty的优劣对比"><span>Proxy与Object.defineProperty的优劣对比?</span></a></h3>
...
<li>Proxy返回的是一个新对象，我们可以只操作新的对象达到目的，而<code v-pre>Object.defineProperty</code>只能遍历对象属性直接修改;</li>
...
<h3 id="你是如何理解vue的响应式系统的" tabindex="-1"><a class="header-anchor" href="#你是如何理解vue的响应式系统的"><span>你是如何理解Vue的响应式系统的?</span></a></h3>
...
<ul>
<li>为什么要了解Vue数据响应式？</li>
</ul>
<p>因为这是Vue的立身之本呀，连<a href="https://www.zhihu.com/search?q=%E5%B0%A4%E9%9B%A8%E6%BA%AA&amp;search_source=Entity&amp;hybrid_search_source=Entity&amp;hybrid_search_extra=%7B%22sourceType%22%3A%22answer%22%2C%22sourceId%22%3A2259003949%7D" target="_blank" rel="noopener noreferrer">尤雨溪</a>都在给放文档上这样说，“Vue 最独特的特性之一，是其非侵入性的响应式系统。”</p>
...
<h3 id="既然vue通过数据劫持可以精准探测数据变化-为什么还需要虚拟dom进行diff检测差异" tabindex="-1"><a class="header-anchor" href="#既然vue通过数据劫持可以精准探测数据变化-为什么还需要虚拟dom进行diff检测差异"><span>既然Vue通过数据劫持可以精准探测数据变化,为什么还需要虚拟DOM进行diff检测差异?</span></a></h3>
...
<p>具体流程：</p>
<ol>
<li>真实 DOM 与虚拟 DOM 之间存在一个映射关系。这个映射关系依靠初始化时的 JSX 建立完成；</li>
<li>当虚拟 DOM 发生变化后，就会根据差距计算生成 patch，这个 patch 是一个结构化的数据，内容包含了增加、更新、移除等；</li>
<li>最后再根据 patch 去更新真实的 DOM，反馈到用户的界面上。</li>
</ol>
<p>这样一个生成补丁、更新差异的过程统称为 diff 算法。</p>
<p>这里涉及3个要点：</p>
<ol>
<li>更新时机：更新发生在setState、Hooks 调用等操作以后</li>
<li>遍历算法：采用深度优先遍历，从根节点出发，沿着左子树方向进行纵向遍历，直到找到叶子节点为止。然后回溯到前一个节点，进行右子树节点的遍历，直到遍历完所有可达节点</li>
<li>优化策略：树、组件及元素三个层面进行复杂度的优化</li>
<li>
<ol>
<li>忽略节点跨层级操作场景，提升比对效率。</li>
<li>
<ol>
<li>这一策略需要进行树比对，即对树进行分层比较。树比对的处理手法是非常“暴力”的，即两棵树只对同一层次的节点进行比较，如果发现节点已经不存在了，则该节点及其子节点会被完全删除掉，不会用于进一步的比较，这就提升了比对效率</li>
</ol>
</li>
<li>如果组件的 class 一致，则默认为相似的树结构，否则默认为不同的树结构</li>
<li>
<ol>
<li>在组件比对的过程中：如果组件是同一类型则进行树比对；如果不是则直接放入补丁中。只要父组件类型不同，就会被重新渲染。这也就是为什么shouldComponentUpdate、PureComponent 及 React.memo 可以提高性能的原因</li>
</ol>
</li>
<li>同一层级的子节点，可以通过标记 key 的方式进行列表对比</li>
<li>
<ol>
...
<h3 id="vue为什么没有类似于react中shouldcomponentupdate的生命周期" tabindex="-1"><a class="header-anchor" href="#vue为什么没有类似于react中shouldcomponentupdate的生命周期"><span>Vue为什么没有类似于React中shouldComponentUpdate的生命周期？</span></a></h3>
...
<h3 id="vue中的key到底有什么用" tabindex="-1"><a class="header-anchor" href="#vue中的key到底有什么用"><span>Vue中的key到底有什么用？</span></a></h3>
<p>1、key的作用主要是为了搞笑的更新虚拟dom，其原理是vue在patch过程中通过key可以精准判断两个节点是否是同一个，从而避免频繁更新不同元素，使得整个patch过程更加高效，减少dom操作量，提高性能。
2、另外，若不设置key还可能在列表更新时候引发一些隐藏的bug。
3、vue中在使用相同标签名元素的过渡切换时，也会使用到key属性，其目的也是为了让vue可以区分它们，否则vue只会替换其内部属性而不会触发过渡效果。</p>
<h3 id="不能用index做key" tabindex="-1"><a class="header-anchor" href="#不能用index做key"><span>不能用index做key</span></a></h3>
<p>看了上面的介绍其实也很容易明白为什么不能用index作为key。</p>
<p><strong>1、影响性能：当用index作为key的时候，删除节点后面的所有节点都会导致重新渲染，因为index变化了，可以也就变化了</strong></p>
<p>有人说，当你的列表数据没有变化的时候可以用index作为key。也就是说列表不会触发更新元素，只有静态展示。这种说法你怎么看呢？
之所以说到这个问题，是在vue官方群里面一群人应为这个问题讨论半天。我弱弱回复一句，任何情况下都不要用index作为key。结果遭到炮轰，哎！（除非前端写死的list，且无操作不会引起key变化，只要是后端数据，前端怎么能保证数据不变呢）。
关于这个问题，我有这样三点想法：</p>
<p><strong>1、代码的规范性</strong>
<strong>2、类比typescript，为什么变量要加类型，除了规范，也方便定位错误</strong>
<strong>3、列表的顺序稳定其实是难以保证的</strong></p>
<h3 id="vue项目中用jsx语法" tabindex="-1"><a class="header-anchor" href="#vue项目中用jsx语法"><span>vue项目中用jsx语法</span></a></h3>
<p>JSX就是Javascript和XML结合的一种格式。React发明了JSX，利用HTML语法来创建虚拟DOM。当遇到&lt;，JSX就当HTML解析，遇到{就当JavaScript解析.</p>
<h5 id="我为什么要在vue中用jsx" tabindex="-1"><a class="header-anchor" href="#我为什么要在vue中用jsx"><span>我为什么要在vue中用JSX?</span></a></h5>
<p>是使用的的模板语法，Vue的模板实际上就是编译成了 render 函数，同样支持 JSX 语法。在 Vue 官网中，提供 createElement 函数中使用模板中的功能。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;script></span>
<span class="line">   export default {</span>
...
<span class="line">&lt;/script></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是极少数的 VUE项目用JSX语法 JSX语法 根植在react上面  在vue上还是  template舒服！</p>
<h3 id="vue的-set是什么" tabindex="-1"><a class="header-anchor" href="#vue的-set是什么"><span>vue的$set是什么？</span></a></h3>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;div id="app"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行结果：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">姓名：张三</span>
...
<p><img src="https://images2017.cnblogs.com/blog/1055667/201710/1055667-20171017175710537-1569151545.png" alt="https://images2017.cnblogs.com/blog/1055667/201710/1055667-20171017175710537-1569151545.png"></p>
...
<h3 id="vue里绑定了一个空对象-往空对象里面添加属性-在哪个函数周期里面可以实现" tabindex="-1"><a class="header-anchor" href="#vue里绑定了一个空对象-往空对象里面添加属性-在哪个函数周期里面可以实现"><span>vue里绑定了一个空对象,往空对象里面添加属性，在哪个函数周期里面可以实现</span></a></h3>
<p>需要在created里面才可以，如下代码：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;div>{{user}}&lt;/div></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> data () {</span>
<span class="line">    return {</span>
...
<span class="line">  },</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue的通信方式有什么" tabindex="-1"><a class="header-anchor" href="#vue的通信方式有什么"><span>Vue的通信方式有什么</span></a></h3>
<p><code v-pre>vue</code>中8种常规的通信方案</p>
<ol>
<li>通过 props 传递</li>
...
<h5 id="props传递数据" tabindex="-1"><a class="header-anchor" href="#props传递数据"><span>props传递数据</span></a></h5>
<p><img src="https://img2020.cnblogs.com/blog/1079767/202012/1079767-20201201095920670-935007644.png" alt="img"></p>
<ul>
...
<p>Children.vue</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">props:{</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Father.vue</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;Children name:"jack" age=18 /></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h5 id="emit-触发自定义事件" tabindex="-1"><a class="header-anchor" href="#emit-触发自定义事件"><span>$emit 触发自定义事件</span></a></h5>
<ul>
...
<p>Children.vue</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">this.$emit('add', good)</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>Father.vue</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;Children @add="cartAdd($event)" /></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h5 id="ref" tabindex="-1"><a class="header-anchor" href="#ref"><span>ref</span></a></h5>
<ul>
<li>父组件在使用子组件的时候设置<code v-pre>ref</code></li>
<li>父组件通过设置子组件<code v-pre>ref</code>来获取数据</li>
</ul>
<p>父组件</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;Children ref="foo" /></span>
<span class="line"></span>
<span class="line">this.$refs.foo  // 获取子组件实例，通过子组件实例我们就能拿到对应的数据</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="eventbus" tabindex="-1"><a class="header-anchor" href="#eventbus"><span>EventBus</span></a></h5>
<ul>
<li>使用场景：兄弟组件传值</li>
<li>创建一个中央时间总线<code v-pre>EventBus</code></li>
<li>兄弟组件通过<code v-pre>$emit</code>触发自定义事件，<code v-pre>$emit</code>第二个参数为传递的数值</li>
<li>另一个兄弟组件通过<code v-pre>$on</code>监听自定义事件</li>
</ul>
<p>Bus.js</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 创建一个中央时间总线类</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// main.js</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Children1.vue</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">this.$bus.$emit('foo')</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>Children2.vue</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">this.$bus.$on('foo', this.handle)</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h5 id="parent或-root" tabindex="-1"><a class="header-anchor" href="#parent或-root"><span>Parent或 root</span></a></h5>
<ul>
<li>通过共同祖辈<code v-pre>$parent</code>或者<code v-pre>$root</code>搭建通信侨联</li>
</ul>
<p>兄弟组件</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">this.$parent.on('add',this.add)</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>另一个兄弟组件</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">this.$parent.emit('add')</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h5 id="attrs与-listeners" tabindex="-1"><a class="header-anchor" href="#attrs与-listeners"><span>attrs与 listeners</span></a></h5>
<ul>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// child：并未在props中声明foo</span>
<span class="line">&lt;p>{{$attrs.foo}}&lt;/p></span>
<span class="line"></span>
<span class="line">// parent</span>
<span class="line">&lt;HelloWorld foo="foo"/></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// 给Grandson隔代传值，communication/index.vue</span>
...
<span class="line">&lt;/div></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="provide-与-inject" tabindex="-1"><a class="header-anchor" href="#provide-与-inject"><span>provide 与 inject</span></a></h5>
<ul>
<li>在祖先组件定义<code v-pre>provide</code>属性，返回传递的值</li>
<li>在后代组件通过<code v-pre>inject</code>接收组件传递过来的值</li>
</ul>
<p>祖先组件</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">provide(){</span>
<span class="line">    return {</span>
<span class="line">        foo:'foo'</span>
<span class="line">    }</span>
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>后代组件</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">inject:['foo'] // 获取到祖先组件传递过来的值</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h5 id="vuex" tabindex="-1"><a class="header-anchor" href="#vuex"><span>vuex</span></a></h5>
<ul>
<li>适用场景: 复杂关系的组件数据传递</li>
<li><code v-pre>Vuex</code>作用相当于一个用来存储共享变量的容器</li>
</ul>
<p><img src="https://img2020.cnblogs.com/blog/1079767/202012/1079767-20201201100512604-1215038716.png" alt="img"></p>
<ul>
<li><code v-pre>state</code>用来存放共享变量的地方</li>
<li><code v-pre>getter</code>，可以增加一个<code v-pre>getter</code>派生状态，(相当于<code v-pre>store</code>中的计算属性），用来获得共享变量的值</li>
<li><code v-pre>mutations</code>用来存放修改<code v-pre>state</code>的方法。</li>
<li><code v-pre>actions</code>也是用来存放修改state的方法，不过<code v-pre>action</code>是在<code v-pre>mutations</code>的基础上进行。常用来做一些异步操作</li>
</ul>
<h5 id="小结" tabindex="-1"><a class="header-anchor" href="#小结"><span>小结</span></a></h5>
<ul>
...
<h3 id="vue的生命周期里什么时候拿dom结构比较好" tabindex="-1"><a class="header-anchor" href="#vue的生命周期里什么时候拿dom结构比较好"><span>Vue的生命周期里什么时候拿DOM结构比较好</span></a></h3>
...
<h3 id="beforemount与mounted的区别" tabindex="-1"><a class="header-anchor" href="#beforemount与mounted的区别"><span>beforeMount与mounted的区别</span></a></h3>
<p>beforeMount：在这里Vue实例的元素el和数据对象都有了，只不过在挂载之前还是虚拟的dom节点。</p>
...
<h3 id="跳转下一个页面-在返回-怎么保持页面的状态不变" tabindex="-1"><a class="header-anchor" href="#跳转下一个页面-在返回-怎么保持页面的状态不变"><span>跳转下一个页面，在返回，怎么保持页面的状态不变</span></a></h3>
...
<p><code v-pre>keep-alive</code> 是 Vue 内置的一个组件，可以使被包含的组件保留状态，或避免重新渲染。
实际项目中,需要配合vue-router共同使用</p>
<p><code v-pre>router-view</code> 也是一个组件，如果直接被包在 <code v-pre>keep-alive</code> 里面，所有路径匹配到的视图组件都会被缓存：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;keep-alive></span>
<span class="line">    &lt;!-- 所有路径匹配到的视图组件都会被缓存！ --></span>
<span class="line">    &lt;router-view></span>
<span class="line">    &lt;/router-view></span>
<span class="line">&lt;/keep-alive></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果只想 <code v-pre>router-view</code> 里面某个组件被缓存，怎么办？</p>
<p><strong>增加 router.meta 属性</strong></p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// routes 配置</span>
<span class="line">export default [</span>
<span class="line">  {</span>
...
<span class="line">]</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;!-- 这里是会被缓存的视图组件，比如 Home！ --></span>
<span class="line">&lt;keep-alive></span>
...
<span class="line">&lt;router-view v-if="!$route.meta.keepAlive">&lt;/router-view></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue的性能优化有哪些方法" tabindex="-1"><a class="header-anchor" href="#vue的性能优化有哪些方法"><span>Vue的性能优化有哪些方法</span></a></h3>
<h5 id="_1、路由懒加载" tabindex="-1"><a class="header-anchor" href="#_1、路由懒加载"><span><strong>1、路由懒加载</strong></span></a></h5>
<h5 id="_2、keep-alive缓存页面" tabindex="-1"><a class="header-anchor" href="#_2、keep-alive缓存页面"><span><strong>2、keep-alive缓存页面</strong></span></a></h5>
<h5 id="_3、使用v-show复用dom" tabindex="-1"><a class="header-anchor" href="#_3、使用v-show复用dom"><span><strong>3、使用v-show复用DOM</strong></span></a></h5>
<h5 id="_4、v-for遍历避免同时使用v-if-使用computed属性过滤需要显示的数据项" tabindex="-1"><a class="header-anchor" href="#_4、v-for遍历避免同时使用v-if-使用computed属性过滤需要显示的数据项"><span><strong>4、v-for遍历避免同时使用v-if</strong> （使用computed属性过滤需要显示的数据项 ）</span></a></h5>
<h5 id="_5、长列表性能优化" tabindex="-1"><a class="header-anchor" href="#_5、长列表性能优化"><span>5、长列表性能优化</span></a></h5>
<p>(1)如果列表是纯粹的数据展示，不会有任何改变，就不需要做响应话, 使用object.freeze(data)
(2)如果是大数据长列表，可采用虚拟滚动，只渲染少部分区域的内容，参考vue-virtual-scroller、vue-virtual-scroll-list</p>
<h5 id="_6、事件的销毁" tabindex="-1"><a class="header-anchor" href="#_6、事件的销毁"><span><strong>6、事件的销毁</strong></span></a></h5>
<p>vue组件销毁时，会自动解绑它的全部指令及事件监听，但是仅限于组件本身的限制</p>
<h5 id="_7、图片懒加载" tabindex="-1"><a class="header-anchor" href="#_7、图片懒加载"><span><strong>7、图片懒加载</strong></span></a></h5>
<h5 id="_8、第三方插件按需引入" tabindex="-1"><a class="header-anchor" href="#_8、第三方插件按需引入"><span><strong>8、第三方插件按需引入</strong></span></a></h5>
<p>像element-ui这样的第三方组件库可以按需引入避免体积太大。</p>
<h5 id="_9、无状态的组件标记为函数式组件" tabindex="-1"><a class="header-anchor" href="#_9、无状态的组件标记为函数式组件"><span><strong>9、无状态的组件标记为函数式组件</strong></span></a></h5>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;template functional></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_10、ssr" tabindex="-1"><a class="header-anchor" href="#_10、ssr"><span><strong>10、SSR</strong></span></a></h5>
<h3 id="vue项目怎么进行seo的优化" tabindex="-1"><a class="header-anchor" href="#vue项目怎么进行seo的优化"><span>vue项目怎么进行seo的优化</span></a></h3>
<p>Vue的单页面模式进行开发的项目，网站信息搜索引擎无法做索引,导入收录只有是首页！</p>
<p>搜索引擎无法进行索引的核心原因就是，其在爬取网站数据的时候，是不会执行其中包含的JS过程的；</p>
<p>而采用Vue的方式开发的应用，其数据都是来源于axios或者其它的ajax方法获取的数据！也就是说，想要友好的支持搜索引擎，就必须采用服务器端渲染的相关技术，比如JSP，就是一个典型的服务器端渲染技术，用户请求一个地址然后展示到浏览器中的数据都是服务器端处理好的，浏览器只管展示；又比如静态页面，所有页面都是预先编写或生成好的，浏览器将请求拿到的数据直接展现即可。
所以为了实现seo的优化，我们可以采用比较成熟的服务端SSR的框架Nuxt实现。</p>
<h3 id="element-ui要改变默认样式有几种方法" tabindex="-1"><a class="header-anchor" href="#element-ui要改变默认样式有几种方法"><span>element-ui要改变默认样式有几种方法</span></a></h3>
<p>当我们在vue中引入第三方组件库的时候，vue组件中样式的scoped就会成为我们修改样式的阻碍，有以下三种方法修改样式，并且不影响全局样式.</p>
<ul>
<li>
<p>在样式外新增一个样式标签不添加scoped</p>
...
<h3 id="用vue开发项目和原生开发项目相比有什么好处" tabindex="-1"><a class="header-anchor" href="#用vue开发项目和原生开发项目相比有什么好处"><span>用vue开发项目和原生开发项目相比有什么好处</span></a></h3>
<p>?	首先vue和原生js都可以用来开发web项目,但越来越多的项目在立项及技术选型时选择使用vue,主要是有以下优势.</p>
<ol>
<li>
<p>控件跟数据自动绑定，可以直接使用data里面的数据值来提交表单，而不需要再使用$(&quot;#myid&quot;).val()那一套方法来获取控件的值，对控件赋值也方便很多，只需要改变data的值，控件就会自动改变值。将复杂的界面操作，转化为对数据进行操作.</p>
</li>
<li>
<p>页面参数传递和页面状态管理.</p>
<p>页面传值对于vue来说，可供选择的方法非常多。比如使用子组件实现，通过对props属性传值；也可以使用页面url参数的方法传值；或使用vuex全局状态管理的方法页面传值等等。而原生开发的时候，在页面有多个参数的时候，页面传值和初始化，要复杂很多。而vue直接将参数保存在对象里面，直接给子组件的属性或vuex存储一个对象就行了，比如：</p>
</li>
</ol>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token operator">&lt;</span>User <span class="token operator">:</span>userinfo<span class="token operator">=</span><span class="token string">"userinfo"</span><span class="token operator">></span><span class="token operator">&lt;</span><span class="token operator">/</span>User<span class="token operator">></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>这样就可以将userinfo传到自定义组件。</p>
<ol start="3">
<li>
<p>模块化开发、无刷新保留场景参数更新</p>
<p>比如一个列表页面里面有添加功能，有修改功能，这时候我们可以通过引用子组件的形式，当子组件内容更新的时候，修改主组件的数据，比如修改了一条数据后，我们需要列表页同时刷新，但我们不希望改变原来列表页的页码和搜索条件。假如你用原生开发来实现这个，需要写很多业务逻辑保存上一个页面的搜索条件和页码这些参数，但假如你用vue开发，将变得非常简单.</p>
</li>
<li>
<p>代码的可阅读性</p>
<p>vue天生具有组件化开发的能力，因此不同的功能基本都是写在不同的模块里面，因此代码的可阅读性非常高。当一个新手接手一个旧项目的时候，基本上可以做到一天就能定位到要修改的代码，进行修改，快速接手项目.</p>
</li>
<li>
<p>丰富的生态圈</p>
<p>基于强大的nodejs，添加新的组件库，基本一句npm命令就能安装，比如当我需要使用axios组件的时候，直接npm install axios安装一下，就可以使用axios这个组件。</p>
</li>
<li>
<p>开发单页面应用非常友好</p>
<p>主路由、子路由、主页面、子组件的方式，可以让我们彻底抛弃iframe。写过前端页面的都知道，因为iframe的滚动条、和子页面跟其他页面的交互性这些原因、用户体验还是远远没有单页面架构友好。而且使用vue非常简单方便的实现系统菜单、导航等固定布局.</p>
</li>
<li>
<p>各子组件样式不冲突</p>
<p>各个组件之间，可以使用相同的样式名，但有不同的样式属性。比如组件A和组件B的button都绑定了class=&quot;btn&quot;, 但在两个组件里，我们可以实现两个不同的btn样式属性，互不影响</p>
<p>当然，vue也有不足，不足的地方如下：</p>
<ol>
<li>
<p>vue是单页面页面，对于搜索引擎不友好，影响seo.因此不适合做公司官网。比如两个vue路由（页面），它的路径是这样的：index.html#aaa  和 index.html#bbb，但对于搜索引擎来说，都是同一个页面，就是index.html。这样搜索引擎就无法收录你的页面。</p>
</li>
<li>
<p>vue门槛较高，使用vue，需要先学习和摸索vue大概3天左右的时候，建议使用vue的时候，不需要看node.js自动帮你生成的js文件。你只需要编写你自己页面的代码就行了。</p>
</li>
</ol>
</li>
</ol>
<h3 id="element-ui的table组件有哪些属性-为什么table组件要用key" tabindex="-1"><a class="header-anchor" href="#element-ui的table组件有哪些属性-为什么table组件要用key"><span>element-UI的table组件有哪些属性，为什么table组件要用key?</span></a></h3>
<ul>
<li>
<p><strong>table表格组件的属性有</strong>:</p>
<ul>
<li>data , 显示的数据</li>
<li>size , 表格的尺寸, 可选的值有medium / small / mini</li>
<li>height , Table 的高度，默认为自动高度。如果 height 为 number 类型，单位 px.</li>
<li>empty-text , 空数据时显示的文本内容</li>
<li>stripe , 是否为斑马纹 table , boolean类型.</li>
<li>border ,  是否带有纵向边框 , boolean类型.</li>
<li>row-key , 行数据的 Key，用来优化 Table 的渲染；在使用 reserve-selection 功能与显示树形数据时，该属性是必填的.</li>
<li>...</li>
</ul>
</li>
<li>
<p><strong>为什么table组件要用key?</strong></p>
<p>row-key属性用来优化 Table 的渲染, 如果不添加row-key，当重新请求渲染表格数据，会默认触发@current-change等等方法，因为重新渲染列表，current-change发生了改变，原本选择的row，变成不再选择任何一行，导致问题很难排查.</p>
<p>参考官网: <a href="https://element.eleme.cn/#/zh-CN/component/table" target="_blank" rel="noopener noreferrer">table组件</a></p>
</li>
</ul>
<h2 id="二、react" tabindex="-1"><a class="header-anchor" href="#二、react"><span>二、react</span></a></h2>
<h3 id="说说react中onclick绑定后的工作原理" tabindex="-1"><a class="header-anchor" href="#说说react中onclick绑定后的工作原理"><span>说说React中onClick绑定后的工作原理</span></a></h3>
<ol>
<li>首先react有自己的事件系统,也是遵循w3c的,这个事件系统的名称叫做合成事件(SyntheticEvent),而其自定义事件系统的动机主要包含以下几个方面
<ul>
<li><strong>抹平不同浏览器之间的兼容性差异</strong>。最主要的动机。</li>
<li>件合成既可以处理兼容性问题</li>
<li>提供一个抽象的跨平台事件机制</li>
<li><strong>可以做更多优化</strong></li>
<li><strong>可以干预事件的分发</strong></li>
</ul>
</li>
<li>当给组件(元素)绑定<code v-pre>onClick</code>事件之后
<ol>
<li>react会对事件先进行注册,将事件统一注册到<code v-pre>document</code>上</li>
<li>根据组件<code v-pre>唯一的标识key</code>来对事件函数进行存储</li>
<li>统一的指定<code v-pre>dispatchEvent</code>回调函数</li>
<li>储存事件回调:<code v-pre>react会将click</code>这个事件统一存到一个对象中,回调函数的存储采用键值对（key/value）的方式存储在对象中，key 是组件的唯一标识 id，value 对应的就是事件的回调函数,通过组件的key就能回调到相应的函数了</li>
</ol>
</li>
</ol>
<h3 id="说说react里面bind与箭头函数" tabindex="-1"><a class="header-anchor" href="#说说react里面bind与箭头函数"><span>说说react里面bind与箭头函数</span></a></h3>
<ol>
<li>bind 由于在类中,采用的是<code v-pre>严格模式</code>,所以事件回调的时候<code v-pre>会丢失this指向,指向undefined</code>,需要使用bind来给函数绑定上当前实例的this指向</li>
<li><code v-pre>箭头函数</code>的this指向上下文,所以永久能拿到当前组件实例的<code v-pre>this</code>指向,我们可以完美的使用箭头函数来替代传统事件处理函数的回调</li>
</ol>
<h3 id="说说react中的性能优化" tabindex="-1"><a class="header-anchor" href="#说说react中的性能优化"><span>说说react中的性能优化</span></a></h3>
<p>性能优化分为2个方面</p>
<ol>
<li>使用shouldComponentUpdate来对state和props进行对比,如果两次的结果一直,那么就return false</li>
<li>使用纯净组件,pureComponent</li>
</ol>
<h3 id="高阶组件和高阶函数是什么" tabindex="-1"><a class="header-anchor" href="#高阶组件和高阶函数是什么"><span>高阶组件和高阶函数是什么</span></a></h3>
<ol>
<li>高阶函数:函数接收一个函数作为参数,或者将函数作为返回值的函数就是高阶函数 map some every filter reduce find forEach等等都属于高阶函数</li>
<li>高阶组价:接受一个组件,返回一个新组建的组件就是高阶组件,本质上和高阶函数的意思一样</li>
<li>高阶组件是用来复用react代码的一种方式</li>
</ol>
<h3 id="setstate和repalcestate的区别" tabindex="-1"><a class="header-anchor" href="#setstate和repalcestate的区别"><span>setState和repalceState的区别</span></a></h3>
<p>setState 是修改其中的部分状态，相当于 Object. assign，只是覆盖，不会减少原来的状态； replaceState 是完全替换原来的状态，相当于赋值，将原来的 state 替换为另一个对象，如果新状态属性减少，那么 state 中就没有这个状态了</p>
<h3 id="redux中核心组件有哪些-reducer的作用" tabindex="-1"><a class="header-anchor" href="#redux中核心组件有哪些-reducer的作用"><span>redux中核心组件有哪些，reducer的作用</span></a></h3>
<h4 id="redux-三大核心" tabindex="-1"><a class="header-anchor" href="#redux-三大核心"><span>redux 三大核心</span></a></h4>
<ul>
<li>action  action理解为动作，action的值一般为一个对象，格式如 { type: &quot;&quot;, data: &quot;&quot; }，type是必须要的，因为reducer处理数据的时候要根据不同的type来进行不同的操作</li>
<li>reducer reducer是初始化以及处理派发的action的纯函数</li>
<li>store store是一个仓库，用来存储数据，它可以获取数据，也可以派发数据，还能监听到数据的变化</li>
</ul>
<h4 id="reducer的作用" tabindex="-1"><a class="header-anchor" href="#reducer的作用"><span>reducer的作用</span></a></h4>
<p>接收旧的 state 和 action，返回新的 state</p>
<h3 id="什么是受控组件" tabindex="-1"><a class="header-anchor" href="#什么是受控组件"><span>什么是受控组件</span></a></h3>
<p>受控组件就是可以被 react 状态控制的组件
在 react 中，Input textarea 等组件默认是非受控组件（输入框内部的值是用户控制，和React无关）。但是也可以转化成受控组件，就是通过 onChange 事件获取当前输入内容，将当前输入内容作为 value 传入，此时就成为受控组件。</p>
<h3 id="hooks-context和redux你是怎么选择的-都在什么场景下使用" tabindex="-1"><a class="header-anchor" href="#hooks-context和redux你是怎么选择的-都在什么场景下使用"><span>hooks+context和redux你是怎么选择的，都在什么场景下使用</span></a></h3>
<p>如果项目体量较小，只是需要一个公共的store存储state，而不讲究使用action来管理state，那context完全可以胜任。反之，则是redux的优点。</p>
<p>使用场景:
如果你在组件间传递的数据逻辑比较复杂，可以使用redux；
如果组件层级不多，可以使用props；
如果层级较深，数据逻辑简单，可以使用context。</p>
<h3 id="useffect-模拟生命周期" tabindex="-1"><a class="header-anchor" href="#useffect-模拟生命周期"><span>useffect 模拟生命周期</span></a></h3>
<ul>
<li>模拟componentDidMount
第二个参数为一个空数组，可以模拟componentDidMount</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">componentDidMount：useEffect(()=>{console.log('第一次渲染时调用')},[])</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li>模拟componentDidUpdate
没有第二个参数代表监听所有的属性更新</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> useEffect(()=>{console.log('任意状态改变')}) </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>监听多个属性的变化需要将属性作为数组传入第二个参数。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> useEffect(()=>{console.log('指定状态改变')},[状态1,状态2...]) </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li>模拟componentWillUnmount</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{   ...  return()=>{ //组件卸载前}   })</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="setsate更新之后和usestate的区别" tabindex="-1"><a class="header-anchor" href="#setsate更新之后和usestate的区别"><span>setsate更新之后和usestate的区别</span></a></h3>
<ul>
<li>
<p>setState( updater [,callback] )</p>
<p>updater：object/function - 用于更新数据
callback：function - 用于获取更新后最新的 state 值</p>
<p>构造函数是唯一建议给 this.state 赋值的地方
不建议直接修改 state 的值，因为这样不会重新渲染组件
自动进行浅合并（只会合并第1层）
由于 setState() 异步更新的缘故，依赖 state 旧值更新 state 的时候建议采用传入函数的方式</p>
</li>
<li>
<p>useState(initState)</p>
<p>const [ state , setState ] = useState(initState)
state：状态
...
<h3 id="react父组件props变化的时候子组件怎么监听" tabindex="-1"><a class="header-anchor" href="#react父组件props变化的时候子组件怎么监听"><span>react父组件props变化的时候子组件怎么监听</span></a></h3>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">//props发生变化时触发</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="usememo在react中怎么使用" tabindex="-1"><a class="header-anchor" href="#usememo在react中怎么使用"><span>usememo在react中怎么使用</span></a></h3>
<p>返回一个 memoized 值。</p>
<p>把“创建”函数和依赖项数组作为参数传入 useMemo，它仅会在某个依赖项改变时才重新计算 memoized 值。这种优化有助于避免在每次渲染时都进行高开销的计算。</p>
<p>传入 useMemo 的函数会在渲染期间执行。请不要在这个函数内部执行与渲染无关的操作，诸如副作用这类的操作属于 useEffect 的适用范畴，而不是 useMemo。</p>
...
<h3 id="react-hooks各种函数介绍" tabindex="-1"><a class="header-anchor" href="#react-hooks各种函数介绍"><span>React Hooks各种函数介绍</span></a></h3>
<ul>
<li>
<p>useState:</p>
<p>useState 是用于声明一个状态变量的，用于为函数组件引入状态.
...
setState 中接收的对象参数如果地址没变的话会被 React 认为没有改变，因此不会引起视图的更新</p>
</li>
<li>
<p>useReducer:</p>
<p>useReducer 是 useState 的升级版。在 useState 中返回的写接口中，我们只能传递最终的结果，在 setN 的内部也只是简单的赋值操作。</p>
<p>创建初始状态值initialState,</p>
<p>创建包含所有操作的 reducer(state, action) 函数，每种操作类型均返回新的 state 值</p>
<p>根据 initialState 和 reducer 使用 const [state, dispatch] = useReducer(reducer, initialState) 得到读写 API</p>
<p>调用写接口，传递的参数均挂在 action 对象上</p>
</li>
<li>
<p>useContext:</p>
<p>context 是上下文的意思，上下文是局部的全局变量这个局部的范围由开发者自己指</p>
</li>
<li>
<p>useEffect:</p>
<p>effect 是副作用的意思，对环境的改变就是副作用。副作用是函数式编程里的一个概念
在 React 中，useEffect 就是在每次 render 后执行的操作，相当于 afterRender， 接收的第一个参数是回调函数，第二个参数是回调时机。可用在函数组件中模拟生命周期。</p>
<p>如果同时出现多个 useEffect ，会按出现顺序依次执行</p>
</li>
<li>
<p>useLayoutEffect</p>
<p>useEffect 总是在浏览器渲染完视图过后才执行，如果 useEffect 里面的回调函数有对 DOM 视图的操作，则会出现一开始是初始化的视图，后来执行了 useEffect 里的回调后立马改变了视图的某一部分，会出现一个闪烁的状态。
为了避免这种闪烁，可以将副作用的回调函数提前到浏览器渲染视图的前面执行，当还没有将 DOM 挂载到页面显示前执行 Effect 中对 DOM 进行操作的回调函数，则在浏览器渲染到页面后不会出现闪烁的状态。</p>
<p>layout 是视图的意思，useLayoutEffect 就是在视图显示出来前执行的副作用。</p>
<p>useEffect 和 useLayoutEffect 就是执行的时间点不同，useLayoutEffect 是在浏览器渲染前执行，useEffect 是在浏览器渲染后执行。但二者都是在 render 函数执行过程中运行，useEffect 是在 render 完毕后执行，useLayoutEffect 是在 render 完毕前（视图还没渲染到浏览器页面上）执行。</p>
<p>因此 useLayoutEffect 总是在 useEffect 前执行。</p>
<p>一般情况下，如果 Effect 中的回调函数中涉及到 DOM 视图的改变，就应该用 useLayoutEffect，如果没有，则用 useEffect。</p>
</li>
<li>
<p>useRef</p>
<p>useRef Hook 是用来定义一个在组件不断 render 时保持不变的变量。
组件每次 render 后都会返回一个虚拟 DOM，组件内对应的变量都只属于那个时刻的虚拟 DOM。
useRef Hook 就提供了创建贯穿整个虚拟 DOM 更新历史的属于这个组件的局部的全局变量。
为了确保每次 render 后使用 useRef 获得的变量都能是之前的同一个变量，只能使用引用做到，因此，useRef 就将这个局部的全局变量的值存储到了一个对象中，属性名为：current</p>
<p>useRef 的 current 变化时不会自动 render</p>
<p>useRef 可以将创建的 Refs 对象通过 ref 属性的方式引用到 DOM 节点或者 React 实例。</p>
</li>
<li>
<p>useCallback</p>
<p>是将某个函数“放入到react底层原型链上，并返回该函数的索引”，而useMemo是将某个函数返回值“放入到react底层原型链上，并返回该返回值的索引”。一个是针对函数，一个是针对函数返回值。</p>
</li>
<li>
<p>useImperativeHandle</p>
<p>useImperativeHandle可以让父组件获取并执行子组件内某些自定义函数(方法)。本质上其实是子组件将自己内部的函数(方法)通过useImperativeHandle添加到父组件中useRef定义的对象中。</p>
</li>
<li>
<p>useMemo</p>
<p>useMemo可以将某些函数的计算结果(返回值)挂载到react底层原型链上，并返回该函数返回值的索引。当组件重新渲染时，如果useMemo依赖的数据变量未发生变化，那么直接使用原型链上保存的该函数计算结果，跳过本次无意义的重新计算，达到提高组件性能的目的。</p>
</li>
</ul>
<h3 id="react-component和purecomponent区别" tabindex="-1"><a class="header-anchor" href="#react-component和purecomponent区别"><span>React Component和Purecomponent区别</span></a></h3>
<p>Component 没有直接实现 shouldComponentUpdate 这个方法；但是 PureComponent通过浅层的Porps 和 state 的对比，内部实现了这个生命周期函数。</p>
<p>PureComponent会跳过整个组件子树的props更新，要确保全部的子组件也是 pure 的形式。</p>
<p>Component 中需要手动执行的 shouldComponentUpdate 函数，在PureComponent中已经自动完成了（自动浅对比）。</p>
<p>PureComponent不仅会影响本身，而且会影响子组件，所以PureComponent最好用在数据展示组件中</p>
<p>PureCoponent 如果是复杂数据类型，这里会造成错误的显示（setState浅复制更新，但是界面不会重新渲染）</p>
<h3 id="hooks相对于class的优化" tabindex="-1"><a class="header-anchor" href="#hooks相对于class的优化"><span>hooks相对于class的优化</span></a></h3>
...
<p>类组件缺点三：组件之间传值过程复杂、缺点三：复杂场景下代码难以组织在一起<br>
Hooks解决方式：<br>
...
<h3 id="hooks父组件怎么调用子组件的方法" tabindex="-1"><a class="header-anchor" href="#hooks父组件怎么调用子组件的方法"><span>hooks父组件怎么调用子组件的方法</span></a></h3>
<p>父组件使用 <code v-pre>useRef</code> 创建一个 <code v-pre>ref</code> 传入 子组件
子组件需要使用 <code v-pre>useImperativeHandle</code> 暴露 <code v-pre>ref</code> 自定义的实例值给父组件。这个需要用 <code v-pre>forwardRef</code> 包裹着。</p>
<h3 id="讲一下react中的通信" tabindex="-1"><a class="header-anchor" href="#讲一下react中的通信"><span>讲一下react中的通信</span></a></h3>
<p>​		1  父子通信， 使用的时候 在子组件上面自定义属性，子组件通过 this.props[累组件]或者props[函数组件]接收然后使用</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">子组件 </span>
...
<span class="line">  }</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​		2 子父通信 ，使用的时候其实还是父传子，只不过这次将父组件的方法传递给子组件，然后子组件去调用父组件传递的方法，通过传递实参的我方式将子组件的数据传递过来</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  class Son extends React.Component {</span>
<span class="line">    </span>
<span class="line">    render(){</span>
<span class="line">        // this.props.til     til	为父组件传递数据</span>
<span class="line">        </span>
...
<span class="line">  }</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​	 3  状态提升，这种情况将两个组件通过同一个父组件来包裹，将数据绑定到父组件上，然后通过子父和父子进行通信</p>
<p>​	 4  context传递 ， 利用Context对象来传递，Context 提供了 Provider 和 Consumer 俩个组件，Provider负责提供数据，Consumer负责使用数据 ， Provider需要包裹父组件，那么所有它的子代组件都可以获取到共享值，实际上react-router，react-redux 等等都在使用context</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">const Context = React.Contexxt('这里是默认值')；</span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​	5  reudx. 可以使用redux 来进行组件通信，适用于多个组件使用同一个数据 ，可以更好的维护和使用</p>
<h3 id="react通过什么方法修改参数" tabindex="-1"><a class="header-anchor" href="#react通过什么方法修改参数"><span>react通过什么方法修改参数</span></a></h3>
<p>类组件修改数据的方法, 通过setState , 注意setState的修改方法有两种，而且它是异步的</p>
<p>函数组件修改方式通过自定义的方法。需要通过 useState  ， 例如。const [count,setCount] = useState(0)</p>
<p>这里面setCount 可以修改count参数</p>
<h3 id="说你对react-native的了解" tabindex="-1"><a class="header-anchor" href="#说你对react-native的了解"><span>说你对react native的了解</span></a></h3>
<p>​    React native 基于 JavaScript 开发的一个 可以开发原生app的这么一个集成框架，它兼容开发 iOS 和 Android能够实现一套代码，两个系统都能使用，方便维护，相比于web前端的 react ，react-native更好的提供了一些调用手机硬件的API,可以更好的开发移动端，现在react-native它的生态环境也是越来越好，基本上可以完全实现原生开发，</p>
<p>​     但是现在好多的应用还是用它来套壳 （原生 + web前端），用它来做有些路由，和框架的搭建，然后里面内容来使用前端的react来实现，这样一来让维护更方便，开发更快捷</p>
<h3 id="redux的实现原理" tabindex="-1"><a class="header-anchor" href="#redux的实现原理"><span>redux的实现原理</span></a></h3>
<p>​	  redux它是一个单独的状态管理工具，它是一个数据集中管理的方案，简单来说，就是将公用的数据，放在redux里面进行存储，修改的时候也是利用redux提供的方法来修改，让框架使用的数据的时候更方便，维护起来更容易，reudx提供了一下核心内容：</p>
<h4 id="_1-store" tabindex="-1"><a class="header-anchor" href="#_1-store"><span>1 store.</span></a></h4>
<p>​				store是redux的核心内容，整个redux的仓库，所有的应用方法都是由store提供</p>
<h4 id="_2-createstore" tabindex="-1"><a class="header-anchor" href="#_2-createstore"><span>2 createStore</span></a></h4>
<p>​				createStore用老创建store的，方法里面有三个参数，有reducer,有中间件，还有初始值，最重要的就是reducer函数，它提供了整个数据管理的逻辑</p>
<h4 id="_3-reducer-state-action" tabindex="-1"><a class="header-anchor" href="#_3-reducer-state-action"><span>3 reducer(state, action)</span></a></h4>
<p>​				 reducer函数相当于数据加工厂，初始的数据，修改数据的 逻辑都统统的在这里完成，它让我们整个的数据走向更完成，维护更方便</p>
<h4 id="_4-action" tabindex="-1"><a class="header-anchor" href="#_4-action"><span>4 action</span></a></h4>
<p>​				action 本质是一个对象，它来告诉 redux 要执行什么任务</p>
<h5 id="_5-state" tabindex="-1"><a class="header-anchor" href="#_5-state"><span>5 state</span></a></h5>
<p>​			  state它就是我们需要存储的redux的数据，所有的数据都将要在这里面存储</p>
<h4 id="_6-store-getstate" tabindex="-1"><a class="header-anchor" href="#_6-store-getstate"><span>6  store.getState()</span></a></h4>
<p>​				它就是用来获取数据的，每次修改前后的数据都可以用store.getState()来修改</p>
<h4 id="_7-store-dispatch-action" tabindex="-1"><a class="header-anchor" href="#_7-store-dispatch-action"><span>7 store.dispatch(action)</span></a></h4>
<p>​				 用户通过dispatch出发要执行的任务，这个就是出发动作，然后reducer函数会执行，然后进行数据加工</p>
<h4 id="_8。store-subscribe-callback" tabindex="-1"><a class="header-anchor" href="#_8。store-subscribe-callback"><span>8。store.subscribe(callback)</span></a></h4>
<p>​				 会自动的监听state,一旦有state发生改变，store.subscribe就会还行，利用它可以用来更新视图</p>
<h3 id="react里的一个输入框每当用户输入文字就会触发onchange-我们怎么拿到他最后输入完的结果" tabindex="-1"><a class="header-anchor" href="#react里的一个输入框每当用户输入文字就会触发onchange-我们怎么拿到他最后输入完的结果"><span>react里的一个输入框每当用户输入文字就会触发onchange，我们怎么拿到他最后输入完的结果</span></a></h3>
<p>​		1 第一种是通过受控组件，可以获取到state里面的值，获取修改结果</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  class Home extends React.Component {</span>
<span class="line">    state = {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="react的render什么时候渲染" tabindex="-1"><a class="header-anchor" href="#react的render什么时候渲染"><span>react的render什么时候渲染</span></a></h3>
<p>​	react生命周期有三个阶段。 两个阶段都会执行 render</p>
<p>​	主要从更新和挂载两个阶段来讲，挂载阶段都顺序，更新阶段一定要说	 shouldComponentUpdate   true 和false 分别对应后边是否执行render</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  1） 挂在阶段</span>
<span class="line"></span>
<span class="line">​			constructor(){}</span>
<span class="line"></span>
...
<span class="line">​		render() ..		</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="useeffect的依赖为引用类型如何处理" tabindex="-1"><a class="header-anchor" href="#useeffect的依赖为引用类型如何处理"><span>useEffect的依赖为引用类型如何处理</span></a></h3>
<p>useEffect的依赖为饮用类型的时候，可能会导致监听不出发，原因就是监听的统一个地址的时候，对象本身地址没变，所以监听的结果就是认为数据并没有改变从而不直径调用</p>
<p>​	解决方案</p>
<p>​     1 如果数据是对象的话，可以监听对象的里面的值，值是基本类型，如果值改变了，那么可以监听执行</p>
<p>​	 2 在去修改对象和数据的时候，使用参拷贝或者浅拷贝，这样地址发生改变可以监听执行</p>
<p>​	 3 可以转成字符串，通过JSON.stringify() ,监听字符串这样的，这样改变也会执行</p>
<h3 id="说说在使用hooks的过程中-需要注意的" tabindex="-1"><a class="header-anchor" href="#说说在使用hooks的过程中-需要注意的"><span>说说在使用Hooks的过程中，需要注意的</span></a></h3>
<pre><code>1 首先注意到就是 useState 里面方法是异步的，所以不要在后面连续调用，由于react方法是批量异步调用，并不是每次调用修改方法都执行，所以需要用到callback写法
</code></pre>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  const [count, setCount] = useState(0);</span>
...
<span class="line">  </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​	 	  2 由于 useState的是异步的，不要在修改后直接使用数据 , 可以先修改数据，判断数据，也可以利用useEffec，useMemo等等通过监听数据执行</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">    const [count, setCount] = useState(0);</span>
<span class="line">    </span>
<span class="line">     const add = () => {</span>
<span class="line">        setCount(count + 1); </span>
...
<span class="line">    </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​		3 useEffect 这个hook的使用，每一个消耗性能的内容都可以通过return 来消除</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  useEffect(()=>{</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​	   4  useRef  可以获取组件的数据，也可当常量的值来使用，注意获取数据使用的时候函数组件特别需要注意,如果子组件是函数组件需要利用 useImperativeHandle ，forWard</p>
<h3 id="react组件的key说一下-key发生变化会发生什么-key-值不同销毁前会触发什么生命周期" tabindex="-1"><a class="header-anchor" href="#react组件的key说一下-key发生变化会发生什么-key-值不同销毁前会触发什么生命周期"><span>react组件的key说一下 key发生变化会发生什么 key 值不同销毁前会触发什么生命周期</span></a></h3>
<p>​       1 react的key值给组件作为唯一标识，类似身份证，当数组发生增删改查的时候可以通过这个 标识来去对比虚拟dom的更改前后，如果相同标识的数据或者属性没有改变的话，讲直接略过，对比有改变的然后直接改变此项</p>
<p>​		2 如果给组件添加key,如果key值改变的时候，组件将会重新出创建会执行 挂在阶段的生命周期</p>
<p>​		 	constructor</p>
<p>​			 static getDerivedStateFromProps()</p>
<p>​			 render(){}</p>
<p>​			componentDidUpdate</p>
<p>​</p>
<h3 id="知道react里面的createportal么-说说使用场景。之前react没有这个的时候是怎么实现的-有他没他的区别" tabindex="-1"><a class="header-anchor" href="#知道react里面的createportal么-说说使用场景。之前react没有这个的时候是怎么实现的-有他没他的区别"><span>知道react里面的createPortal么？说说使用场景。之前react没有这个的时候是怎么实现的，有他没他的区别</span></a></h3>
<p>react.createPortal 这个方法是来使用做弹窗Modal组件的,在没有这个组件之前我们可以自己定义组件，然后去实现Modal效果</p>
<p>​	Modal.js</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">const styles = {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>react.createPortal 这个来制作弹窗组件，它 在Modal 组件位置进行 <code v-pre>fixed</code> 定位，可以任意的挂载到某个dom元素上，使用后的管理更方便，但是注意需要预留html的挂载元素</p>
<h3 id="react全家桶" tabindex="-1"><a class="header-anchor" href="#react全家桶"><span>react全家桶</span></a></h3>
<p>真正意义上的react全家桶，其实指的是react，react-dom，react-native。
因为react核心库只是vDom的操作，无关dom(dom操作在react-dom中)——这意味着它天生就可以做到跨平台。</p>
<p>注意这里有误区，react-router，react-router-dom，react-dux只是社区的一些使用较多的解决方案，事实上它们各有缺陷。</p>
<h3 id="如何理解fiber" tabindex="-1"><a class="header-anchor" href="#如何理解fiber"><span>如何理解fiber？</span></a></h3>
<p>截止到当前版本(react17.0.2),react尚存在一个明显的缺陷——这是大多数vDom框架都需要面对的——“diff”。
...
事实上，原计划是17版本上的，但最终定期在了18版本。</p>
<h3 id="时间分片-任务分炼" tabindex="-1"><a class="header-anchor" href="#时间分片-任务分炼"><span>时间分片，任务分炼</span></a></h3>
<p>fiber节点的改造是为了将diff的单位从不可中断的tree降级到可中断的单一vDom。这意味着每次一个vDom节点比对过后，可以轮训是否发生了优先级更高的并发事件(react将用户想更快得到反馈的事进行了优先级排序，比如js动画等)。
...
<h3 id="你了解hooks吗-谈谈你对hooks的理解-聊聊hooks" tabindex="-1"><a class="header-anchor" href="#你了解hooks吗-谈谈你对hooks的理解-聊聊hooks"><span>你了解hooks吗？谈谈你对hooks的理解？聊聊hooks？</span></a></h3>
<p>react-hooks提供给了函数式组件以业务逻辑抽离封装的能力，从单一组件单位进行UI与业务逻辑的分离，以此来保证函数式组件的UI纯净。
在此之前，我们只能通过状态提升的方式，将业务逻辑提升到容器组件的方式。</p>
<h3 id="hooks使用规则" tabindex="-1"><a class="header-anchor" href="#hooks使用规则"><span>hooks使用规则？</span></a></h3>
<ul>
<li>
<p>只可以在顶层调用栈调用hooks</p>
<ul>
<li>不可以在循环/条件/嵌套里调用hooks</li>
</ul>
</li>
<li>
<p>只可以在react function或自定义hooks里调用hooks</p>
<ul>
<li>原因见hooks调用记录表底层</li>
</ul>
</li>
</ul>
<h3 id="hooks调用记录表底层-单链表结构" tabindex="-1"><a class="header-anchor" href="#hooks调用记录表底层-单链表结构"><span>hooks调用记录表底层_单链表结构</span></a></h3>
<p>hooks的引用记录，是用单链表结构实现的；(可在力扣/leetcode网找一下实现单链表的算法)
每一个链表节点(node)都有一个next的指针指向下一个node；
如果中间有缺失，那么就无法找到下一个next；
因此hooks不可以在条件里调用（有可能丢失链表node，导致hooks遍历中断）；</p>
<h3 id="useeffect与副作用-什么是副作用-聊聊useeffect" tabindex="-1"><a class="header-anchor" href="#useeffect与副作用-什么是副作用-聊聊useeffect"><span>useEffect与副作用？什么是副作用？聊聊useEffect？</span></a></h3>
<ul>
<li>副作用函数
我们将跟UI渲染无关的业务逻辑称之为副作用。
useEffect是react在函数式组件里提供的副作用解决方案，它接受两个参数。
第一个是必传参数，类型为函数。
我们写在此函数中的业务逻辑代码就是我们所说的副作用。</li>
<li>消除副作用函数
默认情况下，useEffct会在每次render后执行传入的副作用函数。
然而有的时候我们需要在执行副作用前先去除掉上次render添加的副作用效果,我们可以在副作用函数里再返回一个函数———这个函数就是消除副作用，它会在每次reRender前和组件卸载时去执行。</li>
<li>监听器
与 useMemo, useCallback等一样，useEffect可以传入一个监听数组参数，这意味着副作用只有在数组中的监听值变化时才会执行。
我们借助它的这个参数特性，可以模拟类组件生命周期钩子————比如componentDidMount等。</li>
</ul>
<h3 id="生命周期模拟" tabindex="-1"><a class="header-anchor" href="#生命周期模拟"><span>生命周期模拟？</span></a></h3>
<p>useEffect的本质作用，其实是将函数式组件中的业务逻辑副作用进行抽离封装。模拟生命周期并不是它的核心思想，但它当然能做到这个事：
https://github.com/melodyWxy/melody-core-utils/blob/master/src/lifeHooks/index.ts</p>
<h3 id="uselayouteffect" tabindex="-1"><a class="header-anchor" href="#uselayouteffect"><span>useLayoutEffect？</span></a></h3>
<p>与useEffect的区别是，useLayoutEffect中副作用的执行时间在组件render之前，这意味着它适用于比组件render更紧急的副作用。
正因为如此，多数情况下我们不会选择使用它，因为我们并不想阻塞render。</p>
<h3 id="useref" tabindex="-1"><a class="header-anchor" href="#useref"><span>useRef</span></a></h3>
<ul>
<li>
<p>变量值存储功能
首先，函数式组件每次render就会重新执行一次，这意味着我们在函数组件中定义的变量都会重置，无法保留变更。
useRef可以解决这个问题——它会形成一个闭包作用域来记录这个值。</p>
</li>
<li>
<p>ref的通用功能
当然，我们也可以用它来标记dom和类组件，从而获取对应的实例。</p>
</li>
</ul>
<h3 id="usecallback" tabindex="-1"><a class="header-anchor" href="#usecallback"><span>useCallback</span></a></h3>
<p>同样的，因为函数式组件每次render就会重新执行一次，因此我们在函数式组件中定义的方法都会重新定义————多数情况下这是不必要的，因此我们可以用useCallback来缓存它。
当然，我们也可以基于它第二个参数——一个监听数组，来控制它在何种时机进行重定义。</p>
<h3 id="usememo" tabindex="-1"><a class="header-anchor" href="#usememo"><span>useMemo</span></a></h3>
<p>同样的，因为函数式组件每次render就会重新执行一次，因此我们在定义的一些变量或者计算过后的变量，都会重新定义————多数情况下这是不必要的，因此我们可以用useCallback来缓存它。
当然，我们也可以基于它第二个参数——一个监听数组，来控制它在何种时机进行重定义。</p>
<h2 id="redux" tabindex="-1"><a class="header-anchor" href="#redux"><span>redux</span></a></h2>
<h3 id="flux" tabindex="-1"><a class="header-anchor" href="#flux"><span>Flux</span></a></h3>
<p>Flux 是一种 架构思想，简单来讲 就是:
状态提升到全局Store + Store内容分发给组件 + 组件交互updateStore然后更新组件。
就是这样一种 通过全局store同一管理数据(从而实现组件间数据共享)的架构思想。</p>
<h3 id="redux与react-redux" tabindex="-1"><a class="header-anchor" href="#redux与react-redux"><span>redux与react-redux</span></a></h3>
<p>基于这种思想，社区里已有各种各样成型的解决方案，其中，redux是通用性比较强的方案(兼容原生和绝大部分框架);
...
react-redux 的核心：Provider 与 connect</p>
<h3 id="provider和connect的底层原理" tabindex="-1"><a class="header-anchor" href="#provider和connect的底层原理"><span>Provider和connect的底层原理</span></a></h3>
<p>Provider容器组件底层: 把store打入 contextconnect;
高阶组件底层： 从context拿到store，然后打入到参数组件的props;</p>
<ul>
<li>什么是高阶组件？
高阶组件：接受一个组件为参数，return 出一个新的组件；
高阶函数：就是一个函数，接受一个函数为参数。</li>
<li>redux的核心：
<ul>
<li>createStore 与 disPatchcreateStore： 创建store</li>
<li>disPatch： 更新store的方法disPatch的规范/更新store的流程</li>
</ul>
</li>
</ul>
<h3 id="react-redux流程" tabindex="-1"><a class="header-anchor" href="#react-redux流程"><span>react-redux流程</span></a></h3>
<ul>
<li>状态提升到全局与分发
<ul>
<li>createStore创建全局状态仓库</li>
<li>Provider和connnect进行状态的分发</li>
</ul>
</li>
<li>状态更新
<ul>
<li>disPatch 一个 action （action就是一个对象，形如{type:'xxx',...prarams}）,基于action.type,触发对应的reducer（reducer是具体更新store的方法，纯函数）逻辑，从而更新store;</li>
</ul>
</li>
</ul>
<h3 id="react组件的概念-高阶组件-受控组件-非受控组件" tabindex="-1"><a class="header-anchor" href="#react组件的概念-高阶组件-受控组件-非受控组件"><span>react组件的概念（高阶组件，受控组件，非受控组件）</span></a></h3>
<h5 id="高阶组件" tabindex="-1"><a class="header-anchor" href="#高阶组件"><span>高阶组件：</span></a></h5>
<p>高阶组件（HOC）是 React 中用于复用组件逻辑的一种高级技巧。HOC 自身不是 React API 的一部分，它是一种基于 React 的组合特性而形成的设计模式。</p>
<h6 id="一-属性代理" tabindex="-1"><a class="header-anchor" href="#一-属性代理"><span>一  属性代理</span></a></h6>
<ol>
<li>属性代理是最常见的实现方式，它本质上是使用组合的方式，通过将组件包装在容器组件中实现功能。</li>
<li>属性代理方式实现的高阶组件和原组件的生命周期关系完全是React父子组件的生命周期关系，所以该方式实现的高阶组件会影响原组件某些生命周期等方法。
操作 props
抽象 state
获取 refs 引用
获取原组件的 static 方法
...
<h6 id="二-反向继承" tabindex="-1"><a class="header-anchor" href="#二-反向继承"><span>二  反向继承</span></a></h6>
<p>反向继承指的是使用一个函数接受一个组件作为参数传入，并返回一个继承了该传入组件的类组件，且在返回组件的 render() 方法中返回 super.render() 方法，最简单的实现如下：</p>
<h5 id="受控组件" tabindex="-1"><a class="header-anchor" href="#受控组件"><span>受控组件</span></a></h5>
<ol>
...
<h5 id="非受控组件" tabindex="-1"><a class="header-anchor" href="#非受控组件"><span>非受控组件</span></a></h5>
<p>非受控组件将数据存储在DOM中，而不是组件内，这比较类似于传统的HTML表单元素。</p>
<ol>
<li>非受控组件的值不受组件自身的state和props控制</li>
<li>非受控组件使用ref从DOM中获取元素数据</li>
</ol>
<h3 id="react类组件中的生命周期-整体分几步-常用的有哪些" tabindex="-1"><a class="header-anchor" href="#react类组件中的生命周期-整体分几步-常用的有哪些"><span>react类组件中的生命周期，整体分几步，常用的有哪些</span></a></h3>
<p>三大阶段，如图
实例期
存在期
销毁期
<img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e12b2e35c8444f19b795b27e38f4c149~tplv-k3u1fbpfcp-watermark.awebp" alt="avatar"></p>
<h3 id="render里面为什么不能使用setstate" tabindex="-1"><a class="header-anchor" href="#render里面为什么不能使用setstate"><span>render里面为什么不能使用setState</span></a></h3>
<p>setState会重新执行render函数，如果添加setState会导致死循环</p>
<h3 id="子组件中修改状态时会不会影响父组件-会不会触发生命周期" tabindex="-1"><a class="header-anchor" href="#子组件中修改状态时会不会影响父组件-会不会触发生命周期"><span>子组件中修改状态时会不会影响父组件，会不会触发生命周期</span></a></h3>
<p>如果父组件中没有依赖子组件的状态不会
如果父组件中依赖了子组件的状态，因为要执行setState会重新触发生命周期</p>
<h3 id="父组件改变时会不会影响子组件" tabindex="-1"><a class="header-anchor" href="#父组件改变时会不会影响子组件"><span>父组件改变时会不会影响子组件</span></a></h3>
<p>会，因为会重新执行render函数，如果不想更新子组件可以在shouldComponentUpdate中终止掉</p>
<h3 id="react页面跳转路由传参方法" tabindex="-1"><a class="header-anchor" href="#react页面跳转路由传参方法"><span>react页面跳转路由传参方法</span></a></h3>
<p>跳转路由，并向路由组件传递params参数</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>跳转路由，并向路由组件传递search参数</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>跳转路由，并向路由组件传递state参数</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="使用redux时-setstate修改状态的过程是异步还是同步" tabindex="-1"><a class="header-anchor" href="#使用redux时-setstate修改状态的过程是异步还是同步"><span>使用redux时，setState修改状态的过程是异步还是同步</span></a></h3>
<h3 id="类组件setstate是同步还是异步" tabindex="-1"><a class="header-anchor" href="#类组件setstate是同步还是异步"><span>类组件setState是同步还是异步</span></a></h3>
<ol>
<li>使用合成事件 setState是异步的，想要拿到最新数据需要去回调中</li>
<li>使用原生事件 setState是同步的</li>
</ol>
<h3 id="传值过程中-子传值能不能改变父组件-为什么" tabindex="-1"><a class="header-anchor" href="#传值过程中-子传值能不能改变父组件-为什么"><span>传值过程中，子传值能不能改变父组件，为什么？</span></a></h3>
<p>不能，props为只读状态 单向数据流</p>
<h3 id="hooks中常用的api有哪些" tabindex="-1"><a class="header-anchor" href="#hooks中常用的api有哪些"><span>hooks中常用的api有哪些</span></a></h3>
<p>useState()
userContext()
userReducer()
useEffect()</p>
<h3 id="useeffect中第二个参数有什么作用" tabindex="-1"><a class="header-anchor" href="#useeffect中第二个参数有什么作用"><span>useeffect中第二个参数有什么作用</span></a></h3>
<p>如果想执行只运行一次的 effect（仅在组件挂载和卸载时执行），可以传递一个空数组（[]）作为第二个参数。这就告诉 React 你的 effect 不依赖于 props 或 state 中的任何值，所以它永远都不需要重复执行。</p>
<h3 id="react常用的优化手段有哪些" tabindex="-1"><a class="header-anchor" href="#react常用的优化手段有哪些"><span>react常用的优化手段有哪些</span></a></h3>
<ol>
<li>属性传递优化</li>
<li>多组件优化</li>
<li>Key</li>
...
<li>不要使用内联函数定义</li>
<li>避免 componentWillMount() 中的异步请求</li>
<li>在 Constructor 的早期绑定函数</li>
<li>优化 React 中的条件渲染</li>
<li>不要在 render 方法中导出数据</li>
<li>为组件创建错误边界</li>
<li>组件的不可变数据结构</li>
</ol>
<h3 id="为什么要用redux-怎么修改数据" tabindex="-1"><a class="header-anchor" href="#为什么要用redux-怎么修改数据"><span>为什么要用redux，怎么修改数据</span></a></h3>
<p>使用Redux的主要优势之一是它可以帮你处理应用的共享状态。如果两个组件需要访问同一状态，该怎么办？这种两个组件同时需要访问同一状态的现象称为“共享状态”。你可以将该状态提升到附近的父组件，但是如果该父组件在组件树中向上好几个组件的位置，那么将状态当做属性向下一个一个地传递，这项工作很快就会变得乏味。此外，在该父组件和该子组件之间的组件甚至根本不需要访问该状态！</p>
<p>在构建网络应用时，Redux不仅使我们能够以有条理的方式存储数据，而且使我们能够在应用的任何位置快速获取该数据。只需告诉Redux到底哪个组件需要哪个数据，它就会为你处理后续一切工作！</p>
<p>借助Redux，你可以控制状态改变的时间、原因和方式。</p>
<h3 id="useeffect是干什么的" tabindex="-1"><a class="header-anchor" href="#useeffect是干什么的"><span>useEffect是干什么的</span></a></h3>
<p>该 Hook 接收一个包含命令式、且可能有副作用代码的函数。
在函数组件主体内（这里指在 React 渲染阶段）改变 DOM、添加订阅、设置定时器、记录日志以及执行其他包含副作用的操作都是不被允许的，因为这可能会产生莫名其妙的 bug 并破坏 UI 的一致性。
使用 useEffect 完成副作用操作。赋值给 useEffect 的函数会在组件渲染到屏幕之后执行。你可以把 effect 看作从 React 的纯函数式世界通往命令式世界的逃生通道。</p>
<h3 id="useeffect能完全模拟componentdidupdate吗" tabindex="-1"><a class="header-anchor" href="#useeffect能完全模拟componentdidupdate吗"><span>useEffect能完全模拟componentDidUpdate吗</span></a></h3>
<p>不可以。 useEffect 并不完全等同于 componentWillUnMount 。当 useEffect 模拟 componentDidMount 和 componentDidUpdate 的时候，返回的函数并不完全等同于 componentWillUnMount。</p>
<h3 id="uselayouteffect和useeffect的区别" tabindex="-1"><a class="header-anchor" href="#uselayouteffect和useeffect的区别"><span>useLayoutEffect和useEffect的区别</span></a></h3>
<p>useEffect和useLayoutEffect作为组件的副作用，本质上是一样的。共用一套结构来存储effect链表。整体流程上都是先在render阶段，生成effect，并将它们拼接成链表，存到fiber.updateQueue上，最终带到commit阶段被处理。他们彼此的区别只是最终的执行时机不同，一个异步一个同步，这使得useEffect不会阻塞渲染，而useLayoutEffect会阻塞渲染。</p>
<h3 id="react和vue的数据流-底层原理" tabindex="-1"><a class="header-anchor" href="#react和vue的数据流-底层原理"><span>react和vue的数据流，底层原理</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">React遵循从上到下的数据流向，即单向数据流。</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="react路由和vue路由底层实现原理" tabindex="-1"><a class="header-anchor" href="#react路由和vue路由底层实现原理"><span>react路由和vue路由底层实现原理</span></a></h3>
<p>eact-router和vue-router实现原理大同小异，都是通过两种方式，hash和history，首先看一下什么是hash和history：</p>
<ul>
<li>hash —— 即地址栏 URL 中的 # 符号（此 hash 不是密码学里的散列运算）。比如这个 URL：<a href="https://link.zhihu.com/?target=http%3A//www.abc.com/%23/hello" target="_blank" rel="noopener noreferrer">http://www.abc.com/#/hello</a>，hash 的值为 #/hello。它的特点在于：hash 虽然出现在 URL 中，但不会被包括在 HTTP 请求中，对后端完全没有影响，因此改变 hash 不会重新加载页面。</li>
<li>history —— 利用了 HTML5 History Interface 中新增的 pushState() 和 replaceState() 方法。（需要特定浏览器支持）这两个方法应用于浏览器的历史记录栈，在当前已有的 back、forward、go 的基础之上，它们提供了对历史记录进行修改的功能。只是当它们执行修改时，虽然改变了当前的 URL，但浏览器不会立即向后端发送请求。</li>
</ul>
<ol>
<li>hash模式（vue-router默认hash模式）</li>
</ol>
<p>hash模式背后的原理是onhashchange事件。</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（localtion是js里管理地址栏的内置对象，是window对象的一部分，可通过window.localtion访问，在w3cshool里的详细介绍)</p>
<p>由于hash发生变化的url都会被浏览器记录下来，使得浏览器的前进后退都可以使用了，尽管浏览器没有亲求服务器，但是页面状态和url关联起来。后来人们称其为前端路由，成为单页应用标配。</p>
<p>比如<a href="https://link.zhihu.com/?target=http%3A//www.abc.com/%23/index" target="_blank" rel="noopener noreferrer">http://www.abc.com/#/index</a>，hash值为#/index。hash模式的特点在于hash出现在url中，但是不会被包括在HTTP请求中，对后端没有影响，不会重新加载页面。</p>
<p>2.history模式</p>
<p>当使用history模式时，url就像正常的url,例如<a href="https://link.zhihu.com/?target=http%3A//abc.com/user/id" target="_blank" rel="noopener noreferrer">http://abc.com/user/id</a>相比hash模式更加好看。特别注意，history模式需要后台配置支持。如果后台没有正确配置，访问时会返回404。</p>
<p>其中一事件触发用到了 onpopstate。</p>
<p>通过history api，我们丢弃了丑陋的#，但是有一个缺点，当刷新时，如果服务器中没有相应的相应或者资源，会分分钟刷出一个404来（刷新需要请求服务器）。所以history模式不怕前进，不怕后退，就怕刷新。</p>
<p>下述案例为实现的react-router的代码，来了解router大致实现原理</p>
<p><strong>原理</strong>： 在dom渲染完成之后，给window 添加 “hashchange” 事件监听页面hash的变化，并且在state属性之中添加了 route属性，代表当前页面的路由。</p>
<p>1、当点击连接 页面hash改变时，触发绑定在window 上的 hashchange 事件，</p>
<p>2、在 hashchange 事件中改变组件的 state中的 route 属性，（react组件的state属性改变时，自动重新渲染页面）</p>
<p>3、页面 随着 state 中的route属性改变自动 根据 不停的hash 给 Child 变量赋值不通的组件，进行渲染</p>
<p>核心代码：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">'react'</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="axios守卫-请求和响应守卫" tabindex="-1"><a class="header-anchor" href="#axios守卫-请求和响应守卫"><span>axios守卫（请求和响应守卫）</span></a></h3>
<p>其实这个问题问的是axios请求封装种的请求拦截器和响应拦截器，比如如下的封装代码案例</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> axios <span class="token keyword">from</span> <span class="token string">'axios'</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dva之前有了解吗" tabindex="-1"><a class="header-anchor" href="#dva之前有了解吗"><span>dva之前有了解吗</span></a></h3>
<p>这个其实是支付宝整合的一套框架，集成了 (redux + react-router + redux-saga 等)的一层轻量封装。dva 是 framework，不是 library，类似 emberjs。
他最核心的是提供了 app.model 方法，用于把 reducer, initialState, action, saga 封装到一起。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">app<span class="token punctuation">.</span><span class="token function">model</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>
<p>namespace - 对应 reducer 在 combine 到 rootReducer 时的 key 值</p>
</li>
<li>
<p>state - 对应 reducer 的 initialState</p>
</li>
<li>
<p>subscription - elm@0.17 的新概念，在 dom ready 后执行，这里不展开解释</p>
</li>
<li>
<p>effects - 对应 saga，并简化了使用</p>
</li>
<li>
<p>reducers - 相当于数据模型</p>
</li>
</ul>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line">// 如何创建一个dva项目</span>
...
<h4 id="方式1-添加global" tabindex="-1"><a class="header-anchor" href="#方式1-添加global"><span>方式1:添加global</span></a></h4>
<p>可以在样式的外部添加:global</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> &lt;Form onSubmit={this.handleSubmit} className="account-form"></span>
<span class="line"> &lt;/Form></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-css line-numbers-mode" data-highlighter="prismjs" data-ext="css" data-title="css"><pre v-pre><code><span class="line"><span class="token selector">:global</span><span class="token punctuation">{</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="方式2-定制主题" tabindex="-1"><a class="header-anchor" href="#方式2-定制主题"><span>方式2:定制主题</span></a></h4>
<p>可以参考链接https://ant.design/docs/react/customize-theme-cn</p>
<p>我们以 webpack@4 为例进行说明，以下是一个 <code v-pre>webpack.config.js</code> 的典型例子，对 <a href="https://github.com/webpack-contrib/less-loader" target="_blank" rel="noopener noreferrer">less-loader</a> 的 options 属性进行相应配置。</p>
<div class="language-diff line-numbers-mode" data-highlighter="prismjs" data-ext="diff" data-title="diff"><pre v-pre><code><span class="line">// webpack.config.js</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：</p>
<ol>
<li>less-loader 的处理范围不要过滤掉 <code v-pre>node_modules</code> 下的 antd 包。</li>
<li><code v-pre>lessOptions</code> 的配置写法在 <a href="https://github.com/webpack-contrib/less-loader/releases/tag/v6.0.0" target="_blank" rel="noopener noreferrer">less-loader@6.0.0</a> 里支持。</li>
</ol>
<h3 id="react-组件传值的方法" tabindex="-1"><a class="header-anchor" href="#react-组件传值的方法"><span>React 组件传值的方法</span></a></h3>
<ol>
<li>父组件传递到子组件传值。又称正向传值 采用props进行数据的传递</li>
<li>子组件传递到父组件传值。又称逆向传值 通过在父组件引入的子组件中传递一个函数并传参，子组件去触发这个函数更改参数完成数据更新</li>
<li>同级组件传值。又称同胞传值 通过一款插件pubsub-js 这个可以采用发布订阅的方式实现组件间的传值 a组件通过publish进行发布数据。b组件通过subscribe订阅数据</li>
<li>跨层级传值 通过上下文对象的形式进行数据的传递 通过Provider生产数据 需要接受的组件使用consumer使用数据</li>
<li>redux也可以完成上述传值方式</li>
</ol>
<h3 id="useeffect模拟生命周期" tabindex="-1"><a class="header-anchor" href="#useeffect模拟生命周期"><span>useEffect模拟生命周期</span></a></h3>
<h4 id="模拟componentdidmount" tabindex="-1"><a class="header-anchor" href="#模拟componentdidmount"><span>模拟componentDidMount</span></a></h4>
<p>hooks 模拟 componentDidMount</p>
<p>useEffect 拥有两个参数，第一个参数作为回调函数会在浏览器布局和绘制完成后调用，因此它不会阻碍浏览器的渲染进程。
第二个参数是一个数组</p>
<ul>
<li>当数组存在并有值时，如果数组中的任何值发生更改，则每次渲染后都会触发回调。</li>
<li>当它不存在时，每次渲染后都会触发回调。</li>
<li>当它是一个空列表时，回调只会被触发一次，类似于 componentDidMount。</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{console.log('第一次渲染时调用')},[])</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h4 id="模拟componentdidupdate" tabindex="-1"><a class="header-anchor" href="#模拟componentdidupdate"><span>模拟componentDidUpdate</span></a></h4>
<p>没有第二个参数代表监听所有的属性更新</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{console.log('任意属性该改变')}) </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>监听多个属性的变化需要将属性作为数组传入第二个参数。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{console.log('n变了')},[n,m]) </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h4 id="模拟componentwillunmount" tabindex="-1"><a class="header-anchor" href="#模拟componentwillunmount"><span>模拟componentWillUnmount</span></a></h4>
<p>通常，组件卸载时需要清除 effect 创建的诸如订阅或计时器 ID 等资源 useEffect函数返回的函数可以表示组件卸载了</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>hooks 模拟 shouldComponentUpdate</p>
<p>React.memo 包裹一个组件来对它的 props 进行浅比较,但这不是一个 hooks，因为它的写法和 hooks 不同,其实React.memo 等效于 PureComponent，但它只比较 props。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">const MyComponent = React.memo(</span>
...
<li>
<p>hooks 模拟 componentDidUpdate</p>
<p>没有第二个参数代表监听所有的属性更新</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{console.log('任意属性该改变')}) </span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>监听多个属性的变化需要将属性作为数组传入第二个参数。</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>hooks 模拟 componentWillUnmount</p>
<p>通常，组件卸载时需要清除 effect 创建的诸如订阅或计时器 ID 等资源 useEffect函数返回的函数可以表示组件卸载了</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">useEffect(()=>{</span>
<span class="line"> const timer = setTimeout(()=>{</span>
<span class="line">     ...</span>
...
<h3 id="react框架怎么做优化" tabindex="-1"><a class="header-anchor" href="#react框架怎么做优化"><span>react框架怎么做优化</span></a></h3>
<p>1.render里面尽量减少新建变量和bind函数，传递参数时尽量减少传递参数的数量</p>
<p>第一种是在构造函数中绑定this，会在 构造函数 实例化的时候执行一次</p>
<p>第二种是在render()函数里面绑定this，在每次render()的时候都会重新执行一遍</p>
<p>第三种就是使用箭头函数，每一次render()的时候，都会生成一个新的箭头函数，即使两个箭头函数的内容是一样的。</p>
<p>2.shouldComponentUpdate是决定react组件什么时候能够不重新渲染的函数，但是这个函数默认的实现方式就是简单的返回一个true。也就是说，默认每次更新的时候都要调用所用的生命周期函数，包括render函数，重新渲染。</p>
<p>为了不做不必要的渲染，需要使用shouldComponentUpdate 加以判断</p>
<p>最新的react中，react给我们提供了React.PureComponent</p>
<p>3.使用key进行组件的唯一标识</p>
<h3 id="react的虚拟dom怎么实现" tabindex="-1"><a class="header-anchor" href="#react的虚拟dom怎么实现"><span>react的虚拟dom怎么实现</span></a></h3>
<p>虚拟DOM可以看做一棵模拟了DOM树的JavaScript对象树。在传统的 Web 应用中，我们往往会把数据的变化实时地更新到用户界面中，于是每次数据的微小变动都会引起 DOM 树的重新渲染。虚拟DOM的目的是将所有操作累加起来，统计计算出所有的变化后，统一更新一次DOM。</p>
<p>React会先将你的代码转换成一个javascript对象，然后再把这个javascript对象转换成真实的DOM。而这个javascript对象就是所谓的虚拟DOM。</p>
<p>1.基于babel-preset-react-app把JSX变成<code v-pre>React.createElement(...)</code>。可以理解为JSX只是React.createElement的语法糖。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">&lt;div className="box" style={{color: '#f00'}} index={0}></span>
<span class="line">    123</span>
<span class="line">    &lt;p>456&lt;/p></span>
<span class="line">&lt;/div></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>经过babel转换成下面的样子：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">React.createElement("div", {</span>
...
<span class="line">);</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.执行<code v-pre>React.createElement(...)</code>会返回一个javascript对象，这个对象就是所谓的虚拟DOM。</p>
<p>createElement会返回一个虚拟对象 <code v-pre>let VitrualDomObj = React.createElement(...)</code></p>
<p>3.把这个虚拟DOM通过render函数转换成真实的DOM</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">myrender( VitrualDomObj , document.getElementById('root'));</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="redux和mobx的区别" tabindex="-1"><a class="header-anchor" href="#redux和mobx的区别"><span>redux和mobx的区别？</span></a></h3>
<p>1.共同点：</p>
<ul>
<li>两者都是为了解决状态不好管理，无法有效同步的问题而产生的工具。</li>
<li>都是用来统一管理应用状态的工具</li>
<li>某一个状态只有一个可靠的数据来源</li>
<li>操作更新的方式是统一的，并且是可控的</li>
<li>都支持store与react组件，如react-redux,mobx-react;</li>
</ul>
<p>2.不同点：</p>
<p>Redux每一次的dispatch都会从根reducer到子reducer嵌套递归的执行，所以效率相对较低；而Mobx的内部使用的是依赖收集，所以不会有这个问题，执行的代码较少，性能相对更高；</p>
<p>Redux核心是不可变对象，在Reducer中的操作都要比较小心，注意不能修改到state的属性，返回时必须是一个全新的对象；而Mobx采用不存在这个问题，操作比较随意；</p>
<p>Redux中写法固定，模板代码较多，Mobx中写法比较随意，但是因为写法随意的原因，如果没有规范性的话，维护性则不会像Redux那么高；</p>
<p>正因为Redux中的reducer更新时，每次return的都是不可变对象，所以时间旅行操作相对容易，而Mobx在这方面不占优势</p>
<p>Redux更加的轻量，但是一般来说都会配合中间件进行使用</p>
<h3 id="react中跨级组件通信中的context是不推荐使用的-为什么-不使用redux还有其它方案吗" tabindex="-1"><a class="header-anchor" href="#react中跨级组件通信中的context是不推荐使用的-为什么-不使用redux还有其它方案吗"><span>react中跨级组件通信中的context是不推荐使用的，为什么？不使用redux还有其它方案吗？</span></a></h3>
<p>1、Context目前还处于实验阶段，可能会在后面的发行版本中有很大的变化，事实上这种情况已经发生了，所以为了避免给今后升级带来大的影响和麻烦，不建议在app中使用context。
...
4、context的更新需要通过setState()触发，但是这并不是很可靠的，Context支持跨组件的访问，但是如果中间的子组件通过一些方法不影响更新，比如 shouldComponentUpdate() 返回false 那么不能保证Context的更新一定可以使用Context的子组件，因此，Context的可靠性需要关注。</p>
<p>其他的解决方案可以使用</p>
<ol>
<li>mobx</li>
<li>useContext + useReducer</li>
</ol>
<h3 id="react-router底层实现原理" tabindex="-1"><a class="header-anchor" href="#react-router底层实现原理"><span>react-router底层实现原理</span></a></h3>
<p>顶层Router订阅history，history变化时，Router调用setState将location向下传递，并设置到RouterContext。Route组件匹配context中的location决定是否显示。Switch选择最先匹配到的显示，利用props children。Link组件阻止a标签默认事件，并调用history.push。NavLink通过匹配context中的location决定是否为active状态。Redirect组件匹配context里的location决定是否调用history.push(to)，Switch组件会匹配location和from决定是否发起Redirect。</p>
<h3 id="react为什么是单向数据流-react有什么特性" tabindex="-1"><a class="header-anchor" href="#react为什么是单向数据流-react有什么特性"><span>react为什么是单向数据流，react有什么特性</span></a></h3>
<p>单向数据流就是：数据在某个节点被改动后，只会影响一个方向上的其他节点。数据只会影响到下一个层级的节点，不会影响上一个层级的节点。</p>
<p>在react中Props 为只读的，而不是可更改的。这也就是数据更新不能直接通过 this.state 操作，想要更新，就需要通过 React 提供的专门的 this.setState() 方法来做。</p>
<p>单向数据流其实就是一种框架本身对数据流向的限制。保证数据的可控性。</p>
<h3 id="react使用的是jsx-模板的好处是什么" tabindex="-1"><a class="header-anchor" href="#react使用的是jsx-模板的好处是什么"><span>react使用的是jsx,模板的好处是什么？</span></a></h3>
<p>JSX 是 JavaScript 的一种扩展，为函数调用和对象构造提供了语法糖，特别是 React.createElement()。JSX 看起来可能更像是模板引擎或 HTML，但它不是。JSX 生成 React 元素，同时允许你充分利用 JavaScript 的全部功能。</p>
<p>JSX 是编写 React 组件的极好方法，有以下优点：</p>
<p>改进的开发人员体验：代码更易读，因为它们更加形象，感谢类 XML 语法，从而可以更好地表示嵌套的声明式结构。
更具生产力的团队成员：非正式开发人员可以更容易地修改代码，因为 JSX 看起来像HTML，这正是他们所熟悉的。
更少的语法错误：开发人员需要敲入的代码量变得更少，这意味着他们犯错的概率降低了，能够减少重复性伤害。</p>
<h3 id="antd常用的组件" tabindex="-1"><a class="header-anchor" href="#antd常用的组件"><span>antd常用的组件</span></a></h3>
<ul>
<li>常用组件有：Table、Form、Grid、Button、Menu、Upload、DatePicker、Pagination等。</li>
</ul>
<h3 id="antd弹出层的原理" tabindex="-1"><a class="header-anchor" href="#antd弹出层的原理"><span>antd弹出层的原理</span></a></h3>
<ul>
<li>弹出层组件使用了 ReactDOM.createPortal(child, container) 来实现的。</li>
<li>React Portal 提供了一种将子节点渲染到存在于父组件以外的 DOM 节点的优秀的方案。</li>
</ul>
<h3 id="类组件和函数组件的区别" tabindex="-1"><a class="header-anchor" href="#类组件和函数组件的区别"><span>类组件和函数组件的区别</span></a></h3>
<ol>
<li>函数组件看似只是一个返回值是DOM结构的函数，其实它的背后是无状态组件（Stateless Components）的思想。函数组件中，你无法使用State，也无法使用组件的生命周期方法，这就决定了函数组件都是展示性组件（Presentational Components），接收Props，渲染DOM，而不关注其他逻辑。</li>
<li>函数组件中没有this。所以你再也不需要考虑this带来的烦恼。而在类组件中，你依然要记得绑定this这个琐碎的事情。如示例中的sayHi。</li>
<li>函数组件更容易理解。当你看到一个函数组件时，你就知道它的功能只是接收属性，渲染页面，它不执行与UI无关的逻辑处理，它只是一个纯函数。而不用在意它返回的DOM结构有多复杂。</li>
<li>性能。目前React还是会把函数组件在内部转换成类组件，所以使用函数组件和使用类组件在性能上并无大的差异。但是，React官方已承诺，未来将会优化函数组件的性能，因为函数组件不需要考虑组件状态和组件生命周期方法中的各种比较校验，所以有很大的性能提升空间。</li>
<li>函数组件迫使你思考最佳实践。这是最重要的一点。组件的主要职责是UI渲染，理想情况下，所有的组件都是展示性组件，每个页面都是由这些展示性组件组合而成。如果一个组件是函数组件，那么它当然满足这个要求。所以牢记函数组件的概念，可以让你在写组件时，先思考这个组件应不应该是展示性组件。更多的展示性组件意味着更多的组件有更简洁的结构，更多的组件能被更好的复用。</li>
</ol>
<p>在React组件复用与组合 中我们会提到，应当避免在底层的展示性组件中混入对于状态的管理，而应该将状态托管于某个高阶组件或者其他的状态容器中。利用函数式声明组件可以彻底保证不会在组件中进行状态操作。</p>
<h3 id="双向数据绑定和单向数据流的优缺点-1" tabindex="-1"><a class="header-anchor" href="#双向数据绑定和单向数据流的优缺点-1"><span>双向数据绑定和单向数据流的优缺点</span></a></h3>
<ol>
<li>单向数据流 数据流动方向可以跟踪，流动单一，追查问题的时候可以跟快捷。缺点就是写起来不太方便。要使UI发生变更就必须创建各种action来维护对应的state</li>
<li>单向数据流其实是没有状态的, 这使得单向绑定能够避免状态管理在复杂度上升时产生的各种问题, 程序的调试会变得相对容易, 但强制要求编码时设计思维的一致性。</li>
<li>双向流动值和UI双绑定，这种好处大家都懂。但是由于各种数据相互依赖相互绑定，导致数据问题的源头难以被跟踪到，子组件修改父组件，兄弟组件互相修改有有违设计原则。 但好处就是 太方便使用了。</li>
<li>双向数据流是自动管理状态的, 但是在实际应用中会有很多不得不手动处理状态变化的逻辑, 使得程序复杂度上升, 难以调试, 但程序各个部分自成一体, 不强制要求一致的编码。
如果你的程序需要一个统一的数据源, 应该选择单向数据流, 所有的数据变化都是可观测的, 数据自上而下流动, 即使出问题也很容易找到源头.</li>
<li>如果你的程序本身有多个数据源, 或者是程序的逻辑本身会产生很多的副作用, 应该选择双向绑定的程序, 将大项目分化为小项目, 逐个击破。</li>
<li>单向绑定使得数据流也是单向的，对于复杂应用来说这是实施统一的状态管理（如redux）的前提。
双向绑定在一些需要实时反应用户输入的场合会非常方便（比如多级联动菜单）。但通常认为复杂应用中这种便利比不上引入状态管理带来的优势。</li>
</ol>
<h3 id="setstate是同步还是异步" tabindex="-1"><a class="header-anchor" href="#setstate是同步还是异步"><span>setState是同步还是异步</span></a></h3>
<ol>
<li>在 React 的 setState 函数实现中，会根据一个变量 isBatchingUpdates 判断是直接更新 this.state 还是放到一个updateQueue中延时更新，而 isBatchingUpdates 默认是 false，表示 setState 会同步更新 this.state；但是，有一个函数 batchedUpdates，该函数会把 isBatchingUpdates 修改为 true，而当 React 在调用事件处理函数之前就会先调用这个 batchedUpdates将isBatchingUpdates修改为true，这样由 React 控制的事件处理过程 setState 不会同步更新 this.state，而是异步的。</li>
<li>所以说setstate本身是同步的，一旦走了react内部的合并逻辑，放入了updateQueue队列中就变成异步了，而代码中的函数是react控制的，内部会走合并逻辑，所以这里的setState 不但是合并的也是异步的</li>
<li>上面说了，setState是异步的原因是因为走了react内部的合并逻辑，那只要能绕过react内部的合并逻辑，不让它进入到updateQueue中不就变成同步了吗？因为setState()本身就是同步的</li>
<li>利用setTimeout绕过react内部的合并逻辑</li>
<li>异步的情况：
由React控制的事件处理函数，以及生命周期函数调用setState时表现为异步 。大部分开发中用到的都是React封装的事件，比如onChange、onClick、onTouchMove等（合成事件中），这些事件处理函数中的setState都是异步处理的。</li>
</ol>
<p>同步的情况：
React控制之外的事件中调用setState是同步更新的。比如原生js绑定的事件，setTimeout/setInterval，ajax，promise.then内等 React 无法掌控的 APIs情况下，setState是同步更新state的</p>
<h3 id="redux和context-hooks优缺点" tabindex="-1"><a class="header-anchor" href="#redux和context-hooks优缺点"><span>redux和context+hooks优缺点</span></a></h3>
<ul>
<li>数据流对比</li>
</ul>
<p>redux</p>
<p><img src="@source/guide/interview/1.png" alt="alt text"></p>
<p>hooks</p>
<p><img src="@source/guide/interview/2.png" alt="alt text"></p>
<ul>
<li>
<p>简单分析
redux 的数据流程图画得比较简单，理解大概意思就好，毕竟它不是我要说的重点，和 hooks 的数据流程相比其实是大同小异。</p>
...
hooks 还没有 middleware 的解决方案</p>
</li>
</ul>
<h3 id="react的生命周期" tabindex="-1"><a class="header-anchor" href="#react的生命周期"><span>react的生命周期</span></a></h3>
<ul>
<li>react旧版生命周期包含三个过程</li>
</ul>
<p><img src="@source/guide/interview/3.png" alt="alt text"></p>
<p>1、挂载过程
constructor()
componentWillMount()
componentDidMount()</p>
...
1、constructor()
完成了React数据的初始化。</p>
<p>2、componentWillMount()
组件已经完成初始化数据，但是还未渲染DOM时执行的逻辑，主要用于服务端渲染。</p>
<p>3、componentDidMount()
组件第一次渲染完成时执行的逻辑，此时DOM节点已经生成了。</p>
<p>4、componentWillReceiveProps(nextProps)
接收父组件新的props时，重新渲染组件执行的逻辑。</p>
<p>5、shouldComponentUpdate(nextProps, nextState)
在setState以后，state发生变化，组件会进入重新渲染的流程时执行的逻辑。在这个生命周期中return false可以阻止组件的更新，主要用于性能优化。</p>
<p>6、componentWillUpdate(nextProps, nextState)
shouldComponentUpdate返回true以后，组件进入重新渲染的流程时执行的逻辑。</p>
<p>7、render()
页面渲染执行的逻辑，render函数把jsx编译为函数并生成虚拟dom，然后通过其diff算法比较更新前后的新旧DOM树，并渲染更改后的节点。</p>
<p>8、componentDidUpdate(prevProps, prevState)
重新渲染后执行的逻辑。</p>
<p>9、componentWillUnmount()
组件的卸载前执行的逻辑，比如进行“清除组件中所有的setTimeout、setInterval等计时器”或“移除所有组件中的监听器removeEventListener”等操作。</p>
<ul>
<li>react新版生命周期
<img src="@source/guide/interview/4.png" alt="alt text"></li>
</ul>
<p>react16.4后使用了新的生命周期，使用getDerivedStateFromProps代替了旧的componentWillReceiveProps及componentWillMount。使用getSnapshotBeforeUpdate代替了旧的componentWillUpdate。</p>
<p>使用getDerivedStateFromProps(nextProps, prevState)的原因：
旧的React中componentWillReceiveProps方法是用来判断前后两个 props 是否相同，如果不同，则将新的 props 更新到相应的 state 上去。在这个过程中我们实际上是可以访问到当前props的，这样我们可能会对this.props做一些奇奇怪怪的操作，很可能会破坏 state 数据的单一数据源，导致组件状态变得不可预测。</p>
...
<p>使用getSnapshotBeforeUpdate(prevProps, prevState)的原因：
在 React 开启异步渲染模式后，在执行函数时读到的 DOM 元素状态并不总是渲染时相同，这就导致在 componentDidUpdate 中使用 componentWillUpdate 中读取到的 DOM 元素状态是不安全的，因为这时的值很有可能已经失效了。</p>
<p>而getSnapshotBeforeUpdate 会在最终的 render 之前被调用，也就是说在 getSnapshotBeforeUpdate 中读取到的 DOM 元素状态是可以保证与componentDidUpdate 中一致的。</p>
<h3 id="react-redux中有个context使用过吗-用来干什么的" tabindex="-1"><a class="header-anchor" href="#react-redux中有个context使用过吗-用来干什么的"><span>React-redux中有个Context使用过吗？用来干什么的</span></a></h3>
<p>这里再次提及下Redux的Store上的3个api，</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  store<span class="token punctuation">.</span><span class="token function">getState</span><span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token comment">// 获得 store 上存储的所有状态</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>虽然 Redux 应用全局就一个 Store 这样的直接导入依然有问题，因为在组件中直接导人 Store 是非常不利于组件复用的 。</p>
...
<h3 id="redux-thunk是干什么的-为什么要用这个-具体怎么实现" tabindex="-1"><a class="header-anchor" href="#redux-thunk是干什么的-为什么要用这个-具体怎么实现"><span>redux-thunk是干什么的，为什么要用这个？具体怎么实现</span></a></h3>
<ol>
<li>
<p>什么是thunk？</p>
<p>thunk可以理解为函数的另一种称呼，但不是以前我们说的简单函数。Thunk代表的是一个被其他函数返回的函数。</p>
</li>
<li>
<p>那么它是怎么作用在redux上的呢？
Redux中有几个概念：”actions”，”action creators”，”reducer”，“middleware”</p>
</li>
</ol>
<p>Actions就是普通对象，并且一定有一个type属性，除了这个，你可以在对象中自定义你想要描述该action的数据。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">// 1. plain object</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每次都要手写action对象会很麻烦，redux有一个“action creators”的概念来简化。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">userLoggedIn</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">  <span class="token keyword">return</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token literal-property property">type</span><span class="token operator">:</span> <span class="token string">'USER_LOGGED_IN'</span><span class="token punctuation">,</span></span>
<span class="line">    <span class="token literal-property property">username</span><span class="token operator">:</span> <span class="token string">'dave'</span></span>
<span class="line">  <span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>你可以通过调用userLoggedIn函数来生成这个action，如果你在app中多次dispatch同样的action，使用action creators会大大简化工作。</p>
<ol>
<li>Action可以做点什么吗？
Action虽然叫action，但其实什么都不做，只是对象而已。它们可以自己做点什么吗？比如像调用api或是触发其他actions？
因为reducer必须是纯函数，我们不能在reducer里调用api或是触发其他actions。</li>
</ol>
<p>如果我们希望action做些什么，就要把代码放进一个函数中去，这个函数就是thunk。</p>
<p>Action creators返回一个函数而不是一个action对象。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">getUser</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li>那么怎么让Redux处理actions是函数的情况呢？
我们就引入了redux-thunk，它是一个中间件，每次action都会经历它，如果action是一个函数，就调用这个函数，这就是redux-thunk做的事。</li>
</ol>
<p>传递给thunk函数的就是两个参数：</p>
<ul>
<li>
<p>Dispatch，如果它们需要，可以dispatch新的action。</p>
</li>
<li>
<p>getState，它们可以获取最新的state。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">logOutUser</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<ol>
<li>如何使用redux-thunk</li>
</ol>
<ul>
<li>安装redux-thunk包
npm install --save redux-thunk</li>
<li>导入redux-thunk并插入redux</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token keyword">import</span> <span class="token punctuation">{</span> createStore<span class="token punctuation">,</span> applyMiddleware <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'redux'</span><span class="token punctuation">;</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="怎么用-react-redux-解决数据发生改变就会刷新页面这个问题" tabindex="-1"><a class="header-anchor" href="#怎么用-react-redux-解决数据发生改变就会刷新页面这个问题"><span>怎么用 React-redux 解决数据发生改变就会刷新页面这个问题</span></a></h3>
<p>通常情况下，store 状态数据发生改变，会刷新页面这个问题是由于设计导致的，可能是组件定义时的问题。建议不要将页面中使用的组件都包装到一个大的容器组件中（如图1所示），而是将各相关的组件包装到一个较小的容器组件中（如图2所示）:</p>
<p><strong>图1</strong>																											<strong>图2</strong></p>
<p><img src="@source/guide/interview/VBtL8.png" alt="VBtL8" style="zoom:28%;" /><img src="@source/guide/interview/GvUOL.png" alt="GvUOL" style="zoom:28%;" /></p>
<p>图1中，当容器组件中订阅的 store 发生变化时，所有组件都会重新渲染。在图2中，由于将相关组件包装到了较小的容器组件中，当 container2 容器中订阅的 store 发生变化时，仅相关的组件重新渲染，其它组件不会导致重新渲染。</p>
<h3 id="一般什么时候使用redux" tabindex="-1"><a class="header-anchor" href="#一般什么时候使用redux"><span>一般什么时候使用redux</span></a></h3>
<p>在遇到如下情况时，可以考虑使用 redux：</p>
<ul>
<li>某个状态需要在全局使用或共享（例如角色权限等信息）</li>
<li>state并不总是以单向的方式线性流动</li>
<li>UI 可以根据应用程序状态显著变化</li>
<li>许多不相关的组件以相同的方式更新状态</li>
<li>状态树结构复杂</li>
</ul>
<h3 id="redux有什么优缺点" tabindex="-1"><a class="header-anchor" href="#redux有什么优缺点"><span>redux有什么优缺点</span></a></h3>
<p>优点：</p>
<ul>
<li>纯粹，清晰易懂，让状态可预测，方便测试</li>
</ul>
<p>缺点：</p>
<ul>
<li>繁琐，要写大量的 action creator、reducer，所以即便想进行一个小的状态变化也会需要更改好几个地方</li>
<li>需要写大量 <code v-pre>switch case</code> 分支判断，造成不小的负担</li>
<li>状态是存在于顶层的一棵树，通过 connect 和组件连在一起，单个组件是无法独立工作的。</li>
<li>对于各种异步的副作用，redux 本身是无能为力的，需要使用中间件</li>
</ul>
<h3 id="类组件有状态-为什么还要用-redux" tabindex="-1"><a class="header-anchor" href="#类组件有状态-为什么还要用-redux"><span>类组件有状态,为什么还要用 redux</span></a></h3>
<p>类组件有 state，但 React 推荐组件间传递数据使用 props 自上而下流动，如果涉及到跨组件层级的通信，涉及到全局组件状态数据的共享及更新等，在各组件中都添加 props 来传递数据会显得非常繁琐，利用 redux 可以简化状态更新的繁琐度，提供统一的状态更新方式，使得状态更新可预测，也方便调试与维护。</p>
<h3 id="shouldcomponentupdate-的作用" tabindex="-1"><a class="header-anchor" href="#shouldcomponentupdate-的作用"><span>shouldComponentUpdate 的作用</span></a></h3>
<p>此方法仅作为<strong>性能优化的方式</strong>而存在，根据 <code v-pre>shouldComponentUpdate()</code> 的返回值，判断 React 组件的输出是否受当前 state 或 props 更改的影响，返回 <code v-pre>false</code> 以告知 React 可以跳过更新。</p>
<p>示例：</p>
<img src="@source/guide/interview/should-component-update.png" alt="should-component-update" style="zoom:80%;" />
<p>这是一个组件的子树。每个节点中，<code v-pre>SCU</code> 代表 <code v-pre>shouldComponentUpdate</code> 返回的值，而 <code v-pre>vDOMEq</code> 代表返回的 React 元素是否相同。最后，圆圈的颜色代表了该组件是否需要被调停。</p>
<p>节点 C2 的 <code v-pre>shouldComponentUpdate</code> 返回了 <code v-pre>false</code>，React 因而不会去渲染 C2，也因此 C4 和 C5 的 <code v-pre>shouldComponentUpdate</code> 不会被调用到。</p>
<p>对于 C1 和 C3，<code v-pre>shouldComponentUpdate</code> 返回了 <code v-pre>true</code>，所以 React 需要继续向下查询子节点。这里 C6 的 <code v-pre>shouldComponentUpdate</code> 返回了 <code v-pre>true</code>，同时由于渲染的元素与之前的不同使得 React 更新了该 DOM。</p>
<p>最后一个有趣的例子是 C8。React 需要渲染这个组件，但是由于其返回的 React 元素和之前渲染的相同，所以不需要更新 DOM。</p>
<p>显而易见，你看到 React 只改变了 C6 的 DOM。对于 C8，通过对比了渲染的 React 元素跳过了渲染。而对于 C2 的子节点和 C7，由于 <code v-pre>shouldComponentUpdate</code> 使得 <code v-pre>render</code> 并没有被调用。因此它们也不需要对比元素了。</p>
<h3 id="react-中-ref-的作用" tabindex="-1"><a class="header-anchor" href="#react-中-ref-的作用"><span>react 中 ref 的作用</span></a></h3>
<p>ref 是 React 提供的用来操纵 React 组件实例或者操作 DOM 元素的技术。</p>
<p>适合使用 ref 的几种情况：</p>
<ul>
...
<p>示例1：</p>
<div class="language-jsx line-numbers-mode" data-highlighter="prismjs" data-ext="jsx" data-title="jsx"><pre v-pre><code><span class="line"><span class="token keyword">class</span> <span class="token class-name">CustomTextInput</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个例子是为 DOM 元素添加 <code v-pre>ref</code>，使用 <code v-pre>ref</code> 去存储 DOM 节点的引用，React 会在组件挂载时给 <code v-pre>ref</code> 对象的 <code v-pre>current</code> 属性传入 DOM 元素，并在组件卸载时传入 <code v-pre>null</code> 值。<code v-pre>ref</code> 会在 <code v-pre>componentDidMount</code> 或 <code v-pre>componentDidUpdate</code> 生命周期钩子触发前更新。</p>
<p>示例2：</p>
<div class="language-jsx line-numbers-mode" data-highlighter="prismjs" data-ext="jsx" data-title="jsx"><pre v-pre><code><span class="line"><span class="token keyword">class</span> <span class="token class-name">AutoFocusTextInput</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span> <span class="token punctuation">{</span></span>
<span class="line">  <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token parameter">props</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">super</span><span class="token punctuation">(</span>props<span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line">    <span class="token keyword">this</span><span class="token punctuation">.</span>textInput <span class="token operator">=</span> React<span class="token punctuation">.</span><span class="token function">createRef</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line">  <span class="token punctuation">}</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个示例是包装上面的 <code v-pre>CustomTextInput</code>，来模拟它挂载之后立即被点击的操作，我们可以使用 ref 来获取这个自定义的 input 组件并手动调用它的 <code v-pre>focusTextInput</code> 方法。</p>
<h3 id="解释-redux-的工作流程" tabindex="-1"><a class="header-anchor" href="#解释-redux-的工作流程"><span>解释 redux 的工作流程</span></a></h3>
<p>Redux工作流程：</p>
<ol>
<li>在 View 中派发 action（dispatch(action)）</li>
<li>store 接收到派发的 action 对象</li>
<li>在 store 中，调用 reducer()，并传递之前的 state 与 action 作为参数</li>
<li>在 reducer 中按照 action.type 判断，运算并返回新的 state 给 store</li>
<li>store 中更新最新的 state</li>
<li>执行由 subscribe() 注册的监听任务（这些任务订阅了 store 的变化）</li>
</ol>
<h3 id="redux-数据流向-比如点击按钮到状态修改-数据如何流向的" tabindex="-1"><a class="header-anchor" href="#redux-数据流向-比如点击按钮到状态修改-数据如何流向的"><span>redux 数据流向，比如点击按钮到状态修改，数据如何流向的</span></a></h3>
<img src="@source/guide/interview/ReduxDataFlowDiagram.gif" alt="ReduxDataFlowDiagram" style="zoom:30%;" />
<p>由上图我们可以看到，redux 数据流向大致步骤（以按钮点击修改状态为例）：</p>
<ol>
<li>UI 首次呈现时，访问 redux 存储的当前状态 state，并使用该数据来决定初始呈现内容：显示提现 <code v-pre>$0</code> 元。</li>
<li>在视图中触发点击事件：提现</li>
<li>事件处理程序中，触发 action 并传递给 store：dispatch(action)</li>
<li>store 使用前一个 <code v-pre>state</code> 和接收到的 action 经 reducer 函数处理，并将返回值保存为新的 <code v-pre>state</code></li>
<li>UI 根据新状态重新呈现</li>
</ol>
<h3 id="说一下-redux-的使用流程-dispash-是从哪里解构出来的" tabindex="-1"><a class="header-anchor" href="#说一下-redux-的使用流程-dispash-是从哪里解构出来的"><span>说一下 redux 的使用流程，dispash 是从哪里解构出来的</span></a></h3>
<p>redux 使用流程:</p>
<ol>
<li>创建 reducer() 纯函数，用于同步更新状态</li>
<li>将各独立的 reducer 合并为一个完整的根 reducer</li>
<li>创建 action creator 函数，用于生成 action 对象</li>
<li>基于根 reducer 创建 store，如果有异步更新状态数据操作，应用中间件（如 redux-thunk）</li>
<li>订阅 store 中的状态变化</li>
<li>在 UI 中根据 store 的状态初始渲染</li>
<li>在 UI 中触发 action 到 store 中更新状态</li>
</ol>
<p>如果我们要在 View 中实现 store 中的状态更新，则需要 dispatch(action)，这个 <code v-pre>dispatch()</code> 方法是从创建的 store 中解构出来的，在 store 中除了 dispatch 外，还可以解构诸如 getState、subscribe 等属性。</p>
<h3 id="react性能为什么强于vue" tabindex="-1"><a class="header-anchor" href="#react性能为什么强于vue"><span>React性能为什么强于vue</span></a></h3>
<p>对于框架之间我们并不是特别在意谁强谁弱, 而是要搞清楚框架真正值得我们学习的点:</p>
<p>像React框架, 它在 <strong>架构上融合了数据驱动视图、组件化、函数式编程、面向对象、Fiber</strong> 等经典设计“哲学”，		在底层技术选型上涉及了 <strong>JSX、虚拟 DOM</strong>等经典解决方案，在周边生态上至少涵盖了状态管理和前端路由两		大领域的最佳实践。此外，它还自建了状态管理机制与事件系统，创造性地在前端框架中引入了 Hooks 思		想...... <strong>React 十年如一日的稳定输出背后，有太多值得我们去吸收和借鉴的东西</strong>.</p>
<ol>
<li>npm源码包大小, react 291kb, vue 2.97mb 更小的源码包, 更少的cpu消耗.</li>
<li>基于虚拟DOM, 减少重绘次数(将多次数据操作汇集成一次<code v-pre>DOM</code>更新); 减少手动操作<code v-pre>DOM</code>操作(不用再像以前写<code v-pre>jQuery</code>那样，先获取<code v-pre>DOM</code>元素，再设置属性)</li>
<li>Fiber算法, React16提出了Fiber架构，其能够将任务分片，划分优先级，同时能够实现类似于操作系统中对线程的抢占式调度，非常强大, 对于因为JavaScript的单线程特性，单个同步任务耗时太长，出现卡顿的问题就可以得到解决, 这进一步弥补了React在组件更新机制方面的缺陷.</li>
<li>Hooks, 创造性地在前端框架中引入了 Hooks , 这使得程序员有了除class component以外的界面构建方式, Hooks让复用代码这件事变得更容易, 结合函数式组件整体风格更清爽，更优雅, 更少的代码量, 这也使得项目更容易阅读和维护.</li>
<li>结合shouldComponentUpdate等方法, 可以避免不必要的组件更新, 实现更少的cpu消耗, 程序员可以从代码的角度介入到组件更新效率的控制过程中.</li>
</ol>
<h3 id="vue-router和react-router的区别" tabindex="-1"><a class="header-anchor" href="#vue-router和react-router的区别"><span>vue-router和react-router的区别</span></a></h3>
<ul>
<li>路由配置语法的差异
<ul>
<li>vue-router是全局配置方式，react-router是全局组件方式。</li>
<li>vue-router仅支持对象形式的配置，react-router支持对象形式和JSX语法的组件形式配置。</li>
<li>vue-router任何路由组件都会被渲染到<router-view/>位置，react-router子组件作为children被传入父组件，而根组件被渲染到Router位置。</li>
</ul>
</li>
<li>使用方式上的不同
<ul>
<li>vue-router通过路由配置表 + router-link, router-view控制路由.</li>
<li>react-router通过Link,NavLink, Route,Switch,Redirect等路由组件控制路由,</li>
</ul>
</li>
<li>获取参数的方式不同
<ul>
<li>vue-router借助this.$router获取全局路由的实例,this.$route获取当前路由信息</li>
<li>react-router借助this.props.location,  this.props.match获取路由参数</li>
</ul>
</li>
</ul>
<h2 id="三、小程序" tabindex="-1"><a class="header-anchor" href="#三、小程序"><span>三、小程序</span></a></h2>
<h3 id="简单谈谈微信小程序" tabindex="-1"><a class="header-anchor" href="#简单谈谈微信小程序"><span>简单谈谈微信小程序</span></a></h3>
<p><strong>在结构和样式方面</strong>，小程序提供了一些常用的标签与控件，比如：</p>
...
<p>配置文件app.json平级的还有一个app.js文件，是小程序的脚本代码。我们可以在这个文件中监听并处理小程序的生命周期函数、声明全局变量，在每个page目录里的js做当前页面的业务操作。但是小程序的页面的脚本逻辑是在JsCore中运行，JsCore是一个没有窗口对象的环境，所以不能在脚本中使用window，也无法在脚本中操作组件，所以我们常用的zepto/jquery 等类库也是无法使用的。</p>
<p>另一个app.wxss文件，这个是全局的样式，所有的页面都会调用到，每个项目目录下面的wxss是局部样式文件，不会和其他目录产生污染，可以放心使用样式名。</p>
<p>他提供的WXSS(WeiXin Style Sheets)是一套样式语言，具有 CSS 大部分特性，可以看作一套简化版的css。
同时为了更适合开发微信小程序，还对 CSS 进行了扩充以及修改，直接帮我们把适配的一部分工作都做了，比如他的rpx（responsive pixel），可以根据屏幕宽度进行自适应，规定屏幕宽为750rpx。如在 iPhone6 上，屏幕宽度为375px，共有750个物理像素，则750rpx = 375px = 750物理像素，1rpx = 0.5px = 1物理像素。</p>
<p>在调用微信生态系统功能时，微信小程序提供了相应的api，比如你要修改一个头像，可以使用wx.chooseImage等</p>
<h3 id="小程序的原生组件有哪些" tabindex="-1"><a class="header-anchor" href="#小程序的原生组件有哪些"><span>小程序的原生组件有哪些</span></a></h3>
<p>以微信小程序为例，可以分成容器组件、基础组件、表单组件、媒体组件、开放能力组件等</p>
<h3 id="小程序的安卓版和ios版是怎么开发出来" tabindex="-1"><a class="header-anchor" href="#小程序的安卓版和ios版是怎么开发出来"><span>小程序的安卓版和ios版是怎么开发出来</span></a></h3>
<p>小程序开发基于html、css、javascript，与web开发一样具有跨平台特性，一次开发即可在安卓和iOS等平台访问，但与普通web开发不同，小程序运行环境并不是浏览器，而是依附于各自的软件App，如微信小程序必须在微信中访问，支付宝小程序必须在支付宝中访问等，小程序的开发流程也有所不同，需要经过申请小程序帐号、安装小程序开发者工具、配置项目、开发、调试、上线发布等过程方可完成</p>
<h3 id="uni-app弹窗被覆盖怎么解决" tabindex="-1"><a class="header-anchor" href="#uni-app弹窗被覆盖怎么解决"><span>uni-app弹窗被覆盖怎么解决</span></a></h3>
<p>如果弹窗被别的内容覆盖，且设置很大的z-index也无法解决，这种情况多半是被一些如<code v-pre>map</code>、<code v-pre>video</code>、<code v-pre>textarea</code>、<code v-pre>canvas</code>等原生组件遮盖，因为原生组件层级高于前端组件，我们可以使用<code v-pre>cover-view</code>组件解决</p>
<h3 id="小程序生命周期" tabindex="-1"><a class="header-anchor" href="#小程序生命周期"><span>小程序生命周期</span></a></h3>
<p>onReady		生命周期函数--监听页面初次渲染完成</p>
<p>onShow		生命周期函数--监听页面显示</p>
<p>onHide		生命周期函数--监听页面隐藏</p>
<p>onUnload		生命周期函数--监听页面卸载</p>
<p>onPullDownRefresh		页面相关事件处理函数--监听用户下拉动作</p>
<p>onReachBottom		页面上拉触底事件的处理函数</p>
<p>onShareAppMessage		用户点击右上角转发</p>
<p>onPageScroll 		页面滚动触发事件的处理函数</p>
<p>onTabItemTap   当前是 tab 页时，点击 tab 时触发</p>
<h3 id="小程序路由跳转" tabindex="-1"><a class="header-anchor" href="#小程序路由跳转"><span>小程序路由跳转</span></a></h3>
<ol>
<li>
<p>通过组件navigator跳转，设置url属性指定跳转的路径，设置open-type属性指定跳转的类型（可选），open-type的属性有 redirect, switchTab, navigateBack</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">// redirect 对应 API 中的 wx.redirect 方法</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>通过api跳转，wx.navigateTo() ,  wx.navigateBack(),  wx.redirectTo() , wx.switchTab(), wx.reLanch()</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">wx.navigateTo({</span>
...
<h3 id="小程序的兼容问题有哪些" tabindex="-1"><a class="header-anchor" href="#小程序的兼容问题有哪些"><span>小程序的兼容问题有哪些</span></a></h3>
<p>遇到的如下：</p>
<ul>
<li>1，ios下的zIndex层级问题，主要发生在iphone7和iphoneX下 绝对定位必须有一个共同的父元素。</li>
<li>2，左右边框不生效 当边框的宽度设置为奇数的时候，可能会不生效 解决方法：将宽度设置为偶数的时候，在ios下就可以解决</li>
<li>3，还有尽量不要用margin-bottom ，当元素是在整个页面的最底部的时候，在ios下可能margin-bottom会失效，所以建议，都使用padding-bottom</li>
</ul>
<p><strong>new Date跨平台兼容性问题</strong></p>
<p>在Andriod使用new Date(“2018-05-30 00:00:00”)木有问题，但是在ios下面识别不出来。</p>
<p>因为IOS下面不能识别这种格式，需要用2018/05/30 00:00:00格式。可以使用正则表达式对做字符串替换，将短横替换为斜杠。var iosDate= date.replace(/-/g, '/');。</p>
<p><strong>wx.getUserInfo()接口更改问题</strong></p>
<p>微信小程序最近被吐槽最多的一个更改，就是用户使用wx.getUserInfo（开发和体验版）时不会弹出授权，正式版不受影响。现在授权方式是需要引导用户点击一个授权按钮，然后再弹出授权。</p>
<h3 id="小程序框架都掌握哪一些-uniapp都会哪一些-平时开发遇到的困难" tabindex="-1"><a class="header-anchor" href="#小程序框架都掌握哪一些-uniapp都会哪一些-平时开发遇到的困难"><span>小程序框架都掌握哪一些，uniapp都会哪一些，平时开发遇到的困难</span></a></h3>
<ul>
<li>Taro</li>
<li>uni-app</li>
<li>WeUI</li>
...
<p>开发uni-app遇到的坑</p>
<h4 id="上传图片" tabindex="-1"><a class="header-anchor" href="#上传图片"><span>上传图片</span></a></h4>
<blockquote>
<p>小程序时必须要写<a href="https://so.csdn.net/so/search?q=header" target="_blank" rel="noopener noreferrer">header</a>:{“Content-Type”: “multipart/form-data”}, h5是必须省略</p>
</blockquote>
<h4 id="uni-app-h5-端的ios图片不能加载问题" tabindex="-1"><a class="header-anchor" href="#uni-app-h5-端的ios图片不能加载问题"><span>uni-app h5 端的ios图片不能加载问题</span></a></h4>
<blockquote>
<p>uni-app h5端 ios只能加载https的图片</p>
</blockquote>
<h4 id="uni-app-使用deep-穿透微信小程序生效-h5无作用" tabindex="-1"><a class="header-anchor" href="#uni-app-使用deep-穿透微信小程序生效-h5无作用"><span>uni-app 使用deep 穿透微信小程序生效 h5无作用</span></a></h4>
<blockquote>
<p>需要在methods同级下加一个 ：
options: { styleIsolation: ‘shared’ },</p>
</blockquote>
<h4 id="uni-app-post请求如何传递数组-参数" tabindex="-1"><a class="header-anchor" href="#uni-app-post请求如何传递数组-参数"><span>uni-app post请求如何传递数组 参数</span></a></h4>
<blockquote>
<p>在开发中我们接口上传图片是post请求 无法传递一个数组 解决方法如下</p>
<p>我们可以把数据转换成字符串 然后拼接到请求地址后后面
拼接字符串格式：image[]=arr[0]&amp;image[]=arr[1]</p>
</blockquote>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">imgURlClick(imgArr){</span>
<span class="line">  return '?images[]='+imgArr.join('&amp;images[]=')</span>
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="小程序怎么获取手机号" tabindex="-1"><a class="header-anchor" href="#小程序怎么获取手机号"><span>小程序怎么获取手机号</span></a></h3>
<ol>
<li>
<p>准备一个button组件, 将 <a href="https://developers.weixin.qq.com/miniprogram/dev/component/button.html" target="_blank" rel="noopener noreferrer">button</a> 组件 <code v-pre>open-type</code> 的值设置为 <code v-pre>getPhoneNumber</code>，当用户点击并同意之后，可以通过 <code v-pre>bindgetphonenumber</code> 事件回调获取到动态令牌<code v-pre>code</code>;</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token function">Page</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>接着把<code v-pre>code</code>传到开发者后台，并在开发者后台调用微信后台提供的 <a href="https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/phonenumber/phonenumber.getPhoneNumber.html" target="_blank" rel="noopener noreferrer">phonenumber.getPhoneNumber</a> 接口，消费<code v-pre>code</code>来换取用户手机号。每个<code v-pre>code</code>有效期为5分钟，且只能消费一次。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token function-variable function">getPhoneNumber</span><span class="token operator">:</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"> <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注：<code v-pre>getPhoneNumber</code> 返回的 <code v-pre>code</code> 与 <code v-pre>wx.login</code> 返回的 <code v-pre>code</code> 作用是不一样的，不能混用.</p>
<p>注：从基础库 2.21.2 开始，对获取手机号的接口进行了安全升级, 需要用户主动触发才能发起获取手机号接口，所以该功能不由 API 来调用，需用 <a href="https://developers.weixin.qq.com/miniprogram/dev/component/button.html" target="_blank" rel="noopener noreferrer">button</a> 组件的点击来触发。另外，新版本接口<strong>不再</strong>需要提前调用<code v-pre>wx.login</code>进行登录.</p>
</li>
</ol>
<h3 id="小程序的登录流程" tabindex="-1"><a class="header-anchor" href="#小程序的登录流程"><span>小程序的登录流程</span></a></h3>
<p>登陆流程:</p>
<p><img src="https://res.wx.qq.com/wxdoc/dist/assets/img/api-login.2fcc9f35.jpg" alt="登陆流程"></p>
<ul>
<li>
<p><strong>首次登录</strong></p>
<ul>
<li>
<p>调用小程序api接口 <code v-pre>wx.login()</code> 获取 临时登录凭证code ，这个code是有过期时间的.</p>
</li>
<li>
<p>将这个<code v-pre>code</code>回传到开发者服务器（就是请求开发者服务器的登录接口，通过凭证进而换取用户登录态信息，包括用户的唯一标识（openid）及本次登录的会话密钥（session_key）等）</p>
</li>
<li>
<p>拿到开发者服务器传回来的会话密钥（session_key）之后，前端需要保存起来.</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">wx<span class="token punctuation">.</span><span class="token function">setStorageSync</span><span class="token punctuation">(</span><span class="token string">'sessionKey'</span><span class="token punctuation">,</span> <span class="token string">'value'</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
<li>
<p><strong>再次登录的时候，就要判断存储的session_key是否过期了</strong></p>
<ul>
<li>获取缓存中的session_key，<code v-pre>wx.getStorageSync('sessionKey')</code></li>
<li>如果缓存中存在session_key，那么调用小程序api接口<code v-pre>wx.checkSession()</code>来判断登录态是否过期，回调成功说明当前 session_key 未过期，回调失败说明 session_key 已过期。登录态过期后前端需要再调用 wx.login()获取新的用户的code，然后再向开发者服务器发起登录请求.</li>
<li>一般在项目开发，开发者服务器也会对用户的登录态做过期限制，所以这时在判断完微信服务器中登录态如果没有过期之后还要判断开发者服务器的登录态是否过期。（请求开发者服务器给定的接口进行请求判断就好）</li>
</ul>
<p>参考官网: <a href="https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/login.html" target="_blank" rel="noopener noreferrer">小程序登陆流程</a>  <a href="https://developers.weixin.qq.com/miniprogram/dev/api/open-api/login/wx.checkSession.html" target="_blank" rel="noopener noreferrer">登陆态过期检测</a></p>
</li>
</ul>
<h3 id="小程序如果版本更新了怎么通知用户" tabindex="-1"><a class="header-anchor" href="#小程序如果版本更新了怎么通知用户"><span>小程序如果版本更新了怎么通知用户</span></a></h3>
<p>当小程序发布新的版本后，用户如果之前访问过该小程序，通过已打开的小程序进入（未手动删除），则会弹出提示，提醒用户更新新的版本。用户点击确定就可以自动重启更新，点击取消则关闭弹窗，不再更新.</p>
<ul>
<li>
<p><strong>核心步骤</strong>:</p>
<ul>
<li>
<p>打开小程序, 检查小程序是否有新版本发布</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">updateManager<span class="token punctuation">.</span><span class="token function">onCheckForUpdate</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">res</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>小程序有新版本，则静默下载新版本，做好更新准备</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">updateManager<span class="token punctuation">.</span><span class="token function">onUpdateReady</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>新的版本已经下载好，调用 <code v-pre>applyUpdate </code> 应用新版本并重启小程序</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">updateManager<span class="token punctuation">.</span><span class="token function">applyUpdate</span><span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
<li>
<p><strong>更新版本的模拟测试</strong></p>
<p>微信开发者工具上可以通过「编译模式」下的「下次编译模拟更新」开关来调试.</p>
<p>点击编译模式设置下拉列表，然后点击“添加编译模式”，在自定义编译条件弹窗界面，点击下次编译时模拟更新，然后点击确定，重新编译就可以了.</p>
<p>注: 需要注意的是，这种方式模拟更新一次之后就失效了，后边再测试仍需要对这种编译模式进行重新设置才可以.</p>
</li>
<li>
<p><strong>核心代码如下</strong>:</p>
</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token function">App</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="小程序嵌入h5页面怎么做" tabindex="-1"><a class="header-anchor" href="#小程序嵌入h5页面怎么做"><span>小程序嵌入H5页面怎么做</span></a></h3>
<ul>
<li><strong>解决方式 ：web-view</strong></li>
</ul>
<p>webview 指向网页的链接。可打开关联的公众号的文章，其它网页需登录<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fmp.weixin.qq.com%2F" target="_blank" rel="noopener noreferrer">小程序管理后台</a>配置业务域名。</p>
<ul>
<li>
<p><strong>具体实现步骤:</strong></p>
<ul>
<li>
<p>登陆小程序管理后台, 配置服务器域名(  h5页面所在的域名 )</p>
</li>
<li>
<p>在小程序里面嵌入h5</p>
<ul>
<li>在小程序里面定义一个你想要的H5入口</li>
</ul>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>navigator</span> <span class="token attr-name">url</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/page/navigate/navigate<span class="token punctuation">"</span></span> <span class="token attr-name">hover-class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navigator-hover<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>跳转到新页面<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>navigator</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li>新建一个页面，放置 webview , src指向h5网页的链接.</li>
</ul>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>web-view</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>{{url}}<span class="token punctuation">"</span></span> <span class="token attr-name">bindmessage</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>getMessage<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>web-view</span><span class="token punctuation">></span></span> <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>block</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
<p>注: 实际开发中在h5页面中有可能需要向小程序发送消息, 实现h5页面和小程序页面的通信</p>
<p>需要使用postMessage向小程序发送消息, 在h5中postMessage 注意，<strong>key必须叫做data</strong>,否则取不到.</p>
</li>
</ul>
<h3 id="小程序的生命周期函数有哪些-分别有什么作用" tabindex="-1"><a class="header-anchor" href="#小程序的生命周期函数有哪些-分别有什么作用"><span>小程序的生命周期函数有哪些?分别有什么作用?</span></a></h3>
<blockquote>
<p>小程序的生命周期函数大体分为三类:</p>
</blockquote>
<ul>
<li>
<p><strong>小程序应用的生命周期</strong></p>
<table>
<thead>
<tr>
<th>属性</th>
...
<tbody>
<tr>
<td><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/App.html#onLaunch-Object-object" target="_blank" rel="noopener noreferrer">onLaunch</a></td>
<td>监听小程序初始化, <strong>全局只触发一次</strong></td>
</tr>
<tr>
<td><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/App.html#onShow-Object-object" target="_blank" rel="noopener noreferrer">onShow</a></td>
<td>监听小程序启动或切前台。</td>
</tr>
<tr>
<td><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/App.html#onHide" target="_blank" rel="noopener noreferrer">onHide</a></td>
<td>监听小程序切后台。</td>
</tr>
</tbody>
</table>
<p>参考官网: <a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/App.html" target="_blank" rel="noopener noreferrer">应用的生命周期</a></p>
</li>
<li>
<p><strong>小程序页面的生命周期</strong></p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:left"><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onLoad-Object-query" target="_blank" rel="noopener noreferrer">onLoad</a></td>
<td style="text-align:left">监听页面加载, <strong>获取其他页面传过来的参数, 发起网络请求</strong></td>
</tr>
<tr>
<td style="text-align:left"><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onShow" target="_blank" rel="noopener noreferrer">onShow</a></td>
<td style="text-align:left">监听页面显示</td>
</tr>
<tr>
<td style="text-align:left"><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onReady" target="_blank" rel="noopener noreferrer">onReady</a></td>
<td style="text-align:left">监听页面初次渲染完成</td>
</tr>
<tr>
<td style="text-align:left"><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onHide" target="_blank" rel="noopener noreferrer">onHide</a></td>
<td style="text-align:left">监听页面隐藏</td>
</tr>
<tr>
<td style="text-align:left"><a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html#onUnload" target="_blank" rel="noopener noreferrer">onUnload</a></td>
<td style="text-align:left">监听页面卸载</td>
</tr>
</tbody>
</table>
<p>参考官网: <a href="https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page.html" target="_blank" rel="noopener noreferrer">页面的生命周期</a></p>
</li>
<li>
<p><strong>小程序组件的生命周期</strong></p>
<table>
<thead>
<tr>
...
<td style="text-align:left">在组件实例刚刚被创建时执行，注意此时不能调用 <code v-pre>setData</code> )</td>
</tr>
<tr>
...
<td style="text-align:left">在组件布局完成后执行)</td>
</tr>
<tr>
...
<h2 id="四、webpack" tabindex="-1"><a class="header-anchor" href="#四、webpack"><span>四、webpack</span></a></h2>
<h3 id="webpack了解吗-讲一讲原理-怎么压缩代码" tabindex="-1"><a class="header-anchor" href="#webpack了解吗-讲一讲原理-怎么压缩代码"><span>webpack了解吗，讲一讲原理，怎么压缩代码</span></a></h3>
<ol>
<li>需要读到入口文件里面的内容。</li>
<li>分析入口文件，递归的去读取模块所依赖的文件内容，生成AST语法树。</li>
<li>根据AST语法树，生成浏览器能够运行的代码</li>
</ol>
<h3 id="webpack怎么配置" tabindex="-1"><a class="header-anchor" href="#webpack怎么配置"><span>webpack怎么配置</span></a></h3>
<p>主要配置5个核心文件</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">1. mode：通过选择 `development`, `production` 或 `none` 之中的一个，来设置 `mode` 参数，你可以启用 webpack 内置在相应环境下的优化。</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="webpack怎么打包" tabindex="-1"><a class="header-anchor" href="#webpack怎么打包"><span>webpack怎么打包</span></a></h3>
<p><code v-pre>初始化参数</code>：解析webpack配置参数，合并shell传入和webpack.config.js文件配置的参数,形成最后的配置结果；</p>
<p><code v-pre>开始编译</code>：上一步得到的参数初始化compiler对象，注册所有配置的插件，插件 监听webpack构建生命周期的事件节点，做出相应的反应，执行对象的run方法开始执行编译；</p>
<p><code v-pre>确定入口</code>：从配置的entry入口，开始解析文件构建AST语法树，找出依赖，递归下去；</p>
<p><code v-pre>编译模块</code>：递归中根据文件类型和loader配置，调用所有配置的loader对文件进行转换，再找出该模块依赖的模块，再递归本步骤直到所有入口依赖的文件都经过了本步骤的处理；</p>
<p><code v-pre>完成模块编译并输出</code>：递归完事后，得到每个文件结果，包含每个模块以及他们之间的依赖关系，根据entry或分包配置生成代码块chunk;</p>
<p><code v-pre>输出完成</code>：输出所有的chunk到文件系统；</p>
<h3 id="vue打包内存过大-怎么使用webpack来进行优化" tabindex="-1"><a class="header-anchor" href="#vue打包内存过大-怎么使用webpack来进行优化"><span>vue打包内存过大，怎么使用webpack来进行优化</span></a></h3>
<p><strong>开放式题目</strong></p>
<ul>
<li>
<p>打包优化的目的</p>
<p>1、优化项目启动速度，和性能</p>
...
减少项目在首次加载的时长（首屏加载优化）
4、目前的解决方向</p>
<p>cdn加载不比多说，就是改为引入外部js路径</p>
<p>首屏加载优化方面主要其实就两点</p>
<p>第一：
尽可能的减少首次加载的文件体积，和进行分布加载</p>
<p>第二：
首屏加载最好的解决方案就是ssr（服务端渲染），还利于seo
但是一般情况下没太多人选择ssr，因为只要不需要seo，ssr更多的是增加了项目开销和技术难度的。</p>
<p>1、路由懒加载
...
结合这两者，这就是如何定义一个能够被 Webpack 自动代码分割的异步组件。</p>
...
<p>const Fee = () =&gt; import('./Fee.vue')</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">在路由配置中什么都不需要改变，只需要像往常一样使用 Foo：</span>
<span class="line"></span>
...
<span class="line">})</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、服务器和webpack打包同时配置Gzip
Gzip是GNU zip的缩写，顾名思义是一种压缩技术。它将浏览器请求的文件先在服务器端进行压缩，然后传递给浏览器，浏览器解压之后再进行页面的解析工作。在服务端开启Gzip支持后，我们前端需要提供资源压缩包，通过Compression-Webpack-Plugin插件build提供压缩</p>
<p>需要后端配置，这里提供nginx方式：</p>
<div class="language-http line-numbers-mode" data-highlighter="prismjs" data-ext="http" data-title="http"><pre v-pre><code><span class="line"><span class="token header"><span class="token header-name keyword">http</span><span class="token punctuation">:</span><span class="token header-value">{ </span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>// 安装插件</p>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line">  $ cnpm i --save-dev compression-webpack-plugin</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>// 在vue-config.js 中加入</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token keyword">const</span> CompressionWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'compression-webpack-plugin'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
...
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、优化打包chunk-vendor.js文件体积过大
当我们运行项目并且打包的时候，会发现chunk-vendors.js这个文件非常大，那是因为webpack将所有的依赖全都压缩到了这个文件里面，这时我们可以将其拆分，将所有的依赖都打包成单独的js。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">// 在vue-config.js 中加入</span></span>
<span class="line">  </span>
<span class="line">  <span class="token operator">...</span><span class="token punctuation">.</span><span class="token punctuation">.</span></span>
<span class="line">  module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span></span>
<span class="line">  <span class="token operator">...</span><span class="token punctuation">.</span></span>
...
<p>4、启用CDN加速
用Gzip已把文件的大小减少了三分之二了，但这个还是得不到满足。那我们就把那些不太可能改动的代码或者库分离出来，继续减小单个chunk-vendors，然后通过CDN加载进行加速加载资源。</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line">  <span class="token comment">// 修改vue.config.js 分离不常用代码库</span></span>
...
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>// 在public文件夹的index.html 加载</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line">  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>https://cdn.bootcss.com/vue/2.5.17-beta.0/vue.runtime.min.js<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>5、完整vue.config.js代码</p>
...
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="webpack打包用过什么插件" tabindex="-1"><a class="header-anchor" href="#webpack打包用过什么插件"><span>webpack打包用过什么插件</span></a></h3>
<ul>
<li>
<h4 id="文件处理上" tabindex="-1"><a class="header-anchor" href="#文件处理上"><span>文件处理上</span></a></h4>
</li>
</ul>
<p>1、HtmlWebpackPlugin</p>
<p>包名：html-webpack-plugin</p>
<blockquote>
<p>该插件将为你生成一个 HTML 文件， 在 body 中使用 script 标签引入你所有 webpack 生成的 bundle。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fhtml-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>2、CleanWebpackPlugin</p>
<p>包名：clean-webpack-plugin</p>
<blockquote>
<p>用于在打包前清理上一次项目生成的 <code v-pre>bundle</code>文件。默认情况下，此插件将删除webpack的<code v-pre>Output.Path</code>目录中的所有文件，以及在每次成功重建后所有未使用的webpack资源（assets）。如果使用的webpack版本是 <strong>4</strong> 以上的，默认 清理 <code v-pre>&lt;PROJECT_DIR&gt;/dist/</code>下的文件。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fjohnagan%2Fclean-webpack-plugin" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>3、MiniCssExtractPlugin</p>
<p>包名：mini-css-extract-plugin</p>
<blockquote>
<p>将 css 成生文件，而非内联 。该插件的主要是为了抽离 css 样式,防止将样式打包在 js 中引起页面样式加载错乱的现象。支持按需加载 css 和 sourceMap
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fwebpack-contrib%2Fmini-css-extract-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>4、HotModuleReplacementPlugin</p>
<p>包名：HotModuleReplacementPlugin</p>
<blockquote>
<p>由 <code v-pre>webpack 自带</code>。在对CSS / JS文件进行修改时，可以立即更新浏览器（部分刷新）。依赖于 <code v-pre>webpack-dev-server</code>
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fconcepts%2Fhot-module-replacement%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>5、ImageminPlugin</p>
<p>包名：imagemin-webpack-plugin</p>
<blockquote>
<p>批量压缩图片。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FKlathmon%2Fimagemin-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>6、PurifyCSSPlugin</p>
<p>包名：purifycss-webpack</p>
<blockquote>
<p>从CSS中删除未使用的选择器（删除多余的 css 代码）。<strong>和 <code v-pre>extract-text-webpack-plugin</code> 一起使用</strong>
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fwebpack-contrib%2Fpurifycss-webpack%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>7、OptimizeCSSAssetsPlugin</p>
<p>包名：optimize-css-assets-webpack-plugin</p>
<blockquote>
<p>压缩css文件。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FNMFR%2Foptimize-css-assets-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>8、CssMinimizerPlugin</p>
<p>包名： css-minimizer-webpack-plugin</p>
<blockquote>
<p>压缩css文件。**用于 webpack 5 **。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fwebpack-contrib%2Fcss-minimizer-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>9、UglifyJsPlugin</p>
<p>包名：uglifyjs-webpack-plugin</p>
<blockquote>
<p>压缩js文件。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fwebpack-contrib%2Fuglifyjs-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>10、ProvidePlugin</p>
<p>包名：ProvidePlugin</p>
<blockquote>
<p>由 <code v-pre>webpack 自带</code>。自动加载模块，而不必在任何地方<code v-pre>import</code>或<code v-pre>require</code>它们。例如：new webpack.ProvidePlugin({$: 'jquery',React: 'react'})
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fprovide-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>11、SplitChunksPlugin</p>
<p>包名：-</p>
<blockquote>
<p>在<code v-pre>webapck配置</code>中的<code v-pre>optimization</code>字段中配置。<code v-pre>cacheGroups</code> 是关键，将文件提取打包成公共模块，像 抽取 <code v-pre>node_modules</code>里的文件。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fsplit-chunks-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>12、CompressionPlugin</p>
<p>包名：compression-webpack-plugin</p>
<blockquote>
<p>启用 <code v-pre>gzip</code> 压缩。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fcompression-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>13、CopyWebpackPlugin</p>
<p>包名： copy-webpack-plugin</p>
<blockquote>
<p>将已存在的单个文件或整个目录复制到构建目录中。多用于 将静态文件 因在打包时 webpack 并不会帮我们拷贝到 dist 目录 拷贝到 dist 目录
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fcopy-webpack-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>14、DefinePlugin</p>
<p>包名：DefinePlugin</p>
<blockquote>
<p>由 <code v-pre>webpack 自带</code>。设置全局变量。如：new webpack.DefinePlugin({'process.env.NODE_ENV': JSON.stringify('production')})
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fdefine-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<ul>
<li>
<h5 id="打包速率上" tabindex="-1"><a class="header-anchor" href="#打包速率上"><span>打包速率上</span></a></h5>
</li>
</ul>
<p>1、DllPlugin</p>
<p>包名：DllPlugin</p>
<blockquote>
<p>由 <code v-pre>webpack 自带</code>。<code v-pre>dllplugin</code>和<code v-pre>dllreferenceplugin</code>提供了拆分捆绑包的方法，这些方式可以大大提高构建时间性能。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fdll-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>2、DLLReferencePlugin</p>
<p>包名：DLLReferencePlugin</p>
<blockquote>
<p>由 <code v-pre>webpack 自带</code>。它引用了仅需要预先构建的依赖项的 <code v-pre>DLL-only-Bundle</code>。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fwebpack.js.org%2Fplugins%2Fdll-plugin%2F%23dllreferenceplugin" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>3、ParallelUglifyPlugin</p>
<p>包名：webpack-parallel-uglify-plugin</p>
<blockquote>
<p>开启多个子进程，把对多个文件压缩的工作分别给多个子进程去完成。减少构建时间。
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fgdborton%2Fwebpack-parallel-uglify-plugin%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<p>4、HappyPack</p>
<p>包名：happypack</p>
<blockquote>
<p>让 webpack 把任务分解给多个子进程去并发的执行，子进程处理完后再把结果发送给主进程。提升 构建 速度
<a href="https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Famireh%2Fhappypack%2F" target="_blank" rel="noopener noreferrer">官方传送门</a></p>
</blockquote>
<h3 id="说说gulp和webpack的区别" tabindex="-1"><a class="header-anchor" href="#说说gulp和webpack的区别"><span>说说gulp和webpack的区别</span></a></h3>
<p><strong>开放式题目</strong></p>
<p>Gulp强调的是前端开发的工作流程。我们可以通过配置一系列的task，定义task处理的事务（例如文件压缩合并、雪碧图、启动server、版本控制等），然后定义执行顺序，来让Gulp执行这些task，从而构建项目的整个前端开发流程。通俗一点来说，“Gulp就像是一个产品的流水线，整个产品从无到有，都要受流水线的控制，在流水线上我们可以对产品进行管理。”</p>
<p>Webpack是一个前端模块化方案，更侧重模块打包。我们可以把开发中的所有资源（图片、js文件、css文件等）都看成模块，通过loader（加载器）和plugins（插件）对资源进行处理，打包成符合生产环境部署的前端资源。 Webpack就是需要通过其配置文件（Webpack.config.js）中 entry 配置的一个入口文件（JS文件），然后在解析过程中，发现其他的模块，如scss等文件，再调用配置的loader或者插件对相关文件进行解析处理。</p>
<p>虽然Gulp 和 Webpack都是前端自动化构建工具，但看2者的定位就知道不是对等的。Gulp严格上讲，模块化不是他强调的东西，旨在规范前端开发流程。Webpack更明显的强调模块化开发，而那些文件压缩合并、预处理等功能，不过是他附带的功能。</p>
<h2 id="五、typescript" tabindex="-1"><a class="header-anchor" href="#五、typescript"><span>五、Typescript</span></a></h2>
<h3 id="了解过ts吗" tabindex="-1"><a class="header-anchor" href="#了解过ts吗"><span>了解过TS吗？</span></a></h3>
<p>ts是一种基于静态类型检查的强类型语言那当然js就是一种弱类型语言
由于我们在浏览器中不能编译ts语言所以我们需要安装编译器
安装下载
使用npm install -g typescript进行下载
使用tsc进行检测是否安装成功
在文件中间一个js文件，然后在文件中见一个ts文件，但是直接去使用的时候会报错，需要在终端中使用tsc ./js/hello.ts，这样之后可以在当前的就是文件中自动编译一个同名js文件。</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">let</span> num<span class="token operator">:</span><span class="token builtin">number</span><span class="token operator">=</span><span class="token number">20</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>ts支持的数据类型</p>
<p>数组</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">let</span> arr<span class="token operator">:</span><span class="token builtin">number</span><span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token operator">=</span><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span><span class="token number">2</span><span class="token punctuation">,</span><span class="token number">3</span><span class="token punctuation">,</span><span class="token number">4</span><span class="token punctuation">,</span><span class="token number">5</span><span class="token punctuation">]</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>元组Tuple
规定元素类型和规定元素数量和顺序的数组
特点：不要越界访问
定义的是什么类型写的就是什么类型，可以使用数组的下标取值，但是如果使用数组的push方法的话，虽然输出的数组中有，但是取值的话会报错可以打印出来但不建议这样写，这就说了元组的一个越界问题</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">let</span> tu<span class="token operator">:</span><span class="token punctuation">[</span><span class="token builtin">number</span><span class="token punctuation">,</span><span class="token builtin">string</span><span class="token punctuation">]</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>枚举
1.有限的可列举出来的命名和索引对应的类型
2枚举类型的优势：语义化可维护性
3原理：反向映射，互相指向</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token comment">//定义了一个枚举</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>代表任意类型：</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">let</span> t<span class="token operator">:</span><span class="token builtin">any</span><span class="token operator">=</span><span class="token number">10</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接口
跟另一个事物之间的一个媒介</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">interface</span> <span class="token class-name">userInfo</span><span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用ts写一个对象属性约束" tabindex="-1"><a class="header-anchor" href="#使用ts写一个对象属性约束"><span>使用ts写一个对象属性约束</span></a></h3>
<p>使用{useName:string, password:number}约束传入的userData参数（并将password置为可选参数）</p>
...
<p>通俗理解：泛型就是解决类 接口 方法的复用性、以及对不特定数据类型的支持</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">getData</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">value</span><span class="token operator">:</span>string</span><span class="token punctuation">)</span><span class="token operator">:</span>string<span class="token punctuation">{</span></span>
...
<p><strong>ts中函数参数的类型定义</strong></p>
<p>函数的参数可能是一个，也可能是多个，有可能是一个变量，一个对象，一个函数，一个数组等等。</p>
<p>1.函数的参数为单个或多个单一变量的类型定义</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntA</span><span class="token punctuation">(</span><span class="token parameter">one<span class="token punctuation">,</span> two<span class="token punctuation">,</span> three</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntA</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">one</span><span class="token operator">:</span> number<span class="token punctuation">,</span> <span class="token literal-property property">two</span><span class="token operator">:</span> string<span class="token punctuation">,</span> <span class="token literal-property property">three</span><span class="token operator">:</span> boolean</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">return</span> one <span class="token operator">+</span> two <span class="token operator">+</span> three</span>
<span class="line"><span class="token punctuation">}</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.函数的参数为数组的类型定义</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntB</span><span class="token punctuation">(</span><span class="token parameter">arr</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntB</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">arr</span><span class="token operator">:</span> number<span class="token punctuation">[</span><span class="token punctuation">]</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">return</span> arr<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span></span>
<span class="line"><span class="token punctuation">}</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3.函数的参数为对象的类型定义</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntC</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> one<span class="token punctuation">,</span> two <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntC</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> one<span class="token punctuation">,</span> two <span class="token punctuation">}</span><span class="token operator">:</span> <span class="token punctuation">{</span> <span class="token literal-property property">one</span><span class="token operator">:</span> number<span class="token punctuation">,</span> <span class="token literal-property property">two</span><span class="token operator">:</span> number <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">return</span> one <span class="token operator">+</span> two</span>
<span class="line"><span class="token punctuation">}</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4.函数的参数为函数的类型定义</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntD</span><span class="token punctuation">(</span><span class="token parameter">callback</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">fntD</span><span class="token punctuation">(</span><span class="token function-variable function">callback</span><span class="token operator">:</span> <span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">bl</span><span class="token operator">:</span> boolean</span><span class="token punctuation">)</span> <span class="token operator">=></span> boolean<span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token function">callback</span><span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"><span class="token keyword">function</span> <span class="token function">callback</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">bl</span><span class="token operator">:</span> boolean</span><span class="token punctuation">)</span><span class="token operator">:</span> boolean <span class="token punctuation">{</span></span>
<span class="line">    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>bl<span class="token punctuation">)</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>ts中函数返回值的类型定义</strong></p>
<p>当函数有返回值时，根据返回值的类型在相应的函数位置进行静态类型定义即可</p>
<p>返回数字：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">getTotal2</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">one</span><span class="token operator">:</span> number<span class="token punctuation">,</span> <span class="token literal-property property">two</span><span class="token operator">:</span> number</span><span class="token punctuation">)</span><span class="token operator">:</span> number <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回布尔值</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">getTotal2</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">one</span><span class="token operator">:</span> number<span class="token punctuation">,</span> <span class="token literal-property property">two</span><span class="token operator">:</span> number</span><span class="token punctuation">)</span><span class="token operator">:</span> boolean <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回字符串</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回对象</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">getObj</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">name</span><span class="token operator">:</span> string<span class="token punctuation">,</span> <span class="token literal-property property">age</span><span class="token operator">:</span> number</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token punctuation">{</span> <span class="token literal-property property">name</span><span class="token operator">:</span> string<span class="token punctuation">,</span> <span class="token literal-property property">age</span><span class="token operator">:</span> number <span class="token punctuation">}</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回数组</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">getArr</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">arr</span><span class="token operator">:</span> number<span class="token punctuation">[</span><span class="token punctuation">]</span></span><span class="token punctuation">)</span> <span class="token operator">:</span>number<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>函数返回值为underfinde，仅仅时为了在内部实现某个功能，我们就可以给他一个类型注解void，代表没有任何返回值，</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">sayName</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后：</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">function</span> <span class="token function">sayName1</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token keyword">void</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当函数没有返回值时</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// 因为总是抛出异常，所以 error 将不会有返回值</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ts和js相比有什么区别" tabindex="-1"><a class="header-anchor" href="#ts和js相比有什么区别"><span>ts和js相比有什么区别</span></a></h3>
<ul>
<li>在ts中完全可以使用js</li>
<li>ts是js的超集，并且ts比js多了一个类型检查功能</li>
</ul>
<h3 id="rx了解吗" tabindex="-1"><a class="header-anchor" href="#rx了解吗"><span>RX了解吗？</span></a></h3>
<p>Rx 中强大的地方在于两处</p>
<ul>
<li>管道思想，通过管道，我们订阅了数据的来源，并在数据源更新时响应 。</li>
<li>强大的操作符，通过操作符对流和流中的数据转换，拼接，以形成我们想要的数据模型 。</li>
</ul>
<p>在 Rx 中，我们先预装好管道，通过管道流通数据 。这些管道的来源多种， create ，from， fromEvent， of .., 通过操作符将管道 拼接，合并，映射...形成最终的数据模型 。
对于管道来说，有两点非常重要</p>
<p>. 管道是懒执行的，只有订阅器 observer subscribe了 数据管道，这个管道才会有数据流通 。
. 整个节点组成一个完整的管道，订阅了后面的管道节点，也会同时订阅之前的管道节点 ，每个节点接受之前的值，并发出新值</p>
<p>Rx 如此高效和强大，得益于其强大的操作符 。
主要包含下面几类</p>
<p>创建操作符： create， range， of， from， fromEvent， fromPromise, empty ..
组合 contact ,merge, startWith, zip ..
时间 delay , throttle, dobounceTime, interval ..
过滤： filter, first, last, skip, distinct, take ..
转换： buffer,map, mapTo, mergeMap, switch, switchMap, reduce, scan .</p>
<h2 id="六、nodejs" tabindex="-1"><a class="header-anchor" href="#六、nodejs"><span>六、nodejs</span></a></h2>
<h3 id="说说对nodejs的了解" tabindex="-1"><a class="header-anchor" href="#说说对nodejs的了解"><span>说说对nodejs的了解</span></a></h3>
<ul>
<li>Node.js 是一个开源和跨平台的 JavaScript 运行时环境。 它几乎是任何类型项目的流行工具！</li>
<li>Node.js 在浏览器之外运行 V8 JavaScript 引擎（Google Chrome 的内核）。 这使得 Node.js 的性能非常好。</li>
<li>Node.js 应用程序在单个进程中运行，无需为每个请求创建新的线程。 Node.js 在其标准库中提供了一组异步的 I/O 原语，以防止 JavaScript 代码阻塞，通常，Node.js 中的库是使用非阻塞范式编写的，使得阻塞行为成为异常而不是常态。</li>
<li>当 Node.js 执行 I/O 操作时（比如从网络读取、访问数据库或文件系统），Node.js 将在响应返回时恢复操作（而不是阻塞线程和浪费 CPU 周期等待）。
这允许 Node.js 使用单个服务器处理数千个并发连接，而​​不会引入管理线程并发（这可能是错误的重要来源）的负担。</li>
<li>Node.js 具有独特的优势，因为数百万为浏览器编写 JavaScript 的前端开发者现在无需学习完全不同的语言，就可以编写除客户端代码之外的服务器端代码。</li>
<li>在 Node.js 中，可以毫无问题地使用新的 ECMAScript 标准，因为你不必等待所有用户更新他们的浏览器，你负责通过更改 Node.js 版本来决定使用哪个 ECMAScript 版本，你还可以通过运行带有标志的 Node.js 来启用特定的实验性功能。</li>
</ul>
<h3 id="nodejs如何写接口-返回参数如何处理-有多少种方法" tabindex="-1"><a class="header-anchor" href="#nodejs如何写接口-返回参数如何处理-有多少种方法"><span>nodejs如何写接口，返回参数如何处理，有多少种方法</span></a></h3>
<ul>
<li>nodejs的原生模块http可用于编写接口，但一般推荐使用express或koa2来设计restful api。</li>
<li>下面以 express 为例说明如何编写接口。</li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">var express = require('express')</span>
...
<li>express响应客户端的方法有：end()/json()/render()/send()/jsonp()/sendFile()等。</li>
</ul>
<h3 id="websocket和http的区别" tabindex="-1"><a class="header-anchor" href="#websocket和http的区别"><span>websocket和http的区别</span></a></h3>
<ul>
<li>WebSocket 是 HTML5 中的协议，支持持久连续，http 协议不支持持久性连接。</li>
<li>Http1.0 和 HTTP1.1 都不支持持久性的链接，HTTP1.1 中的 keep-alive，将多个 http 请求合并为 1个。</li>
</ul>
<h3 id="常见的-http-method-有哪些-get-post-区别" tabindex="-1"><a class="header-anchor" href="#常见的-http-method-有哪些-get-post-区别"><span>常见的 HTTP Method 有哪些? GET/POST 区别？</span></a></h3>
<p>1、<strong>常见的HTTP方法</strong></p>
<ul>
<li>GET：获取资源</li>
<li>POST：传输资源</li>
<li>PUT：更新资源</li>
...
<p>2、<strong>GET/POST的区别</strong></p>
<ul>
...
<h3 id="说一说tcp三次握手-四次挥手" tabindex="-1"><a class="header-anchor" href="#说一说tcp三次握手-四次挥手"><span>说一说Tcp三次握手，四次挥手</span></a></h3>
<p>1、<strong>三次握手</strong></p>
<ul>
<li>seq序号，用来标识从TCP源端向目的端发送的字节流，发起方发送数据时对此进行标记</li>
<li>ack确认序号，只有ACK标志位为1时，确认序号字段才有效，ack=seq+1</li>
</ul>
<p>2、<strong>四次挥手</strong></p>
<p>关闭连接时，当服务器端收到FIN报文时，很可能并不会立即关闭链接，所以只能先回复一个ACK报文，告诉客户端：”你发的FIN报文我收到了”，只有等到服务器端所有的报文都发送完了，我才能发送FIN报文，因此不能一起发送，故需要四步握手。</p>
<h3 id="阐述一下http1-0与http2-0的区别-及http和https区别" tabindex="-1"><a class="header-anchor" href="#阐述一下http1-0与http2-0的区别-及http和https区别"><span>阐述一下http1.0与http2.0的区别,及http和https区别</span></a></h3>
<p>1、<strong>HTTP1.0和HTTP1.1的一些区别</strong></p>
<ul>
<li>缓存处理，HTTP1.0中主要使用Last-Modified，Expires 来做为缓存判断的标准，HTTP1.1则引入了更多的缓存控制策略：ETag，Cache-Control…
带宽优化及网络连接的使用，HTTP1.1支持断点续传，即返回码是206（Partial Content）</li>
...
<p>2、<strong>HTTP2.0和HTTP1.X相比的新特性</strong></p>
<ul>
...
<h3 id="node-js如何导出页面数据形成报表" tabindex="-1"><a class="header-anchor" href="#node-js如何导出页面数据形成报表"><span>node.js如何导出页面数据形成报表</span></a></h3>
<p>生成报表并下载是作为web应用中的一个传统功能，在实际项目中有广范的应用，实现原理也很简单，以NodeJS导出数据的方法为例，就是拿到页面数据对应id，然后根据id查询数据库，拿到所需数据后格式化为特点格式的数据，最后导出文件。</p>
<p>在nodejs中，也提供了很多的第三方库来实现这一功能，以<code v-pre>node-xlsx</code>导出excel文件为例，实现步骤如下：</p>
<ol>
<li>下载<code v-pre>node-xlsx</code><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line">    <span class="token function">npm</span> <span class="token function">install</span> node-xlsx</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>编写接口
<blockquote>
<p>以下代码使用<code v-pre>express</code>编写，调用接口实现下载功能</p>
</blockquote>
...
<h3 id="协商缓存和强缓存" tabindex="-1"><a class="header-anchor" href="#协商缓存和强缓存"><span>协商缓存和强缓存</span></a></h3>
<p>浏览器缓存主要分为强<strong>强缓存</strong>（也称<strong>本地缓存</strong>）和<strong>协商缓存</strong>（也称<strong>弱缓存</strong>）。浏览器在第一次请求发生后，再次发送请求时：</p>
<ul>
<li>浏览器请求某一资源时，会先获取该资源缓存的header信息，然后根据header中的<code v-pre>Cache-Control</code>和<code v-pre>Expires</code>来判断是否过期。若没过期则直接从缓存中获取资源信息，包括缓存的header的信息，所以此次请求不会与服务器进行通信。这里判断是否过期，则是强缓存相关。后面会讲<code v-pre>Cache-Control</code>和<code v-pre>Expires</code>相关。</li>
<li>如果显示已过期，浏览器会向服务器端发送请求，这个请求会携带第一次请求返回的有关缓存的header字段信息，比如客户端会通过<code v-pre>If-None-Match</code>头将先前服务器端发送过来的Etag发送给服务器，服务会对比这个客户端发过来的Etag是否与服务器的相同，若相同，就将<code v-pre>If-None-Match</code>的值设为false，返回状态304，客户端继续使用本地缓存，不解析服务器端发回来的数据，若不相同就将<code v-pre>If-None-Match</code>的值设为true，返回状态为200，客户端重新机械服务器端返回的数据；客户端还会通过<code v-pre>If-Modified-Since</code>头将先前服务器端发过来的最后修改时间戳发送给服务器，服务器端通过这个时间戳判断客户端的页面是否是最新的，如果不是最新的，则返回最新的内容，如果是最新的，则返回304，客户端继续使用本地缓存。</li>
</ul>
<h4 id="强缓存" tabindex="-1"><a class="header-anchor" href="#强缓存"><span>强缓存</span></a></h4>
<p>强缓存是利用http头中的<code v-pre>Expires</code>和<code v-pre>Cache-Control</code>两个字段来控制的，用来表示资源的缓存时间。强缓存中，普通刷新会忽略它，但不会清除它，需要强制刷新。浏览器强制刷新，请求会带上<code v-pre>Cache-Control:no-cache</code>和<code v-pre>Pragma:no-cache</code></p>
<h4 id="expires" tabindex="-1"><a class="header-anchor" href="#expires"><span>Expires</span></a></h4>
<p><code v-pre>Expires</code>是http1.0的规范，它的值是一个绝对时间的GMT格式的时间字符串。如我现在这个网页的<code v-pre>Expires</code>值是：<code v-pre>expires:Fri, 14 Apr 2017 10:47:02 GMT</code>。这个时间代表这这个资源的失效时间，只要发送请求时间是在<code v-pre>Expires</code>之前，那么本地缓存始终有效，则在缓存中读取数据。所以这种方式有一个明显的缺点，由于失效的时间是一个绝对时间，所以当服务器与客户端时间偏差较大时，就会导致缓存混乱。如果同时出现<code v-pre>Cache-Control:max-age</code>和<code v-pre>Expires</code>，那么<code v-pre>max-age</code>优先级更高。如我主页的response headers部分如下：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">cache-control:max-age=691200</span>
<span class="line">expires:Fri, 14 Apr 2017 10:47:02 GMT</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="cache-control" tabindex="-1"><a class="header-anchor" href="#cache-control"><span>Cache-Control</span></a></h4>
...
<li>
<p>private：只能被终端用户的浏览器缓存，不允许CDN等中继缓存服务器对其缓存。
Cache-Control与Expires可以在服务端配置同时启用，同时启用的时候Cache-Control优先级高。</p>
</li>
</ul>
<h4 id="协商缓存" tabindex="-1"><a class="header-anchor" href="#协商缓存"><span>协商缓存</span></a></h4>
...
<p>这个主要涉及到两组header字段：<code v-pre>Etag</code>和<code v-pre>If-None-Match</code>、<code v-pre>Last-Modified</code>和<code v-pre>If-Modified-Since</code>。上面以及说得很清楚这两组怎么使用啦~复习一下：</p>
<h4 id="etag和if-none-match" tabindex="-1"><a class="header-anchor" href="#etag和if-none-match"><span><code v-pre>Etag</code>和<code v-pre>If-None-Match</code></span></a></h4>
...
<h4 id="last-modify-if-modify-since" tabindex="-1"><a class="header-anchor" href="#last-modify-if-modify-since"><span>Last-Modify/If-Modify-Since</span></a></h4>
...
<h4 id="为什么要有etag" tabindex="-1"><a class="header-anchor" href="#为什么要有etag"><span>为什么要有Etag</span></a></h4>
...
<h3 id="http常用状态码有哪一些-说一说他们的作用" tabindex="-1"><a class="header-anchor" href="#http常用状态码有哪一些-说一说他们的作用"><span>http常用状态码有哪一些，说一说他们的作用</span></a></h3>
<p>常用的状态码： 200表示成功，301表示重定向，404表示资源未找到，500表示服务器内部错误</p>
<p>状态码分类：</p>
<table>
<thead>
<tr>
...
<h3 id="网络攻击方案有哪些-自己有写过什么安全性方面的东西吗" tabindex="-1"><a class="header-anchor" href="#网络攻击方案有哪些-自己有写过什么安全性方面的东西吗"><span>网络攻击方案有哪些，自己有写过什么安全性方面的东西吗？</span></a></h3>
<ol>
<li>iframe</li>
<li>opener</li>
<li>CSRF（跨站请求伪造）</li>
...
<p>很难通过技术手段完全避免 XSS，但我们可以总结以下原则减少漏洞的产生：</p>
<ul>
<li><strong>利用模板引擎</strong> 开启模板引擎自带的 HTML 转义功能。例如： 在 ejs 中，尽量使用 <code v-pre>&lt;%= data %&gt;</code> 而不是 <code v-pre>&lt;%- data %&gt;</code>； 在 doT.js 中，尽量使用 <code v-pre>{{! data }</code> 而不是 <code v-pre>{{= data }</code>； 在 FreeMarker 中，确保引擎版本高于 2.3.24，并且选择正确的 <code v-pre>freemarker.core.OutputFormat</code>。</li>
<li><strong>避免内联事件</strong> 尽量不要使用 <code v-pre>onLoad=&quot;onload('{{data}}')&quot;</code>、<code v-pre>onClick=&quot;go('{{action}}')&quot;</code> 这种拼接内联事件的写法。在 JavaScript 中通过 <code v-pre>.addEventlistener()</code> 事件绑定会更安全。</li>
<li><strong>避免拼接 HTML</strong> 前端采用拼接 HTML 的方法比较危险，如果框架允许，使用 <code v-pre>createElement</code>、<code v-pre>setAttribute</code> 之类的方法实现。或者采用比较成熟的渲染框架，如 Vue/React 等。</li>
...
<h3 id="静态资源部署到哪" tabindex="-1"><a class="header-anchor" href="#静态资源部署到哪"><span>静态资源部署到哪?</span></a></h3>
<ul>
<li>
<p><strong>存放静态资源文件到服务器</strong></p>
<p>但这种形式在性能上也有缺陷：</p>
<ul>
<li>
<p>受地理环境影响，离服务器越远资源加载越慢</p>
</li>
<li>
<p>频繁请求资源对服务器压力较大</p>
</li>
...
<li>
<p><strong>存放静态资源文件到CDN</strong></p>
<p>为了进一步提升性能，可以把动态网页（index.html）和静态资源（js、css、image...）分开部署。静态资源被放置于 CDN 上.</p>
<p>但是 CDN 也有缓存策略：新的静态资源发布后，需要一定的时间去覆盖各个边缘站点的旧资源。若某客户端获得了新的动态网页，但是附近的 CDN 节点尚未更新最近发布的静态资源，客户端即便放弃本地缓存，它加载的依旧是位于 CDN 上的“脏数据”。怎么办呢？干脆把文件名也给改了——让摘要信息成为文件名的一部分！具体实现可以仰仗 webpack，将 <code v-pre>output.filename</code> 设为 <code v-pre>[name].[contenthash].js</code>，输出文件和 html 模版都会帮你更改好.</p>
<p>用摘要信息重命名后的资源文件，与旧资源就不同名了，不再需要以覆盖旧文件的形式主动更新各个地区的边缘站点。新版本发布后，浏览器首次请求资源，若 CDN 不存在该资源，便会向就近的边缘站点加载该文件，同时更新 CDN 缓存；这就彻底避免了 CDN 脏数据的问题.</p>
</li>
</ul>
<h3 id="说说你对nodejs的了解" tabindex="-1"><a class="header-anchor" href="#说说你对nodejs的了解"><span>说说你对nodejs的了解</span></a></h3>
<blockquote>
<p>我们从以下几方面来看nodejs.</p>
</blockquote>
<ul>
<li>
<p><strong>什么是nodejs?</strong></p>
<p><code v-pre>Node.js</code> 是一个开源与跨平台的 <code v-pre>JavaScript</code> 运行时环境, 在浏览器外运行 V8 JavaScript 引擎（Google Chrome 的内核），利用事件驱动、非阻塞和异步输入输出模型等技术提高性能.</p>
<p>可以理解为 <code v-pre>Node.js</code> 就是一个服务器端的、非阻塞式I/O的、事件驱动的<code v-pre>JavaScript</code>运行环境</p>
<ul>
<li>
<p>非阻塞异步</p>
<p><code v-pre>Nodejs</code>采用了非阻塞型<code v-pre>I/O</code>机制，在做<code v-pre>I/O</code>操作的时候不会造成任何的阻塞，当完成之后，以时间的形式通知执行操作</p>
...
<ul>
<li>处理高并发场景性能更佳</li>
<li>适合I/O密集型应用，指的是应用在运行极限时，CPU占用率仍然比较低，大部分时间是在做 I/O硬盘内存读写操作</li>
</ul>
<p>因为<code v-pre>Nodejs</code>是单线程，带来的缺点有：</p>
<ul>
<li>不适合CPU密集型应用</li>
...
<p>借助<code v-pre>Nodejs</code>的特点和弊端，其应用场景分类如下：</p>
<ul>
<li>善于<code v-pre>I/O</code>，不善于计算。因为Nodejs是一个单线程，如果计算（同步）太多，则会阻塞这个线程</li>
...
<li>第五大类：操作数据库、为前端和移动端提供基于<code v-pre>json</code>的API</li>
</ul>
</li>
</ul>
<h2 id="七、git" tabindex="-1"><a class="header-anchor" href="#七、git"><span>七、GIT</span></a></h2>
<h3 id="git经常用哪些指令" tabindex="-1"><a class="header-anchor" href="#git经常用哪些指令"><span>git经常用哪些指令</span></a></h3>
<ul>
<li>
<p><strong>产生代码库</strong></p>
<ul>
<li>
<p>新建一个git代码库</p>
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">git</span> init</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">git</span> clone 远程仓库地址</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">git</span> config <span class="token parameter variable">--list</span> <span class="token punctuation">[</span>--global<span class="token punctuation">]</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">git</span> config <span class="token parameter variable">-e</span> <span class="token punctuation">[</span>--global<span class="token punctuation">]</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</li>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">git</span> config <span class="token punctuation">[</span>--global<span class="token punctuation">]</span> user.name <span class="token string">"名"</span></span>
...
<li>
<p><strong>暂存区文件操作</strong></p>
<ul>
<li>
<p>增加文件到暂存区</p>
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 1.添加当前目录的所有文件到暂存区</span></span>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 删除工作区文件，并且将这次删除放入暂存区</span></span>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 改名文件，并且将这个改名放入暂存区</span></span>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 提交暂存区到仓库区</span></span>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 列出所有本地分支</span></span>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 显示有变更的文件</span></span>
...
<ul>
<li>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token comment"># 增加一个新的远程仓库，并命名</span></span>
...
<h3 id="git出现代码冲突怎么解决" tabindex="-1"><a class="header-anchor" href="#git出现代码冲突怎么解决"><span>git出现代码冲突怎么解决</span></a></h3>
<p>冲突合并一般是因为自己的本地做的提交和服务器上的提交有差异，并且这些差异中的文件改动，Git不能自动合并，那么就需要用户手动进行合并</p>
<p>如我这边执行<code v-pre>git pull origin master</code></p>
<p>如果Git能够自动合并，那么过程看起来是这样的：</p>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2021/12/064c1d8d898dcfa04271d3888f9592e8345d8ce7.gif?sign=6515ce97d31c987d90dc4e9e05b19688&amp;t=61c3e059" alt=""></p>
<p>拉取的时候，Git自动合并，并产生了一次提交。</p>
<p>如果Git不能够自动合并，那么会提示：</p>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2021/12/f1184ad1984f78b6cec49e492670b9da0b3bf8d1.png?sign=d97354204b2b8d9630010abc12b196f5&amp;t=61c3e097" alt=""></p>
<p>这个时候我们就可以知道<code v-pre>README.MD</code>有冲突，需要我们手动解决，修改<code v-pre>README.MD</code>解决冲突：</p>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2021/12/7d37e41669c2572905b80640702251df80004482.png?sign=d0a69bfe47903bbe41f03166db81a88a&amp;t=61c3e0b2" alt=""></p>
<p>可以看出来，在1+1=几的这行代码上产生了冲突，解决冲突的目标是保留期望存在的代码，这里保留1+1=2，然后保存退出。</p>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2021/12/59035a8c1be9c0e9a86ffc0d7a25628f32286fa1.png?sign=b5ea411d811831a55269d7903089bbf0&amp;t=61c3e0c8" alt=""></p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>即可完成一次冲突的合并。</p>
<p>整个过程看起来是这样的：</p>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2021/12/48a80f5e69110ed5dcfb988d05358c82d2270f56.gif?sign=ffad10419eee58ce7a59ac0a29769a07&amp;t=61c3e0ee" alt=""></p>
<h3 id="你们团队是怎么管理git分支的" tabindex="-1"><a class="header-anchor" href="#你们团队是怎么管理git分支的"><span>你们团队是怎么管理git分支的</span></a></h3>
<p>关于<code v-pre>Git</code>分支管理，每个团队在不同阶段都有自己的管理策略。我们团队以前采用的是版本分支管理策略，也就是每次上线新版本都会创建一个新的版本分支，而新的需求开发也从当前最新的版本分支迁出一个新的需求分支开发，线上<code v-pre>bug</code>则在版本分支上修改然后发布。</p>
<h3 id="如何实现git的免密操作" tabindex="-1"><a class="header-anchor" href="#如何实现git的免密操作"><span>如何实现Git的免密操作</span></a></h3>
<p>现在的远程仓库都提供了基于SSH协议的Git服务，在使用SSH协议访问仓库之前，需要先配置好账户/仓库的SSH公钥。</p>
<p>① 产生公私钥对</p>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line">ssh-keygen <span class="token parameter variable">-t</span> rsa <span class="token parameter variable">-C</span> cherish@cherish.pw</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>产生完毕后，公私玥对位于<code v-pre>c/Users/用户名/.ssh/</code>：</p>
<ul>
<li>id_rsa：私钥（私有的钥匙，不能公开）</li>
<li>id_rsa.pub：公钥（可以公开的钥匙）</li>
</ul>
<p>② 将公钥上传至远程仓库个人中心的设置里</p>
<blockquote>
<p>以gitee为例，添加公钥请访问：https://gitee.com/profile/sshkeys</p>
</blockquote>
<p><img src="https://storage.lynnn.cn/assets/markdown/91147/pictures/2021/04/bf722d35ec80010faf827ae3b04074b8827a9add.png?sign=057fc480bcb35f04ef9d139833a00033&amp;t=607551a8" alt=""></p>
<p>注：如果想用现在的免密登录，请使用ssh协议去关联本地与线上仓库。</p>
<h2 id="八、其它" tabindex="-1"><a class="header-anchor" href="#八、其它"><span>八、其它</span></a></h2>
<h3 id="loadsh-了解过吗" tabindex="-1"><a class="header-anchor" href="#loadsh-了解过吗"><span>loadsh 了解过吗？</span></a></h3>
<p>Lodash 是一个一致性、模块化、高性能的 JavaScript 实用工具库。</p>
<p>首先要明白的是lodash的所有函数都不会在原有的数据上进行操作，而是复制出一个新的数据而不改变原有数据。类似immutable.js的理念去处理。</p>
<p>Lodash 通过降低 array、number、objects、string 等等的使用难度从而让 JavaScript 变得更简单。 Lodash 的模块化方法 非常适用于：</p>
<ol>
<li>遍历 array、object 和 string 对</li>
<li>值进行操作和检测</li>
<li>创建符合功能的函数</li>
</ol>
<p><strong>常用语法</strong>：cloneDeep深拷贝，uniq数组去重，compact 去除假值，filter和reject 过滤集合传入匿名函数， join 将 array 中的所有元素转换为由 separator 分隔的字符串等</p>
<h3 id="是否用过混合app开发" tabindex="-1"><a class="header-anchor" href="#是否用过混合app开发"><span>是否用过混合APP开发</span></a></h3>
<p>1.原生开发(NativeApp开发)：像盖房子一样，先打地基然后浇地梁、房屋结构、一砖一瓦、钢筋水泥、电路走向等，原生APP同理：通过代码从每个页面、每个功能、每个效果、每个逻辑、每个步骤全部用代码写出来，一层层，一段段全用代码写出来</p>
<p>此种APP的数据都保存在本地，APP能及时调取，所以相应速度及流畅性有保障</p>
<p>2.混合开发(HTML5开发)：这个就相当于一种框架开发，说白了就是网页;该模式通常由“HTML5云网站+APP应用客户端”两部份构成，APP应用客户端只需安装应用的框架部份，而应用的数据则是每次打开APP的时候，去云端取数据呈现给手机用户。</p>
<p>混合APP还有一种是套壳APP，套壳APP就是用H5的网页打包成APP，虽然是APP能安装到手机上，但是每个界面，全部是网页</p>
<p>混合APP开发优势：</p>
<p>时间短：基本都是模版拿来直接套上或打包成APP，会节省很大一部分时间。</p>
<p>价格便宜：代码不需要重新写，界面不用重新设计，都是固定的，可替换的地方很少，自己随便都能换上，所以价格相对便宜。</p>
<h3 id="项目中的组件是如何使用的" tabindex="-1"><a class="header-anchor" href="#项目中的组件是如何使用的"><span>项目中的组件是如何使用的</span></a></h3>
<p>可以使用第三方组件库以及自定义组件</p>
<p>vue项目中使用组件库为 vant / element-ui / iview / ant-design-vue</p>
<p>react常用组件库为 Ant Design / Ant Design Mobile</p>
<p>开发者也可以通过自定义实现组件的使用</p>
<h3 id="hash和histoty的原理" tabindex="-1"><a class="header-anchor" href="#hash和histoty的原理"><span>hash和histoty的原理</span></a></h3>
<ul>
<li>hash模式：在浏览器中符号“#”，#以及#后面的字符称之为hash，用 window.location.hash 读取。特点：hash虽然在URL中，但不被包括在HTTP请求中；用来指导浏览器动作，对服务端安全无用，hash不会重加载页面。</li>
<li>history模式：history采用HTML5的新特性；且提供了两个新方法： pushState()， replaceState()可以对浏览器历史记录栈进行修改，以及popState事件的监听到状态变更</li>
</ul>
<h3 id="window-location-href和history-push的区别" tabindex="-1"><a class="header-anchor" href="#window-location-href和history-push的区别"><span>window.location.href和history.push的区别</span></a></h3>
<ul>
<li>window.location.href 锚点跳转，不会加入路由栈。</li>
<li>history.push 向由路由栈中添加新的路由信息，点击浏览器返回按钮时返回到上一页。</li>
</ul>
<h3 id="商城项目中有写到调用微信-支付宝支付-简单讲述一下这个支付与后台对接的过程-微信支付的原理" tabindex="-1"><a class="header-anchor" href="#商城项目中有写到调用微信-支付宝支付-简单讲述一下这个支付与后台对接的过程-微信支付的原理"><span>商城项目中有写到调用微信，支付宝支付，简单讲述一下这个支付与后台对接的过程，微信支付的原理</span></a></h3>
<ul>
<li>步骤1：用户在商户APP中选择商品，提交订单，选择微信支付。</li>
<li>步骤2：商户后台收到用户支付单，调用微信支付统一下单接口。参见【统一下单API】。</li>
<li>步骤3：统一下单接口返回正常的prepay_id，再按签名规范重新生成签名后，将数据传输给APP。参与签名的字段名为appid，partnerid，prepayid，noncestr，timestamp，package。注意：package的值格式为Sign=WXPay</li>
<li>步骤4：商户APP调起微信支付。api参见本章节【app端开发步骤说明】</li>
<li>步骤5：商户后台接收支付通知。api参见【支付结果通知API】</li>
<li>步骤6：商户后台查询支付结果。，api参见【查询订单API】（查单实现可参考：支付回调和查单实现指引）</li>
</ul>
<h3 id="混合开发知道吗-你是怎么理解混合开发的-在项目中用到过混合开发吗" tabindex="-1"><a class="header-anchor" href="#混合开发知道吗-你是怎么理解混合开发的-在项目中用到过混合开发吗"><span>混合开发知道吗?你是怎么理解混合开发的,在项目中用到过混合开发吗?</span></a></h3>
<ul>
<li>在APP应用中使用WebView嵌套H5页面，即为混合开发。</li>
<li>Android、IOS、uniapp、ReactNative、小程序，都支持混合开发了。</li>
</ul>
<h3 id="平时工作中有是否有接触linux系统-说说常用到linux命令" tabindex="-1"><a class="header-anchor" href="#平时工作中有是否有接触linux系统-说说常用到linux命令"><span>平时工作中有是否有接触linux系统？说说常用到linux命令？</span></a></h3>
<p>1、<strong>常用的目录操作命令</strong></p>
<ul>
<li>创建目录 mkdir &lt;目录名称&gt;</li>
<li>删除目录 rm &lt;目录名称&gt;</li>
<li>定位目录 cd &lt;目录名称&gt;</li>
<li>查看目录文件 ls ll</li>
<li>修改目录名 mv &lt;目录名称&gt; &lt;新目录名称&gt;</li>
<li>拷贝目录 cp &lt;目录名称&gt; &lt;新目录名称&gt;</li>
</ul>
<p>2、<strong>常用的文件操作命令</strong></p>
<ul>
<li>创建文件 touch &lt;文件名称&gt; vi &lt;文件名称&gt;</li>
<li>删除文件 rm &lt;文件名称&gt;</li>
<li>修改文件名 mv &lt;文件名称&gt; &lt;新文件名称&gt;</li>
<li>拷贝文件 cp &lt;文件名称&gt; &lt;新文件名称&gt;</li>
</ul>
<p>3、<strong>常用的文件内容操作命令</strong></p>
<ul>
<li>查看文件 cat &lt;文件名称&gt; head &lt;文件名称&gt; tail &lt;文件名称&gt;</li>
<li>编辑文件内容 vi &lt;文件名称&gt;</li>
<li>查找文件内容 grep '关键字' &lt;文件名称&gt;</li>
</ul>
<h3 id="echarts是什么-怎么用" tabindex="-1"><a class="header-anchor" href="#echarts是什么-怎么用"><span>echarts是什么，怎么用</span></a></h3>
<p>echarts是一个基于 JavaScript 的开源可视化图表库，可以流畅的运行在 PC 和移动设备上，兼容绝大部分的浏览器（IE9/10/11，Chrome，Firefox，Safari等），底层依赖矢量图形库 ZRender，提供20 多种图表和十几种组件，支持Canvas、SVG 双引擎并能一键切换，让移动端渲染更加流畅</p>
<p>echarts源自百度，现由Apache 开源社区维护，官方提供了完善的文档（ https://echarts.apache.org ），使用也非常简单，步骤如下：</p>
<ol>
<li>
<p>下载echarts</p>
<ul>
<li>从 GitHub 获取
<blockquote>
<p>https://github.com/apache/echarts</p>
</blockquote>
</li>
<li>从 npm 获取<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line">    <span class="token function">npm</span> <span class="token function">install</span> echarts <span class="token parameter variable">--save</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>从 CDN 获取
<blockquote>
<p>https://www.jsdelivr.com/package/npm/echarts</p>
</blockquote>
</li>
<li>在线定制
<blockquote>
<p>https://echarts.apache.org//builder.html</p>
</blockquote>
</li>
</ul>
</li>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>初始化一个 echarts 实例并通过 <code v-pre>setOption</code> 方法生成一个图表（以柱状图为例）</p>
...
<h3 id="hash和history的区别" tabindex="-1"><a class="header-anchor" href="#hash和history的区别"><span>Hash和history的区别</span></a></h3>
<p>hash与history一般指Vue-router或React-router中的路由模式，Vue-router中通过<code v-pre>mode</code>配置选项设置，React-router中通过<code v-pre>HashRouter</code>与<code v-pre>BrowerRouter</code>组件设置，区别如下:</p>
<ol>
<li>最直观的区别就是在浏览器url中hash 带了一个很丑的 <code v-pre>#</code>，而history是没有</li>
<li>hash即浏览器地址栏 URL 中的 # 符号，hash 虽然出现在 URL 中，但不会被包括在 HTTP 请求中，因此改变 hash 不会重新加载页面</li>
<li>history利用了 HTML5新增的 <code v-pre>pushState()</code> 和 <code v-pre>replaceState()</code> 方法，在已有 <code v-pre>back()</code>、<code v-pre>forward()</code>、<code v-pre>go()</code> 的基础上，提供了对历史记录进行修改的功能。调用<code v-pre>pushState()</code> 和 <code v-pre>replaceState()</code>时，虽然改变了当前的 URL，但浏览器不会向后端发送请求，但如何用户刷新页面，会导致浏览器向服务器发起请求，如后端没有做出适当的响应，则会显示404页面</li>
</ol>
<h3 id="谈谈宏任务与微任务的理解-举一个宏任务与微任务的api" tabindex="-1"><a class="header-anchor" href="#谈谈宏任务与微任务的理解-举一个宏任务与微任务的api"><span>谈谈宏任务与微任务的理解，举一个宏任务与微任务的api</span></a></h3>
<p>要理解宏任务（macrotask）与微任务（microtask），就必须了解javascript中的事件循环机制（event loop）以及js代码的运行方式</p>
<p>要了解js代码的运行方式，得先搞懂以下几个概念</p>
<ul>
<li>
<p>JS是单线程执行</p>
<blockquote>
...
<p>JS引擎常驻于内存中，等待宿主将JS代码或函数传递给它执行，如何传递，这就是**事件循环（event loop）**所做的事情：当js执行栈空闲时，事件循环机制会从任务队列中提取第一个任务进入到执行栈执行，优先提取微任务（microtask），待微任务队列清空后，再提取宏任务（macrotask），并不断重复该过程</p>
<p>在实际应用中，宏任务（macrotask）与微任务（microtask）的API分别如下：</p>
<ul>
<li>宏任务
<ul>
...
<h3 id="对event-loop的了解" tabindex="-1"><a class="header-anchor" href="#对event-loop的了解"><span>对Event loop的了解？</span></a></h3>
<p>Javascript是单线程的，那么各个任务进程是按照什么样的规范来执行的呢？这就涉及到Event Loop的概念了，EventLoop是在html5规范中明确定义的；</p>
<p>何为eventloop,javascript中的一种运行机制，用来解决浏览器单线程的问题</p>
<p><strong>Event Loop是一个程序结构，用于等待和发送消息和事件。同步任务、异步任务、微任务、宏任务</strong></p>
<p>javascript单线程任务从时间上分为<strong>同步任务和异步任务</strong>，<strong>而异步任务又分为宏任务（macroTask）和微任务(microTask)</strong></p>
<p><strong>宏任务：主代码块、setTimeOut、setInterval、script、I/O操作、UI渲染</strong></p>
<p><strong>微任务：promise、async/await(返回的也是一个promise)、process.nextTick</strong></p>
<p>在执行代码前，任务队列为空，所以会优先执行主代码块，再执行主代码块过程中，遇到同步任务则立即将任务放到调用栈执行任务，遇到宏任务则将任务放入宏任务队列中，遇到微任务则将任务放到微任务队列中。</p>
<p>主线程任务执行完之后，先检查微任务队列是否有任务，有的话则将按照先入先出的顺序将先放进来的微任务放入调用栈中执行，并将该任务从微任务队列中移除，执行完该任务后继续查看微任务队列中是否还有任务，有的话继续执行微任务，微任务队列null时，查看宏任务队列，有的话则按先进先出的顺序执行，将任务放入调用栈并将该任务从宏任务队列中移除，该任务执行完之后继续查看微任务队列，有的话则执行微任务队列，没有则继续执行宏任务队列中的任务。</p>
<p><strong>需要注意的是：每次调用栈执行完一个宏任务之后，都会去查看微任务队列，如果microtask queue不为空，则会执行微任务队列中的任务，直到微任务队列为空再返回去查看执行宏任务队列中的任务</strong></p>
<p><img src="https://img-blog.csdnimg.cn/20200505012852473.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NfbGFtX2U=,size_16,color_FFFFFF,t_70" alt=""></p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">console.log('script start')</span>
<span class="line"> </span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最终输出 ：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">script start</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>解析：</p>
<p>在说返回结果之前，先说一下async/await，async 返回的是一个promise,而await则等待一个promise对象执行，await之后的代码则相当于promise.then()</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">async function async1() {</span>
<span class="line">  await async2()</span>
<span class="line">  console.log('async1 end')</span>
<span class="line">}</span>
<span class="line">async function async2() {</span>
